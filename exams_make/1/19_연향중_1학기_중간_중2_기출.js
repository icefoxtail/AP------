window.examTitle = "19_연향중_1학기_중간_중2_기출";
window.questionBank = [
  {
    "id": 1,
    "category": "유리수와 순환소수",
  ...
  },
  {
    "id": 3,
    "category": "유리수와 순환소수",
    "content": "다음은 순환소수 $2.\\dot{4}\\dot{5}$를 분수로 표현하는 과정이다. 이때 $a+b+c$의 값은? [4점]<br><br>$2.\\dot{4}\\dot{5}$의 분수 표현을 $x$라고 할 때,<br>$a x = 245.4545\\cdots$<br>$x = 2.4545\\cdots$<br>$(a-1)x = b$<br>이므로, $x$를 기약분수로 나타내면 $\\frac{27}{c}$이다.",
    "choices": [
      "254",
      "256",
      "354",
  ...
  },
  {
    "id": 6,
    "category": "식의 계산",
    "content": "$\\left(\\frac{x^{a}}{3y^{2b}}\\right)^{4} = \\frac{x^{8}}{81y^{24}}$일 때, 두 자연수 $a+b$의 값은? (단, $a, b$는 자연수) [4점]",
    "choices": [
      "5",
      "6",
      "7",
  ...
  },
  {
    "id": 8,
    "category": "식의 계산",
    "content": "다음 등식을 만족시키는 네 자연수 $a, b, c, d$에 대하여 $a+b+c+d$의 값을 구하면? [4점]<br><br>$20 \\times 30 \\times 40 \\times 50 \\times 60 \\times 70 = 2^{a} \\times 3^{b} \\times 5^{c} \\times 7^{d}$",
    "choices": [
      "12",
      "14",
      "16",
  ...
  },
  {
    "id": 11,
    "category": "식의 계산",
    "content": "다음 식을 전개하여 간단히 했을 때, $x^{2}$의 계수를 $a$, $xy$의 계수를 $b$라고 할 때, $a-b$의 값은? [4점]<br><br>$4x(3x+2y+6) - 5x(x+y+2)$",
    "choices": [
      "-4",
      "-2",
      "0",
  ...
  },
  {
    "id": 15,
    "category": "일차부등식",
    "content": "$x-8 \\le 16-2x$의 해가 아닌 것을 다음 중에서 고르면? [3.5점]",
    "choices": [
      "5",
      "6",
      "7",
  ...
  },
  {
    "id": 18,
    "category": "일차부등식",
    "content": "다음 두 일차부등식의 해가 같을 때, 정수 $a$의 값을 구하면? [4점]<br><br>$2(3-x) > 4x$, $a(x+3) > -16$",
    "choices": [
      "-4",
      "-2",
      "1",
  ...
  },
  {
    "id": 22,
    "category": "식의 계산",
    "content": "두 식 $A, B$가 다음과 같을 때, $A+B$를 계산하여라. [5점]<br><br>$A = (16a^{2}b - 20a^{3}) \\div (-4a^{2})$<br>$B = (9a^{2} - 15ab) \\div \\frac{3}{2}a$",
    "choices": [],
    "answer": "11a-14b",
    "originalCategory": "식의 계산",
    "standardCourse": "중2 수학",
  ...
  },
  {
    "id": 23,
    "category": "일차부등식",
    "content": "일차부등식 $3(2-x) < 7$를 풀어라. [5점]",
    "choices": [],
    "answer": "x > -\\frac{1}{3}",
    "originalCategory": "일차부등식",
    "standardCourse": "중2 수학",
  ...
  },
  {
    "id": 24,
    "category": "일차부등식",
    "content": "정수기 구입비용(240,000원 + 월 6,000원)과 대여비용(월 9,000원)을 비교할 때, 구입이 더 저렴해지는 시점은? [5점]",
    "choices": [],
    "answer": "81개월",
    "originalCategory": "일차부등식",
    "standardCourse": "중2 수학",
