...
window.examTitle = "21_신흥중2_1학기_중간_중2";
...
window.questionBank = [
    ...
    },
    {
        ...
        choices: ["1000", "10", "990", "716", "$\\frac{217}{330}$"],
        answer: "⑤",
    ...
    },
    {
        ...
        choices: ["$2x^3 \\times (-3x^2) = -6x^5$", "$(-2x^2)^3 \\div 2x^4 = -4x^2$", "$16x^2y \\div 4xy \\times 2x = 8x^2$", "$(-x^2y^3)^2 \\div (\\frac{1}{3}xy)^2 = 9x^2y^4$", "$(-2xy)^2 \\times (-2x^2y)^3 = 32x^8y^5$"],
        answer: "⑤",
