...
window.questionBank = window.questionBank.concat([
  ...
  },
  {
    ...
    "answer": "③",
    "solution": "**[Logical Anchor]** 닮음을 이용한 넓이 함수(2차식) 구성\n$\\because h=3 \\implies S(y) = \\tf{4}{3}y(3-y)$\n$\\because y = \\tf{3}{2} \\text{ 일 때 최댓값}$\n$\\therefore S(1.5) = \\tf{4}{3} \\cdot \\tf{3}{2} \\cdot \\tf{3}{2} = 3$"
  },
  {
    "id": 18,
    "level": "최상",
  ...
  },
  {
    ...
    "solution": "**[Logical Anchor]** 이차함수의 축과 경계값 분석\n$\\because (1) h(t)=0 \\implies t = \\tf{2+\\sqrt{14}}{5}$\n$\\because (2) \\text{축 } t=0.4 \\in [0,1] \\implies h(0.4) = \\tf{14}{5}$\n$\\therefore (3) h(1) = 1$"
  },
  {
    "id": 22,
    "level": "중",
