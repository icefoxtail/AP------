...
\begin{document}
\begin{tikzpicture}
% derived-witness R=(1.8,0.8) calculated by validate_special.py
\begin{axis}[width=11cm,height=9cm,axis equal image,axis lines=middle,grid=major,xmin=-0.5,xmax=3.5,ymin=-0.5,ymax=2.5,xlabel={$x$},ylabel={$y$},clip=true]
  ...
  \addplot[blue,line width=1.1pt] coordinates {(2.7,0.4) (0.2,1.5111111111)};
  \addplot[only marks,mark=*,mark size=1.8pt,black] coordinates {(3,0) (0,2) (2.7,0.4) (0.2,1.5111111111) (1.8,0.8)};
  \node[anchor=south west] at (axis cs:3,0) {$A(3,0)$};
  \node[anchor=south west] at (axis cs:0,2) {$B(0,2)$};
  \node[anchor=north east] at (axis cs:2.7,0.4) {$P$};
  \node[anchor=south west] at (axis cs:0.2,1.5111111111) {$Q$};
