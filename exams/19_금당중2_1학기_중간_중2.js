...
window.questionBank = [
  ...
  },
  {
    ...
    answer: "④",
    solution: "**[Logical Anchor]** 기약분수로 나타낸 후 분모의 소인수를 확인해야 함.\n$\\frac{21}{2 \\times 3^2 \\times 7} = \\frac{3 \\times 7}{2 \\times 3^2 \\times 7} = \\frac{1}{2 \\times 3}$\n기약분수로 나타냈을 때 분모에 소인수 $3$이 남음 $\\implies$ 무한소수\n$\\therefore \\frac{21}{2 \\times 3^2 \\times 7}$"
  },
  {
    id: 3,
    level: "하",
  ...
  },
  {
    ...
    answer: "④",
    solution: "**[Logical Anchor]** 팩토리얼 내 특정 소인수의 개수는 해당 소수의 거듭제곱으로 나눈 몫들의 합과 같음.\n$18$ 이하의 자연수 중 $2$의 배수 개수: $\\frac{18}{2} = 9$\n$2^2$의 배수 개수: $\\frac{18}{4} = 4$ (몫)\n$2^3$의 배수 개수: $\\frac{18}{8} = 2$ (몫)\n$2^4$의 배수 개수: $\\frac{18}{16} = 1$ (몫)\n$\\implies a = 9 + 4 + 2 + 1 = 16$\n$\\therefore 16$"
  },
  {
    id: 16,
    level: "중",
  ...
  },
  {
    ...
    level: "중",
    category: "다항식 계산 확인",
    content: "다음 다항식의 계산 결과가 옳은 것만을 있는 대로 고른 것은?<br><div style='border:1px solid #cbd5e1; padding:10px; margin-top:8px; background:#f8fafc;'>① $(20a^2-24ab+16a) \\div 4a = 5a-6b+4$<br>② $(14x^2-21xy) \\div \\frac{7}{2}x = 4x-6y$<br>③ $5x(2-x) = -5x^2+5x$<br>④ $2(3x^2-x+5)-x(-6x+4) = 12x^2-6x+10$<br>⑤ $-(3x^2y-3xy+6xy^2) \\div \\frac{3}{2}xy = -2x+2-4y$</div>",
    choices: ["①", "②", "③", "④", "⑤"],
    answer: "①, ②",
    solution: "**[Logical Anchor]** 분배법칙과 역수의 곱셈을 통해 각 보기의 연산 결과가 참인지 판별.\n① $(20a^2-24ab+16a) \\times \\frac{1}{4a} = 5a - 6b + 4$ (참)\n② $(14x^2-21xy) \\times \\frac{2}{7x} = 4x - 6y$ (참)\n③ $5x(2-x) = 10x - 5x^2$ (거짓)\n④ $6x^2-2x+10 + 6x^2-4x = 12x^2-6x+10$ (참이나 보기 구성 상 논외)\n$\\therefore$ ①, ②"
  },
  {
    id: 18,
    level: "중",
