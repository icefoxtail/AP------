...
window.questionBank = [
  ...
  },
  {
    ...
    level: "상",
    category: "원순열",
    content: "1학년 학생 2명, 2학년 학생 3명, 3학년 학생 3명이 일정한 간격을 두고 원 모양의 탁자에 다음 조건을 만족시키도록 모두 둘러앉는 경우의 수를 구하시오. (단, 회전하여 일치하는 것은 같은 것으로 본다.) [4.8점]\n<조 건>\n(가) 같은 학년 학생끼리는 서로 이웃하여 앉지 않는다.\n(나) 같은 학년 학생끼리는 서로 마주보고 앉지 않는다.\n<svg width='160' height='160' viewBox='0 0 160 160' style='display:block; margin: 10px auto;'><circle cx='80' cy='80' r='50' fill='none' stroke='black' stroke-width='1'/><line x1='80' y1='30' x2='80' y2='130' stroke='#eee'/><line x1='30' y1='80' x2='130' y2='80' stroke='#eee'/><circle cx='80' cy='25' r='5' fill='gray'/><circle cx='119' cy='41' r='5' fill='gray'/><circle cx='135' cy='80' r='5' fill='gray'/><circle cx='119' cy='119' r='5' fill='gray'/><circle cx='80' cy='135' r='5' fill='gray'/><circle cx='41' cy='119' r='5' fill='gray'/><circle cx='25' cy='80' r='5' fill='gray'/><circle cx='41' cy='41' r='5' fill='gray'/></svg>",
    choices: ["① 72", "② 144", "③ 288", "④ 360", "⑤ 720"],
    answer: "2",
    solution: "[풀이]\n1) 3학년 3명을 배치: 이웃하지 않고 마주보지 않게 앉는 패턴은 (1번, 3번, 6번) 자리와 그 회전형뿐임\n\\rightarrow \\text{3학년 배치 방법} = (3-1)! \\times 3 = 6 \\text{가지 (기준점 고정 원순열)}\n2) 남은 5자리에 2학년 3명, 1학년 2명을 배치:\n\\rightarrow \\text{조건 (가), (나)를 만족하는 자리 구성은 2가지 패턴 존재}\n3) 각 구성에 대해 학생 배열:\n\\rightarrow \\text{2학년 배열} (3!) \\times \\text{1학년 배열} (2!) = 12\n4) 총 경우의 수:\n\\rightarrow 6 \\times 2 \\times 12 = 144\n---\n[결론]\n정답: 2"
  },
  {
    id: 23,
    level: "중",
