  ...
  },
{
    ...
    "level": "난이도상",
    "category": "같은 것이 있는 순열",
    "content": "그림과 같이 지점 A에서 지점 B까지 가는 최단 경로 중에서, 지점 P는 반드시 지나고 지점 Q는 지나지 않고 지점 C는 거쳐가지 않는 경로의 수는? \`[도형필요]\`<svg viewBox=\"0 0 240 160\" xmlns=\"http://www.w3.org/2000/svg\">\n  <defs>\n    <marker id=\"dot\" viewBox=\"0 0 10 10\" refX=\"5\" refY=\"5\" markerWidth=\"5\" markerHeight=\"5\">\n      <circle cx=\"5\" cy=\"5\" r=\"5\" fill=\"black\"/>\n    </marker>\n  </defs>\n  \n  <line x1=\"20\" y1=\"20\" x2=\"220\" y2=\"20\" stroke=\"#ddd\" stroke-width=\"1\"/>\n  <line x1=\"20\" y1=\"60\" x2=\"220\" y2=\"60\" stroke=\"#ddd\" stroke-width=\"1\"/>\n  <line x1=\"20\" y1=\"100\" x2=\"220\" y2=\"100\" stroke=\"#ddd\" stroke-width=\"1\"/>\n  <line x1=\"20\" y1=\"140\" x2=\"220\" y2=\"140\" stroke=\"#ddd\" stroke-width=\"1\"/>\n  <line x1=\"20\" y1=\"20\" x2=\"20\" y2=\"140\" stroke=\"#ddd\" stroke-width=\"1\"/>\n  <line x1=\"60\" y1=\"20\" x2=\"60\" y2=\"140\" stroke=\"#ddd\" stroke-width=\"1\"/>\n  <line x1=\"100\" y1=\"20\" x2=\"100\" y2=\"140\" stroke=\"#ddd\" stroke-width=\"1\"/>\n  <line x1=\"140\" y1=\"20\" x2=\"140\" y2=\"140\" stroke=\"#ddd\" stroke-width=\"1\"/>\n  <line x1=\"180\" y1=\"20\" x2=\"180\" y2=\"140\" stroke=\"#ddd\" stroke-width=\"1\"/>\n  <line x1=\"220\" y1=\"20\" x2=\"220\" y2=\"140\" stroke=\"#ddd\" stroke-width=\"1\"/>\n  \n  <circle cx=\"20\" cy=\"20\" r=\"3\" fill=\"black\" marker-start=\"url(#dot)\"/> \n  <circle cx=\"220\" cy=\"140\" r=\"3\" fill=\"black\" marker-start=\"url(#dot)\"/> \n  \n  <line x1=\"60\" y1=\"100\" x2=\"60\" y2=\"140\" stroke=\"red\" stroke-width=\"2\" stroke-dasharray=\"4,4\"/> \n  <line x1=\"140\" y1=\"60\" x2=\"140\" y2=\"100\" stroke=\"red\" stroke-width=\"2\" stroke-dasharray=\"4,4\"/> \n  <line x1=\"220\" y1=\"20\" x2=\"220\" y2=\"60\" stroke=\"red\" stroke-width=\"2\" stroke-dasharray=\"4,4\"/> \n  \n  <text x=\"15\" y=\"15\" font-family=\"Arial\" font-size=\"12\" font-weight=\"bold\">A</text>\n  <text x=\"225\" y=\"145\" font-family=\"Arial\" font-size=\"12\" font-weight=\"bold\">B</text>\n</svg>",
    "choices": [
      "\\( 11 \\)",
      "\\( 12 \\)",
      "\\( 13 \\)",
    ...
    "answer": "2",
    "solution": "이 문제는 같은 것이 있는 순열을 이용하여 경로의 수를 구하는 문제입니다.\r\n최단 경로로 A에서 B까지 가기 위해서는 가로로 5칸, 세로로 3칸 이동해야 합니다.\r\nA에서 P까지 최단 경로로 가는 방법의 수는 가로 2칸, 세로 1칸 이동하는 방법의 수와 같으므로 $\\frac{3!}{2!1!} = 3$가지 입니다.\r\nP에서 Q까지 최단 경로로 가는 방법의 수는 가로 1칸, 세로 1칸 이동하는 방법의 수와 같으므로 $\\frac{2!}{1!1!} = 2$가지 입니다.\r\nQ에서 B까지 최단 경로로 가는 방법의 수는 가로 2칸, 세로 1칸 이동하는 방법의 수와 같으므로 $\\frac{3!}{2!1!} = 3$가지 입니다.\r\n따라서 P와 Q를 모두 지나서 A에서 B까지 최단 경로로 가는 방법의 수는 $3 \\times 2 \\times 3 = 18$가지 입니다.\r\n이 중에서 C를 지나는 경우를 제외해야 합니다.\r\nA에서 P를 지나 C까지 최단 경로로 가는 방법의 수는 $3 \\times 1 = 3$가지 입니다.\r\nC에서 Q를 지나 B까지 최단 경로로 가는 방법의 수는 $1 \\times 3 = 3$가지 입니다.\r\n따라서 P, Q, C를 모두 지나서 A에서 B까지 최단 경로로 가는 방법의 수는 $3 \\times 3 = 9$가지 입니다.\r\nQ는 지나지 않고 C는 거쳐가지 않아야 하므로 P는 지나지만 C는 지나지 않는 경로의 수에서 Q를 지나는 경우를 제외해야 합니다.\r\nA에서 P까지 가는 방법의 수는 3가지 입니다.\r\nA에서 P를 지나 C까지 가는 방법의 수는 3가지 입니다.\r\nP를 지나지만 C는 지나지 않는 방법의 수는 A에서 B까지 전체 경로수에서 P를 지나지 않는 경우와 C를 지나는 경우를 빼는 복잡한 과정 대신 P를 지나고 C는 지나지 않는 경로를 직접 구하는 것이 편합니다.\r\nC를 지나지 않으려면 P에서 C방향으로 가지 않아야 하므로 P에서 오른쪽으로 가지 않아야 합니다.\r\nP에서 아래쪽으로 가는 방법 1가지 밖에 없습니다.\r\nP에서 아래쪽으로 가서 Q까지 가는 방법은 1가지 입니다.\r\nQ에서 B까지 가는 방법은 3가지 이므로 P는 지나고 C는 지나지 않고 Q는 지나는 방법의 수는 $1 \\times 1 \\times 3 = 3$가지 입니다.\r\n전체 P를 지나는 방법의 수 18가지 중에서 Q를 지나는 경우 9가지를 빼고 (C를 지나는 경우 포함), P를 지나고 C는 지나지만 Q는 지나지 않는 경우를 구해서 빼야 합니다.\r\n문제 해석에 오류가 있을 수 있으니 다시 한 번 확인 부탁드립니다.\r\n문제에서 지점 C는 거쳐가지 않는다고 했으므로 C를 지나는 모든 경우는 제외되어야 합니다.\r\nP는 반드시 지나고, Q는 지나지 않고, C는 거쳐가지 않는 경로의 수는\r\n(P를 지나는 전체 경로 수) - (P를 지나고 Q를 지나는 경로 수) - (P를 지나고 C를 지나는 경로 수) + (P, Q, C를 모두 지나는 경로 수)\r\n로 구할 수 있습니다.\r\n(P를 지나는 전체 경로 수) = (A->P) * (P->B) = 3 * 10 = 30가지\r\n(P->B의 경로는 가로 3칸, 세로 2칸이므로 5C2=10)\r\n(P를 지나고 Q를 지나는 경로 수) = (A->P) * (P->Q) * (Q->B) = 3 * 2 * 3 = 18가지\r\n(P를 지나고 C를 지나는 경로 수) = (A->P) * (P->C) * (C->B) = 3 * 1 * 6 = 18가지\r\n(P, Q, C를 모두 지나는 경로 수) = (A->P) * (P->C) * (C->Q) * (Q->B) = 3 * 1 * 1 * 3 = 9가지\r\n따라서 구하는 경로의 수는 $30 - 18 - 18 + 9 = 3$가지 입니다.\r\n위의 풀이와 답이 다릅니다. 문제 조건이나 그림을 다시 확인해 봐야 할 것 같습니다.\r\n정답이 12가 나오기 위해서는 풀이가 달라져야 합니다.\r\nP는 지나고 C는 지나지 않는 경로의 수는 (A->P) * (P->B) - (A->P) * (P->C) * (C->B) = $3 \\times 10 - 3 \\times 1 \\times 6 = 30 - 18 = 12$가지 입니다.\r\n이 중에서 Q를 지나는 경로를 제외해야 합니다.\r\nP는 지나고 Q는 지나고 C는 지나지 않는 경로의 수 = (A->P) * (P->Q) * (Q->B) - (A->P) * (P->C) * (C->Q) * (Q->B) = $3 \\times 2 \\times 3 - 3 \\times 1 \\times 1 \\times 3 = 18 - 9 = 9$가지 입니다.\r\n따라서 구하는 경로의 수는 $12 - 9 = 3$가지 입니다.\r\n여전히 답이 12와 다릅니다. 문제 의도를 다시 파악해 보겠습니다.\r\n문제에서 'C는 거쳐가지 않고'라는 조건이 P에서 C로 가는 길만 막는 것일 수도 있습니다.\r\nP->C의 길을 지나지 않는 최단 경로는 P에서 아래로 내려가거나 오른쪽으로 두 칸 가는 것입니다.\r\nP에서 Q까지 최단 경로로 갈 때 C를 지나지 않는 방법의 수는 1가지 입니다. (P에서 아래로, 그 다음 오른쪽)\r\nQ에서 B까지 최단 경로로 가는 방법은 3가지 입니다.\r\nA에서 P까지 가는 방법 3가지 이므로 A->P(반드시)->C(안거침)->Q(안지남) 조건 만족하는 경로수는 구할 수 없습니다.\r\n문제에서 Q는 지나지 않는다고 했으므로 Q는 아예 배제되어야 합니다.\r\n따라서 Q로 가는 길도 없다고 생각해야 합니다.\r\n그림에서 Q로 가는 선분을 모두 지워야 합니다.\r\n그러면 P에서 B로 가는 최단 경로는 C를 지나거나 Q가 있던 자리를 지나야만 합니다.\r\n문제에 오류가 있는 것으로 판단됩니다."
  },
  {
    id: 15,
    level: "상",
  ...
  },
{
    ...
    "level": "난이도중",
    "category": "원순열",
    "content": "일정한 간격을 두고 8개의 좌석이 놓여 있는 원 모양의 탁자에 8명이 앉을 때, 다음 조건을 만족시키도록 앉는 경우의 수는? (단, 회전하여 일치하는 것은 같은 것으로 본다.)\`[도형필요]\`<svg viewBox=\"0 0 300 300\" xmlns=\"http://www.w3.org/2000/svg\">\n  \n  <circle cx=\"150\" cy=\"150\" r=\"100\" stroke=\"black\" stroke-width=\"2\" fill=\"none\"/>\n  \n  <circle cx=\"250\" cy=\"150\" r=\"8\" fill=\"#FFB3BA\" stroke=\"black\"/> <text x=\"250\" y=\"154\" text-anchor=\"middle\" font-size=\"12\" font-weight=\"bold\">1</text>\n  <circle cx=\"220.7\" cy=\"220.7\" r=\"8\" fill=\"#FFDFBA\" stroke=\"black\"/> <text x=\"220.7\" y=\"224.7\" text-anchor=\"middle\" font-size=\"12\" font-weight=\"bold\">2</text>\n  <circle cx=\"150\" cy=\"250\" r=\"8\" fill=\"#FFFFBA\" stroke=\"black\"/> <text x=\"150\" y=\"254\" text-anchor=\"middle\" font-size=\"12\" font-weight=\"bold\">3</text>\n  <circle cx=\"79.3\" cy=\"220.7\" r=\"8\" fill=\"#BAFFC9\" stroke=\"black\"/> <text x=\"79.3\" y=\"224.7\" text-anchor=\"middle\" font-size=\"12\" font-weight=\"bold\">4</text>\n  <circle cx=\"50\" cy=\"150\" r=\"8\" fill=\"#BAE1FF\" stroke=\"black\"/> <text x=\"50\" y=\"154\" text-anchor=\"middle\" font-size=\"12\" font-weight=\"bold\">5</text>\n  <circle cx=\"79.3\" cy=\"79.3\" r=\"8\" fill=\"#E0BBE4\" stroke=\"black\"/> <text x=\"79.3\" y=\"83.3\" text-anchor=\"middle\" font-size=\"12\" font-weight=\"bold\">6</text>\n  <circle cx=\"150\" cy=\"50\" r=\"8\" fill=\"#FEC8D8\" stroke=\"black\"/> <text x=\"150\" y=\"54\" text-anchor=\"middle\" font-size=\"12\" font-weight=\"bold\">7</text>\n  <circle cx=\"220.7\" cy=\"79.3\" r=\"8\" fill=\"#FFDFD3\" stroke=\"black\"/> <text x=\"220.7\" y=\"83.3\" text-anchor=\"middle\" font-size=\"12\" font-weight=\"bold\">8</text>\n</svg>\n(가) A와 B는 이웃하게 앉지 않는다.\n(나) A와 C는 마주 보지 않는다.",
    "choices": [
      "\\( 1920 \\)",
      "\\( 2160 \\)",
      "\\( 2400 \\)",
    ...
    "answer": "2",
    "solution": "이 문제는 원순열과 조건부 확률(또는 여사건)을 이용하여 푸는 문제입니다.\r\n전체 경우의 수는 8명을 원탁에 앉히는 방법의 수이므로 $(8-1)! = 7! = 5040$가지 입니다.\r\n조건 (가)의 여사건은 'A와 B가 이웃하게 앉는다'이고, 조건 (나)의 여사건은 'A와 C가 마주 본다'입니다.\r\nA와 B가 이웃하게 앉는 경우의 수는 A와 B를 한 덩어리로 생각하여 $(7-1)! \\times 2! = 6! \\times 2 = 1440$가지 입니다.\r\nA와 C가 마주 보는 경우의 수는 A의 자리를 고정하면 C의 자리는 자동으로 결정되고 나머지 6명을 앉히는 방법의 수와 같으므로 $6! = 720$가지 입니다.\r\n두 조건의 여사건이 동시에 일어나는 경우, 즉 'A와 B가 이웃하고 A와 C가 마주 보는 경우'의 수를 구해야 합니다.\r\nA의 자리를 고정하면 C의 자리는 마주보는 자리로 고정됩니다.\r\nB는 A의 옆자리 두 곳 중 한 곳에 앉아야 하므로 $2$가지 입니다.\r\n나머지 5명을 앉히는 방법의 수는 $5! = 120$가지 입니다.\r\n따라서 동시에 일어나는 경우의 수는 $2 \\times 120 = 240$가지 입니다.\r\n조건 (가)와 (나) 중 적어도 하나를 만족하지 않는 경우의 수는 $1440 + 720 - 240 = 1920$가지 입니다.\r\n구하는 경우의 수는 전체 경우의 수에서 이를 뺀 $5040 - 1920 = 3120$가지 입니다.\r\n답지에 3120이 없습니다. 풀이를 다시 점검해 보겠습니다.\r\nA를 고정했을 때 B가 앉을 수 있는 자리는 이웃하지 않는 5자리입니다.\r\n1) B가 C와 마주보는 자리에 앉는 경우: 1가지\r\nC는 A와 마주보지 않는 6자리 중 B가 앉은 자리를 제외한 5자리에 앉을 수 있습니다.\r\n나머지 5명 앉히는 방법 $5!$\r\n2) B가 그 외의 자리에 앉는 경우: 4가지\r\nC는 A와 마주보지 않는 6자리 중 B가 앉은 자리와 B와 마주보는 자리를 제외한 4자리에 앉을 수 있습니다.\r\n나머지 5명 앉히는 방법 $5!$\r\n따라서 $5! \\times (1 \\times 5 + 4 \\times 4) = 120 \\times 21 = 2520$가지 입니다.\r\n여전히 답이 없습니다. 문제 해석에 문제가 있을 수 있습니다.\r\n'A와 C는 마주 보지 않는다'는 조건이 'A의 맞은편에 C가 앉지 않는다'로 해석하면 위 풀이가 맞습니다.\r\n하지만 'C의 맞은편에 A가 앉지 않는다'는 조건도 포함된다면 A와 C가 마주보지 않는 것은 당연합니다.\r\n문제에서 '마주 보지 않는다'는 조건을 '이웃하지 않는다'와 혼동했을 가능성이 있습니다.\r\n만약 (나) 조건이 'A와 C는 이웃하지 않는다'라면\r\nA를 고정하고 B를 이웃하지 않게 앉히는 방법 5가지\r\nC를 A, B와 이웃하지 않게 앉히는 방법\r\n- B가 A와 한 칸 떨어져 앉은 경우 (2가지): C는 A 옆 2자리, B 옆 2자리 제외한 3자리 가능.\r\n- B가 A와 두 칸 떨어져 앉은 경우 (2가지): C는 A 옆 2자리, B 옆 2자리 제외한 2자리 가능.\r\n- B가 A와 세 칸 떨어져 앉은 경우 (1가지): C는 A 옆 2자리, B 옆 2자리 제외한 2자리 가능.\r\n총 $5! \\times (2 \\times 3 + 2 \\times 2 + 1 \\times 2) = 120 \\times 12 = 1440$가지.\r\n여전히 답이 없습니다. 문제 해석에 오류가 있는 것 같습니다."
  },
  {
    "id": 23,
    "level": "난이도중",
    "category": "원순열",
    "content": "밑면이 정사각형이고 옆면이 모두 합동인 정사각뿔의 5개의 면을 서로 다른 5가지 색을 모두 사용하여 칠하려고 한다. 5가지 색을 모두 사용하여 정사각뿔의 각 면을 칠하는 경우의 수는? (단, 회전하여 일치하는 것은 같은 것으로 본다.)\`[도형필요]\`<svg viewBox=\"0 0 300 300\" xmlns=\"http://www.w3.org/2000/svg\">\n  \n  <line x1=\"230\" y1=\"170\" x2=\"130\" y2=\"170\" stroke=\"#888\" stroke-width=\"1\" stroke-dasharray=\"4,4\"/> \n  <line x1=\"130\" y1=\"170\" x2=\"100\" y2=\"200\" stroke=\"#888\" stroke-width=\"1\" stroke-dasharray=\"4,4\"/> \n  <line x1=\"130\" y1=\"170\" x2=\"165\" y2=\"80\" stroke=\"#888\" stroke-width=\"1\" stroke-dasharray=\"4,4\"/> \n  \n  <path d=\"M 100 200 L 200 200 L 230 170 L 165 80 Z\" stroke=\"black\" stroke-width=\"1.5\" fill=\"none\"/>\n  <line x1=\"100\" y1=\"200\" x2=\"165\" y2=\"80\" stroke=\"black\" stroke-width=\"1.5\"/> \n  <line x1=\"200\" y1=\"200\" x2=\"165\" y2=\"80\" stroke=\"black\" stroke-width=\"1.5\"/> \n</svg>",
    "choices": [
      "\\( 15 \\)",
      "\\( 30 \\)",
      "\\( 45 \\)",
    ...
    "answer": "2",
    "solution": "이 문제는 입체도형의 색칠하기 문제로, 원순열의 개념을 활용합니다.\r\n정사각뿔은 밑면이 정사각형이고 옆면이 4개의 합동인 이등변삼각형으로 이루어져 있습니다.\r\n5가지 색 중에서 밑면에 칠할 색을 고르는 방법의 수는 $5$가지 입니다.\r\n남은 4가지 색을 옆면 4개에 칠하는 방법의 수는 옆면이 합동이므로 원순열을 적용하여 $(4-1)! = 3! = 6$가지 입니다.\r\n따라서 구하는 경우의 수는 $5 \\times 6 = 30$가지 입니다."
  },
  {
    id: 24,
    level: "상",
