...
window.questionBank = [
  ...
  },
  {
    ...
    "answer": "3",
    "solution": "[도형 검토 후 보완 필요]\n도형의 가로, 세로 칸 수에 따라 경로를 분할하여 계산한다.\nA에서 P까지 가는 최단 경로의 수: 가로 3칸, 세로 1칸일 경우 \\frac{4!}{3!1!} = 4가지\nP에서 B까지 가는 최단 경로의 수: 가로 1칸, 세로 1칸일 경우 \\frac{2!}{1!1!} = 2가지\n\\rightarrow 4 \\times 2 = 8\n도형의 기본 형태를 가정했을 때 정답은 8이다.",
    "originalCategory": "",
    "standardCourse": "",
    "standardUnitKey": "",
    "standardUnit": "",
  ...
  },
  {
    ...
    "level": "중",
    "category": "이항정리",
    "content": "{}_1C_0 + {}_2C_1 + {}_3C_2 + {}_4C_3 + {}_5C_4 = {}_nC_4 일 때, 등식을 만족시키는 자연수 n의 값은?",
    "choices": [
      "2",
      "4",
      "6",
    ...
    "answer": "3",
    "solution": "파스칼의 삼각형 성질({}_{n-1}C_{r-1} + {}_{n-1}C_r = {}_nC_r)을 이용한다.\n{}_1C_0 = {}_2C_0 이므로 식을 변형하면:\n({}_2C_0 + {}_2C_1) + {}_3C_2 + {}_4C_3 + {}_5C_4\n= {}_3C_1 + {}_3C_2 + {}_4C_3 + {}_5C_4\n= {}_4C_2 + {}_4C_3 + {}_5C_4\n= {}_5C_3 + {}_5C_4\n= {}_6C_4\n따라서 n=6이다.",
    "originalCategory": "",
    "standardCourse": "",
    "standardUnitKey": "",
    "standardUnit": "",
  ...
  },
  {
    ...
    "answer": "2",
    "solution": "이항정리의 일반항은 {}_4C_k (6x^3)^{4-k} (-\\frac{1}{2x})^k 이다.\n식을 정리하면 {}_4C_k \\cdot 6^{4-k} \\cdot (-\\frac{1}{2})^k \\cdot x^{12-3k} \\cdot x^{-k} = {}_4C_k \\cdot 6^{4-k} \\cdot (-\\frac{1}{2})^k \\cdot x^{12-4k}\n상수항이 되려면 x의 지수가 0이어야 하므로 12 - 4k = 0 \\rightarrow k = 3\nk = 3을 대입하여 계수를 구하면:\n{}_4C_3 \\cdot 6^1 \\cdot (-\\frac{1}{2})^3 = 4 \\cdot 6 \\cdot (-\\frac{1}{8}) = 24 \\times (-\\frac{1}{8}) = -3\n따라서 상수항은 -3이다.",
    "originalCategory": "",
    "standardCourse": "",
    "standardUnitKey": "",
    "standardUnit": "",
  ...
  },
  {
    ...
    "level": "중",
    "category": "이항정리",
    "content": "자연수 n에 대하여, {}_nC_0 + {}_nC_1 \\times 7 + {}_nC_2 \\times 7^2 + \\dots + {}_nC_n \\times 7^n = 2^{60}을 만족하는 n의 값은?",
    "choices": [
      "16",
      "17",
      "18",
  ...
  },
  {
    ...
    "choices": [],
    "answer": "375",
    "solution": "자릿수별로 개수를 누적한다.\n1자리 자연수: 1, 2, 3, 4 (4개)\n2자리 자연수: 맨 앞자리는 0이 올 수 없으므로 4 \\times 5 = 20개\n3자리 자연수: 4 \\times 5 \\times 5 = 100개\n4자리 자연수 중 3000보다 작은 수는 맨 앞자리가 1 또는 2인 경우이다.\n맨 앞자리가 1인 수: 1 \\times 5 \\times 5 \\times 5 = 125개\n맨 앞자리가 2인 수: 1 \\times 5 \\times 5 \\times 5 = 125개\n\\rightarrow 3000 이전의 수들의 총 개수 = 4 + 20 + 100 + 125 + 125 = 374\n따라서 3000은 375번째 수이다.",
    "originalCategory": "",
    "standardCourse": "",
    "standardUnitKey": "",
    "standardUnit": "",
  ...
  },
  {
    ...
    "choices": [],
    "answer": "{}_{28}C_{14}",
    "solution": "주어진 항등식에서 n=14를 대입하면:\n(1+x)^{28} = (1+x)^{14} \\times (1+x)^{14}\n양변의 x^{14}의 계수를 비교한다.\n좌변에서 x^{14}의 계수는 {}_{28}C_{14} 이다.\n우변에서 x^{14}의 계수를 구하기 위해 (1+x)^{14}의 항들을 서로 곱하면:\n\\sum_{k=0}^{14} ({}_{14}C_k x^k) \\times ({}_{14}C_{14-k} x^{14-k}) 의 계수합이 된다.\n{}_{14}C_{14-k} = {}_{14}C_k 이므로, 계수의 합은 \\sum_{k=0}^{14} ({}_{14}C_k)^2 이다.\n따라서 ({}_{14}C_0)^2 + ({}_{14}C_1)^2 + \\dots + ({}_{14}C_{14})^2 = {}_{28}C_{14} 이다.",
    "originalCategory": "",
    "standardCourse": "",
    "standardUnitKey": "",
    "standardUnit": "",
  ...
  },
  {
    ...
    "level": "상",
    "category": "이항정리",
    "content": "다항식 4(x+a)^n의 전개식에서 x^{n-2}의 계수와 다항식 (x-1)(x+a)^n의 전개식에서 x^{n-2}의 계수가 같게 되는 모든 순서쌍 (a, n)에 대하여 an의 최댓값을 구하시오. (단, a는 자연수이고, n은 n \\ge 3인 자연수이다.)",
    "choices": [],
    "answer": "45",
    "solution": "4(x+a)^n에서 x^{n-2}의 계수: 4 \\times {}_nC_{n-2} \\times a^2 = 4 \\times \\frac{n(n-1)}{2} a^2 = 2n(n-1)a^2\n(x-1)(x+a)^n = x(x+a)^n - (x+a)^n 이다.\n여기서 x^{n-2}의 계수는 (x+a)^n의 x^{n-3}항 계수에 x를 곱한 것과 (x+a)^n의 x^{n-2}항 계수에 -1을 곱한 것의 합이다.\n\\rightarrow {}_nC_{n-3} a^3 - {}_nC_{n-2} a^2 = \\frac{n(n-1)(n-2)}{6} a^3 - \\frac{n(n-1)}{2} a^2\n두 계수가 같으므로:\n2n(n-1)a^2 = \\frac{n(n-1)(n-2)}{6} a^3 - \\frac{n(n-1)}{2} a^2\na \\ge 1, n \\ge 3이므로 양변을 n(n-1)a^2로 나눈다.\n2 = \\frac{n-2}{6} a - \\frac{1}{2} \\rightarrow \\frac{5}{2} = \\frac{(n-2)a}{6} \\rightarrow (n-2)a = 15\na, n은 자연수이고 n \\ge 3이므로 n-2 \\ge 1 이다.\n(n-2, a)의 조합은 (1, 15), (3, 5), (5, 3), (15, 1) 이며 이에 따른 (n, a)는 (3, 15), (5, 5), (7, 3), (17, 1) 이다.\nan의 값을 각각 구하면 45, 25, 21, 17 이다.\n따라서 an의 최댓값은 45이다.",
    "originalCategory": "",
    "standardCourse": "",
    "standardUnitKey": "",
    "standardUnit": "",
