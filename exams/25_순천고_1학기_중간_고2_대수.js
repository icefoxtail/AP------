...
window.questionBank = [
  ...
  {
    "id": 8,
    "content": "정의역이 \\{x\\,|\\,x\\leq 0\\}인 함수 $y=\\sqrt{3}\\,x$의 그래프 위의 원점이 아닌 한 점 $P$에 대해 동경 $OP$가 나타내는 각의 크기를 $\\theta$라 할 때 $\\sin\\theta$의 값은? (단, O는 원점이고 시초선은 x축의 양의 부분이다.) (3.7점)",
    "choices": [
      "-\\frac{\\sqrt{3}}{2}",
      "-\\frac{\\sqrt{2}}{2}",
      "-\\frac{1}{2}",
  ...
  {
    "id": 12,
    "content": "정의역이 \\{x\\,|\\,\\frac{1}{4} \\le x \\le 8\\}인 함수 $y=|\\log_{\\frac{1}{2}}x|+2$의 최댓값과 최솟값의 합은? (단, '||'은 절댓값 기호이다.) (4.3점)",
    "choices": [
      "7",
      "8",
      "9",
  ...
  },
  {
    ...
    "standardCourse": "대수",
    "standardUnitKey": "RAW-삼각함수의최대와최소",
    "standardUnit": "삼각함수의 최대와 최소",
  ...
  {
    "id": 15,
    "content": "$0 < a < 1$일 때, 함수 $y=a^{x^2-2x-1}$의 최댓값이 9이다. 이때, $0 \\le x \\le 3$에서 함수의 최솟값이 $m$이라고 하면 $a+m$의 값은? (4.4점)",
    "choices": [
      "\\frac{10}{3}",
      "\\frac{7}{3}",
      "\\frac{13}{9}",
  ...
  },
  {
    ...
    "standardCourse": "대수",
    "standardUnitKey": "RAW-로그의실생활활용",
    "standardUnit": "로그의 실생활 활용",
    "standardUnitOrder": 999,
  ...
  {
    "id": 21,
    "content": "각 $\\theta$를 나타내는 동경과 각 $3\\theta$를 나타내는 동경이 $y$축에 대하여 대칭이라고 하자. $\\sin\\theta+\\cos\\theta<0$일 때, $\\tan(\\theta+\\frac{7}{12}\\pi)$의 값을 구하는 과정을 풀이 과정과 함께 서술하시오. (단, $0 < \\theta < 2\\pi$이다.) (4점)",
