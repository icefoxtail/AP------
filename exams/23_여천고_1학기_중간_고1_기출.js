...
window.questionBank = [
  {
    ...
    "level": "중",
    "category": "다항식의 연산",
    "content": "두 다항식 $A, B$에 대하여\n$A+B=3x^2-2xy+y^2$, $A-B=-x^2+4xy-5y^2$\n일 때, $B-2A=ax^2+bxy+cy^2$이다. $a+b+c$의 값은? (단, $a, b, c$는 실수이다.)",
    "choices": [
      "$-4$",
      "$-2$",
      "$0$",
  ...
  },
  {
    ...
    "level": "중",
    "category": "이차방정식",
    "content": "다음 <보기>에서 서로 다른 두 실근을 갖는 이차방정식을 모두 고르면?\n<보기>\nㄱ. $4x^2-x-1=0$\nㄴ. $9x^2+6x+1=0$\nㄷ. $x^2-3x+6=0$\nㄹ. $3x^2-6x+1=0$",
    "choices": [
      "ㄱ",
      "ㄱ, ㄴ",
      "ㄴ, ㄷ",
  ...
  },
  {
    ...
    "level": "상",
    "category": "이차함수",
    "content": "[도형필요] 두 이차함수 $f(x)=x^2-ax+b$, $g(x)=-x^2+cx-d$에 대하여 그림과 같이 함수 $y=f(x)$의 그래프는 $x$축에 접하고, 두 함수 $y=f(x)$와 $y=g(x)$의 그래프는 제1사분면과 제2사분면에서 만난다. <보기>에서 옳은 것만을 있는대로 고른 것은?\n<보기>\nㄱ. $a^2-4b=0$\nㄴ. $a^2-4d<0$\nㄷ. $(a+c)^2-8(b+d)>0$",
    "choices": [
      "ㄱ",
      "ㄱ, ㄴ",
      "ㄴ, ㄷ",
  ...
  },
  {
    ...
    "level": "상",
    "category": "이차함수",
    "content": "이차함수 $f(x)=ax^2+bx+c$가 다음 조건을 만족시킬 때, $f(0)$의 값을 구하시오. (단, $a, b, c$는 상수이다.)\n<보기>\n(가) $f(-1)=f(5)$\n(나) 함수 $y=f(x)$의 그래프의 꼭짓점의 $y$좌표는 $-3$이다.\n(다) 함수 $y=f(x)$의 그래프가 $x$축과 두 점 $P, Q$에서 만나고 $\\overline{PQ}=2$이다.",
    "choices": [],
    "answer": "9",
