window.examTitle = "21_왕운중3_1학기_중간_중3";
...
window.questionBank = [
  ...
  },
  {
    ...
    "choices": ["x^{2}-2xy-y^{2}-1", "x^{2}-2xy+y^{2}-1", "x^{2}+2xy-y^{2}-1", "x^{2}+2xy+y^{2}-1", "x^{2}+2xy+y^{2}+1"],
    "answer": "2",
