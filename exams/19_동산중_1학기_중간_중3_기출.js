...
window.questionBank = [
    {
        ...
        choices: ["(-3)의 제곱근은 $\\pm 3$이다.", "$\\sqrt{64}$의 제곱근은 $\\pm 8$이다.", "제곱근 5는 $\\sqrt{5}$이다.", "의 제곱근은 없다.", "$\\sqrt{(-16)^{2}}$의 음의 제곱근은 -4이다."],
        answer: "③, ⑤",
        category: "제곱근과 실수",
    ...
    },
    {
        ...
        choices: ["$\\sqrt{3}\\times\\sqrt{12}=6$", "$3\\sqrt{3}\\times\\sqrt{18}\\times\\sqrt{\\frac{1}{6}}=9$", "$3\\sqrt{w}:\\sqrt{3}=3\\sqrt{2}$", "$\\sqrt{\\frac{3}{16}}\\times\\sqrt{\\frac{2}{3}}\\div\\sqrt{2}=\\frac{1}{8}$", "$\\sqrt{48}\\div\\sqrt{4}\\times\\sqrt{3}=6$"],
        answer: "④",
    ...
    },
    {
        ...
        choices: ["$10\\text{cm}$", "$\\sqrt{10}\\text{cm}$", "$5\\sqrt{2}\\text{cm}$", "$2\\sqrt{5}\\text{cm}$", "$5\\text{cm}$"],
        answer: "③",
        category: "제곱근과 실수",
        originalCategory: "제곱근과 실수",
        standardCourse: "중3 수학",
        ...
        standardUnit: "제곱근과 실수",
        standardUnitOrder: 1,
        solution: "전체 정사각형 넓이는 100이다. 색칠된 부분은 전체의 절반이므로 넓이가 50이다. 한 변의 길이는 $\\sqrt{50}=5\\sqrt{2}\\text{cm}$이다."
    },
    {
        id: "8",
    ...
    },
    {
        ...
        choices: ["$-\\sqrt{18}>-4$", "$2\\sqrt{11}>3\\sqrt{5}$", "$\\sqrt{2}+1>3$", "$5\\sqrt{6}+\\sqrt{7}>\\sqrt{7}+6\\sqrt{5}$", "$3\\sqrt{3}-4\\sqrt{2}>-2\\sqrt{3}+2\\sqrt{2}$"],
        answer: "⑤",
        category: "제곱근과 실수",
        originalCategory: "제곱근과 실수",
        standardCourse: "중3 수학",
    ...
    },
    {
        ...
        choices: ["$a^{2}+8a+16$", "$\\frac{1}{4}x^{2}+x+1$", "$1+2y+y^{2}$", "$9a^{2}+30ab+16b^{2}$", "$3x^{2}-12xy+12y^{2}$"],
        answer: "④",
        category: "인수분해",
        originalCategory: "인수분해",
        standardCourse: "중3 수학",
    ...
    },
    {
        ...
        choices: ["$x^{2}-49=(x-7)^{2}$", "$x^{2}+x-6=(x-3)(x+2)$", "$x^{2}-4x+4=(x+2)^{2}$", "$2a^{2}-8ab+4a=2a(a-4ab+2)$", "$x^{2}-25=(x+5)(x-5)$"],
        answer: "⑤",
        category: "인수분해",
        originalCategory: "인수분해",
        standardCourse: "중3 수학",
    ...
    },
    {
        ...
        choices: ["$50\\pi\\text{cm}^{2}$", "$60\\pi\\text{cm}^{2}$", "$75\\pi\\text{cm}^{2}$", "$85\\pi\\text{cm}^{2}$", "$100\\pi\\text{cm}^{2}$"],
        answer: "⑤",
        category: "인수분해의 활용",
    ...
    },
    {
        ...
        choices: ["x+2", "x+3", "x+5", "x+5", "$x^{2}+5x+6$"],
        answer: "①",
        category: "인수분해",
        originalCategory: "인수분해",
        standardCourse: "중3 수학",
    ...
    },
    {
        ...
        choices: ["$2\\times 91^{2}-2\\times 9^{2}$", "$103\\times 97$", "$x=103$ 일 때 $x^{2}-6x+9$의 값", "$47\\times 62+38\\times 47$", "$11^{2}-2^{2}+13^{2}-14^{2}+15^{2}-16^{2}$"],
        answer: "①",
        category: "인수분해의 활용",
        originalCategory: "인수분해의 활용",
        standardCourse: "중3 수학",
