window.examTitle = "유리수와순환소수_중2_유형";
...
window.questionBank = [
  ...
  },
  {
    ...
    "choices": [
      "$x = 1.2\\dot{5} \\implies 100x - 10x$",
      "$x = 0.\\dot{4}\\dot{7} \\implies 100x - x$",
      "$x = 0.5\\dot{6} \\implies 1000x - 10x$",
      "$x = 3.2\\dot{1}\\dot{8} \\implies 1000x - 10x$",
  ...
  },
  {
    ...
    "choices": [
      ...
      "기약분수의 분모에 $2, 5$ 이외의 소인수가 있으면 순환소수가 된다.",
      "$0$은 유리수이다.",
