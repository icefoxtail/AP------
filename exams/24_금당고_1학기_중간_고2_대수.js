...
window.questionBank = [
        ...
        },
    {
            ...
            choices: ["\\frac{1}{9}", "\\frac{1}{3}", "3", "9", "27"],
            answer: "⑤",
            category: "지수",
            originalCategory: "지수",
            standardCourse: "대수",
        ...
        },
    {
            ...
            choices: ["0", "\\log_a a", "\\log_c c", "\\log_b b", "1"],
            answer: "⑤",
            category: "로그",
            originalCategory: "로그",
            standardCourse: "대수",
        ...
        },
    {
            ...
            choices: ["\\frac{\\pi}{18}", "\\frac{\\pi}{9}", "\\frac{2\\pi}{9}", "\\frac{4\\pi}{9}", "\\frac{8\\pi}{9}"],
            answer: "③",
            category: "부채꼴",
        ...
        },
    {
            ...
            choices: ["0", "\\frac{\\pi}{2}", "\\pi", "\\frac{3\\pi}{2}", "2\\pi"],
            answer: "③",
            category: "삼각방정식",
        ...
        },
    {
            ...
            choices: ["0", "\\frac{\\sqrt{3}}{3}", "\\frac{\\sqrt{2}}{2}", "\\frac{\\sqrt{3}}{2}", "\\sqrt{3}"],
            answer: "②",
            category: "삼각부등식",
