window.examTitle = "25_효천고_1학기_중간_고2_대수";
...
window.questionBank = [
  ...
  },
  {
    ...
    "answer": "②",
    "solution": "1단계: 그림은 중심각이 $\\frac{2}{3}\\pi$인 환부채꼴이다.<br>2단계: 바깥 반지름은 $12 cm$, 안쪽 반지름은 $6 cm$이다.<br>3단계: 넓이는 $\\frac12\\theta(R^2-r^2)$ 이므로<br>$\\frac12\\cdot\\frac{2\\pi}{3}\\cdot(12^2-6^2)=\\frac{\\pi}{3}(144-36)=\\frac{\\pi}{3}\\cdot108=36\\pi$<br>* 검산: 정답 ②"
  },
  {
    "id": 10,
    "level": "",
