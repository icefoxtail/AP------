...
window.questionBank = [
  ...
  },
  {
    ...
    "solution": "(1) $h(t)=0$에서 $-5t^2+4t+2=0$이므로 근의 공식에 의해 $t=\\frac{-4\\pm\\sqrt{16+40}}{-10} = \\frac{2\\pm\\sqrt{14}}{5}$이다. $t>0$이므로 $t=\\frac{2+\\sqrt{14}}{5}$초이다. (2) $h(t)=-5(t-\\frac{2}{5})^2+\\frac{14}{5}$이므로 $t=\\frac{2}{5}$일 때 최대 높이 $\\frac{14}{5}m$를 갖는다. (3) $0 \\le t \\le 1$ 범위에서 $h(0)=2, h(1)=1$이므로 최소 높이는 $1m$이다."
  },
  {
    "id": 22,
    "level": "중",
