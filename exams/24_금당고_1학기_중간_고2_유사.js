...
window.questionBank = [
        ...
        },
    {
            ...
            choices: ["$100^\\circ$", "$200^\\circ$", "$300^\\circ$", "$400^\\circ$", "$600^\\circ$"],
            answer: "①",
            category: "삼각함수",
        ...
        },
    {
            ...
            choices: ["-\\frac{\\sqrt{15}}{4}", "\\frac{\\sqrt{15}}{4}", "-\\frac{\\sqrt{15}}{3}", "\\frac{\\sqrt{15}}{3}", "-\\frac{1}{4}"],
            answer: "①",
            category: "삼각함수",
            originalCategory: "삼각함수",
            standardCourse: "수학(상)",
        ...
        },
    {
            ...
            choices: ["\\frac{\\pi}{8}", "\\frac{\\pi}{4}", "\\frac{\\pi}{2}", "\\pi", "2\\pi"],
            answer: "②",
            category: "부채꼴",
        ...
        },
    {
            ...
            choices: ["\\pi", "\\frac{4\\pi}{3}", "\\frac{3\\pi}{2}", "2\\pi", "\\frac{5\\pi}{2}"],
            answer: "④",
            category: "삼각방정식",
        ...
        },
    {
            ...
            choices: ["0", "\\frac{\\sqrt{3}}{3}", "\\frac{\\sqrt{2}}{2}", "1", "\\sqrt{3}"],
            answer: "④",
            category: "삼각부등식",
        ...
        },
    {
            ...
            choices: ["\\sqrt{2}", "\\frac{3\\sqrt{2}}{2}", "2\\sqrt{2}", "\\frac{5\\sqrt{2}}{2}", "3\\sqrt{2}"],
            answer: "⑤",
            category: "삼각함수",
            originalCategory: "삼각함수",
            standardCourse: "수학(상)",
