...
window.questionBank = [
    {
        ...
        choices: ["$\\frac{5}{14}$", "$\\frac{20}{28}$", "$\\frac{1}{14}$", "$\\frac{7}{3 \\times 5^2}$", "$\\frac{36}{2 \\times 3^2 \\times 5}$"],
        answer: "⑤",
        category: "유한소수의 판별",
    ...
    },
    {
        ...
        choices: ["순환마디에 점을 찍어 나타내면 $x=0.\\dot{2}\\dot{5}$이다.", "$100x - x = 25$ 이다.", "순환마디는 $2525$이다.", "$x=\\frac{25}{90}$", "$x$는 유한소수이다."],
        answer: "①",
        category: "순환소수의 이해",
    ...
    },
    {
        ...
        choices: ["$3.0272727\\dots = 3.0\\dot{2}\\dot{7}$", "$1.3464646\\dots = 1.\\dot{3}4\\dot{6}$", "$-2.454545\\dots = 2.\\dot{4}\\dot{5}$", "$0.232323\\dots = 0.2\\dot{3}$", "$0.104104104\\dots = 0.\\dot{1}0\\dot{4}$"],
        answer: "①",
        category: "순환소수의 표현",
    ...
    },
    {
        ...
        choices: ["$\\frac{54}{11}$", "$\\frac{50}{11}$", "$\\frac{48}{11}$", "$\\frac{46}{11}$", "$\\frac{42}{11}$"],
        answer: "①",
        category: "순환소수와 역수",
    ...
    },
    {
        ...
        choices: ["$a \\div (b \\times c) = \\frac{ab}{c}$", "$a \\div (b \\div c) = \\frac{ac}{b}$", "$a \\times (b \\div c) = \\frac{a}{bc}$", "$(a \\div b) \\times c = \\frac{b}{ac}$", "$(a \\div b) \\div c = \\frac{ac}{b}$"],
        answer: "②",
        category: "식의 계산",
    ...
    },
    {
        id: "10",
        content: "다음 중 옳은 것을 구하면? [3점]",
        choices: ["$(a^3b)^2 = a^3b^2$", "$(-xy^3)^2 = -x^2y^6$", "$\\left(-\\frac{y^2z^3}{x^2}\\right)^2 = \\frac{y^4z^6}{x^4}$", "$\\left(\\frac{c}{ab^2}\\right)^3 = \\frac{c^3}{ab^6}$", "$\\left(-\\frac{2x^2}{3y}\\right)^3 = -\\frac{8x^6}{9y^3}$"],
        answer: "③",
        category: "지수법칙",
    ...
    },
    {
        ...
        choices: ["$x-2$", "$2x-3$", "$3x-4$", "$4x-5$", "$5x-6$"],
        answer: "②",
        category: "다항식의 계산",
    ...
    },
    {
        ...
        choices: ["$6x^2+x$", "$6x^2+3x$", "$3x$", "$-6x^2-3x$", "$-6x^2-x$"],
        answer: "③",
        category: "다항식의 계산",
        originalCategory: "다항식의 계산",
        standardCourse: "중2 수학",
    ...
    },
    {
        ...
        choices: ["$(a^2)^3=a^\\Box$", "$(x^4)^2 \\div x^3=x^\\Box$", "$x \\times y^4 \\times (x^3)^2=x^\\Box y^4$", "$\\left(-\\frac{b^3}{a^2}\\right)^4 = \\frac{b^{12}}{a^\\Box}$", "$(x^4)^3 \\div x^4 \\div (x^3)^2 = x^\\Box$"],
        answer: "④",
        category: "지수법칙",
        originalCategory: "지수법칙",
        standardCourse: "중2 수학",
    ...
    },
    {
        ...
        choices: ["$-9a^{10}b^8$", "$9a^{10}b^8$", "$-\\frac{1}{9}a^{10}b^8$", "$-\\frac{1}{9}a^8b^4$", "$9a^8b^{10}$"],
        answer: "①",
        category: "단항식의 계산",
    ...
    },
    {
        ...
        choices: ["$\\frac{5}{2}ab + \\frac{1}{2}b^2$", "$\\frac{5}{2}ab + \\frac{3}{2}b^2$", "$\\frac{7}{2}ab + \\frac{1}{2}b^2$", "$\\frac{9}{2}ab + \\frac{3}{2}b^2$", "$\\frac{11}{2}ab + \\frac{3}{2}b^2$"],
        answer: "⑤",
        category: "도형과 다항식",
