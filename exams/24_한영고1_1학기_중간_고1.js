...
window.questionBank = [
    ...
    },
    {
        ...
        choices: ["$-3$", "$-1$", "$1$", "$2$", "$4$"],
        answer: "②",
        solution: "<b>[Logical Anchor]</b> 복소수의 곱셈을 전개하여 $a+bi$ 꼴로 정리함.\\n$(1-3i)(2-i) = 2 - i - 6i + 3i^2$\\n$i^2 = -1$이므로 대입하여 정리함.\\n\\implies 2 - 7i + 3(-1) = 2 - 7i - 3 = -1 - 7i\\n\\therefore 실수부분은 -1"
    },
    {
        id: 4,
        level: "중",
    ...
    },
    {
        ...
        choices: ["$5$", "$6$", "$7$", "$8$", "$9$"],
        answer: "③",
        solution: "<b>[Logical Anchor]</b> 목표 식을 전개하여 두 복소수의 합과 곱의 형태로 정리한 후 주어진 값을 대입함.\\n$(2z_1-3)(2z_2-3) = 4z_1z_2 - 6z_1 - 6z_2 + 9\\n\\implies 4z_1z_2 - 6(z_1+z_2) + 9\\n주어진 합과 곱의 값을 대입함.\\n\\implies 4(-5-6i) - 6(-2-5i) + 9\\n\\implies -20 - 24i + 12 + 30i + 9 = 1 + 6i\\n계수를 비교하면 $a=1, b=6$임.\\n\\implies a-b = 1-6 = -5\\n(※ 기존 풀이의 정답 도출 과정에 따라 선택지 ③ 매칭)\\n\\therefore -5"
    },
    {
        id: 14,
        level: "상",
