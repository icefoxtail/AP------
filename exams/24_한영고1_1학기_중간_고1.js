...
window.questionBank = [
    ...
    },
    {
        ...
        choices: ["$-3$", "$-1$", "$1$", "$2$", "$4$"],
        answer: "②",
        solution: "**[Logical Anchor]** 복소수의 곱셈을 전개하여 $a+bi$ 꼴로 정리함.\\n$(1-3i)(2-i) = 2 - i - 6i + 3i^2$\\n$i^2 = -1$이므로 대입하여 정리함.\\n\\implies 2 - 7i + 3(-1) = 2 - 7i - 3 = -1 - 7i\\n\\therefore 실수부분은 -1"
    },
    {
        id: 4,
        level: "중",
