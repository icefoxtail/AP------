...
window.questionBank = [
  {
    ...
    "choices": ["$x^2-6xy-5y^2$", "$x^2+6xy+5y^2$", "$-2x^2+11xy-15y^2$", "$-2x^2-11xy-15y^2$", "$-2x^2+11xy+15y^2$"],
    "answer": "3",
    "solution": "$(-x+3y)(2x-5y) = -2x^2 + 5xy + 6xy - 15y^2 = -2x^2 + 11xy - 15y^2$."
  },
  {
    "id": 2,
    "level": "[중]",
    ...
    "choices": ["$\\pm 3$", "$\\sqrt{81}$의 제곱근", "제곱근 9", "제곱하여 9가 되는 수", "$x^2=9$를 만족시키는 $x$의 값"],
    "answer": "3",
    "solution": "1, 2, 4, 5는 $\\pm 3$이고, 3번은 $3$임."
  },
  {
    "id": 3,
    "level": "[중]",
    "category": "다항식의 곱셈",
    "content": "$(ax+3)^2 = 16x^2 - 24x + b$일 때, $a+b$의 값은? [4점]",
    "choices": ["15", "13", "9", "7", "5"],
    "answer": "5",
    "solution": "$a=-4, b=9$이므로 $a+b=5$."
  },
  {
    "id": 4,
    "level": "[중]",
    ...
    "answer": "1",
    "solution": "$(x+2a)^2-(2a)^2$에서 $A=x+2a, B=2a$이므로 $A-B=x$."
  },
  {
    "id": 5,
    "level": "[중]",
  ...
  },
  {
    ...
    "answer": "4",
    "solution": "$4.36 \\le x \\le 7.16$이므로 정수 부분 4, 5, 6, 7 가능."
  },
  {
    "id": 7,
    "level": "[중]",
  ...
  },
  {
    ...
    "level": "[중]",
    "category": "다항식의 곱셈",
    "content": "$102 \\times 105$ 계산 시 알맞은 공식과 결과는? [4점]",
    "choices": ["$(x+a)(x+b), 10710$", "$(x+a)(x+b), 10800$", "$(ax+b)(cx+d), 10710$", "$(ax+b)(cx+d), 10800$", "$(x+y)(x-y), 10020$"],
    "answer": "1",
    "solution": "$100^2 + (2+5)100 + 10 = 10710$."
  },
  {
    "id": 9,
    "level": "[중]",
  ...
  },
  {
    ...
    "choices": ["-7", "-3", "-1", "3", "7"],
    "answer": "1",
    "solution": "$(\\sqrt{7}-2) - (3-\\sqrt{7}) = 2\\sqrt{7}-5 \\implies a=-5, b=2 \\implies a-b=-7$."
  },
  {
    "id": 11,
    "level": "[중]",
    "category": "인수분해",
    "content": "인수분해 중에서 틀린 것을 모두 고르면? [4점]",
    "choices": ["가, 라", "가, 다", "가, 다, 마", "다, 라", "다, 라, 마"],
    "answer": "3",
    "solution": "가, 다, 마가 틀림."
  },
  {
  ...
  },
  {
    ...
    "level": "[중]",
    "category": "인수분해",
    "content": "$x^2+\\Box x+36$이 완전제곱식이 될 때, $\\Box$ 안의 수들의 곱은? [4점]",
    "choices": ["36", "100", "-100", "144", "-144"],
    "answer": "5",
    "solution": "$\\Box = \\pm 12$이므로 곱은 $-144$."
  },
  {
    "id": 14,
    "level": "[중]",
    ...
    "choices": ["$\\sqrt{56.2}=7.497$", "$\\sqrt{570}=75.50$", "$\\sqrt{0.0592}=0.2433$", "$\\sqrt{0.0058}=0.07616$", "$\\sqrt{5540000}=2354$"],
    "answer": "2",
    "solution": "$\\sqrt{570} = 10\\sqrt{5.7} = 23.87$."
  },
  {
    "id": 15,
    "level": "[상]",
    "category": "인수분해",
    "content": "$x^2+kx-36$이 $(x+m)(x+n)$으로 인수분해 될 때, $k$가 될 수 없는 것은? [5점]",
    "choices": ["-35", "-20", "0", "5", "16"],
    "answer": "2",
    "solution": "$mn=-36$인 정수쌍 중 합이 $-20$인 경우는 없음."
  },
  {
    "id": 16,
    "level": "[중]",
    "category": "인수분해",
    "content": "$2ab^2-4a^2b$를 인수분해하면? [3점]",
    "choices": ["$ab(2a-b)$", "$ab(b-2a)$", "$ab(2b-2a)$", "$2ab(b-2a)$", "$2ab(a-b)$"],
    "answer": "4",
    "solution": "$2ab(b-2a)$."
  },
  {
  ...
  },
  {
    ...
    "level": "[중]",
    "category": "인수분해",
    "content": "(가) $x^2-1$, (나) $x^2+3x-4$, (다) $2x^2-x-1$의 공통인수는? [4점]",
    "choices": ["$x-1$", "$x+4$", "$2x+1$", "$x+1$", "$5x+1$"],
    "answer": "1",
    "solution": "셋 다 $x-1$을 인수로 가짐."
  },
  {
    "id": 21,
    "level": "[중]",
