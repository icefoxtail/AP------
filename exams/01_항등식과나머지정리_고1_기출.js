...
window.questionBank = [
    {
    id: "1",
    content: "두두 다항식 $A, B$에 대하여 $2A + B = 2x^2 + 5xy + 10y^2$, $A - B = x^2 + xy - 4y^2$일 때, 다항식 $A - 2B$를 구하시오. [2024 부영여고 1-1 중간 01번]",
    choices: [
        "$$x^2 - 5y^2$",
        "$$x^2 - 10y^2$",
        "$$2x^2 + 5y^2$",
    ...
    answer: "②②",
    category: "다다항식의 연산",
    originalCategory: "다다항식의 연산",
    standardCourse: "수수학(상)",
    standardUnitKey: "HH15-SA-01",
    standardUnit: "다다항식의 연산",
    standardUnitOrder: 1,
    ...
    {
    id: "3",
    content: "다다항식 $6x^3 - x^2 - 5x + 3$을 $3x - 2$로 나누었을 때 몫을 $Q(x)$, 나머지를 $R$이라 할 때, $Q(1) + R$의 값을 구하시오. [2024 부영여고 1-1 중간 08번]",
    choices: [
        "11",
        "22",
        "33",
    ...
    answer: "③③",
    category: "나나머지 정리 (몫의 보정)",
    originalCategory: "나나머지 정리 (몫의 보정)",
    standardCourse: "수수학(상)",
    standardUnitKey: "HH15-SA-02",
    standardUnit: "항항등식과 나머지정리",
    standardUnitOrder: 2,
    ...
    {
    id: "4",
    content: "다다항식 $2x^3 - 9x^2 - 4x + 7$을 인수분해 하면 $(x+1)(2x^2 + bx + c)$일 때, $b+c$의 값을 구하시오. [2024 부영여고 1-1 중간 11번]",
    choices: [
        "--6",
        "--4",
        "--2",
    ...
    answer: "②②",
    category: "인인수분해와 조립제법",
    originalCategory: "인인수분해와 조립제법",
    standardCourse: "수수학(상)",
    standardUnitKey: "HH15-SA-01",
    standardUnit: "다다항식의 연산",
    standardUnitOrder: 1,
    ...
    answer: "③③",
    category: "다다항식 전개 응용",
    originalCategory: "다다항식 전개 응용",
    standardCourse: "수수학(상)",
    standardUnitKey: "RRAW-다항식전개응용",
    standardUnit: "다다항식 전개 응용",
    ...
    {
    id: "6",
    content: "모모든 자연수 $n$에 대하여 $x^n(x^2+ax+b)$를 $(x-2)^2$으로 나누었을 때의 나머지가 $2^n(x-2)$일 때, $a+b$의 값을 구하시오. [2024 부영여고 1-1 중간 15번]",
    choices: [
        "--2",
        "--1",
        "00",
    ...
    {
    id: "7",
    content: "다다항식 $f(x) = x^3 - x^2 + ax + b$를 $x^2-2x-2$로 나누었을 때의 몫을 $Q(x)$, 나머지를 $R(x)$라 하자. $R(2)=6$이고, $f(x)$는 $Q(x)$로 나누어떨어질 때, $f(3)$의 값을 구하시오. [2024 부영여고 1-1 중간 서술형 1번]",
    choices: [
        "  ",
        "  ",
        "  ",
    ...
    answer: "330",
    category: "서서술형 (나눗셈의 관계)",
    originalCategory: "서서술형 (나눗셈의 관계)",
    standardCourse: "수수학(상)",
    standardUnitKey: "RRAW-서술형(나눗셈의관계)",
    standardUnit: "서서술형 (나눗셈의 관계)",
    standardUnitOrder: 999,
    ...
    {
    id: "8",
    content: "두두 다항식 $A, B$에 대하여 $2A + B = 3x^2 - 2xy - y^2$, $A - B = -x^2 + 4xy + 5y^2$일 때, $A + 2B = ax^2 + bxy + cy^2$이다. $a+b+c$의 값을 구하시오. [2024 한영고 1-1 중간 01번]",
    choices: [
        "--10",
        "--8",
        "--6",
    ...
    answer: "③③",
    category: "세세제곱 공식",
    originalCategory: "세세제곱 공식",
    standardCourse: "수수학(상)",
    standardUnitKey: "RRAW-세제곱공식",
    standardUnit: "세세제곱 공식",
    standardUnitOrder: 999,
    solution: "$$x^3 + y^3 = (x+y)^3 - 3xy(x+y)$\\n$\\implies 4^3 - 3(2)(4)$\\n$= 64 - 24 = 40$\\n$\\therefore 40$"
},
    {
    id: "10",
    content: "등등식 $a(x-1)(x+1) + bx(x-1) + cx(x+1) = 2x^2 + 3x + 4$가 $x$에 대한 항등식일 때, $-a+2b+2c$의 값을 구하시오. [2024 한영고 1-1 중간 08번]",
    choices: [
        "112",
        "114",
        "116",
    ...
    {
    id: "11",
    content: "다다항식 $x^2 - xy - 2y^2 - x - 7y - 6$이 $(x+ay-3)(x+by+c)$로 인수분해 될 때, $-2a+3b+c$의 값을 구하시오. [2024 한영고 1-1 중간 09번]",
    choices: [
        "55",
        "77",
        "99",
    ...
    {
    id: "12",
    content: "다다항식 $f(x)$를 $x+2$로 나누었을 때 몫이 $Q(x)$, 나머지가 $-4$이고 $Q(x)$를 $x-3$으로 나누었을 때 나머지가 $3$이다. $f(x)$를 $x^2-x-6$으로 나누었을 때의 나머지 $R(x)$에 대하여 $R(1)$의 값을 구하시오. [2024 한영고 1-1 중간 12번]",
    choices: [
        "11",
        "33",
        "55",
    ...
    answer: "③③",
    category: "나나머지 정리 (몫의 관계)",
    originalCategory: "나나머지 정리 (몫의 관계)",
    standardCourse: "수수학(상)",
    standardUnitKey: "HH15-SA-02",
    standardUnit: "항항등식과 나머지정리",
    standardUnitOrder: 2,
    ...
    {
    id: "13",
    content: "최최고차항 계수가 $1$인 이차식 $f(x)$가 $x+2$로 나누어떨어진다. $f(x^2)$을 $f(x)$로 나누었을 때의 나머지가 $10x+2$일 때, $f(2)$의 값을 구하시오. [2024 한영고 1-1 중간 15번]",
    choices: [
        "--25",
        "--20",
        "--15",
    ...
    {
    id: "14",
    content: "등등식 $x^3 - 4x^2 + 3x - 5 = a(x-2)^3 + b(x-2)^2 + c(x-2) + d$가 항등식일 때, $ab + cd$의 값을 구하시오. [2024 한영고 1-1 중간 17번]",
    choices: [
        "55",
        "77",
        "99",
    ...
    {
    id: "15",
    content: "다다항식 $2x^3 - 4x^2 + 5$를 $x^2 - 3x - 1$로 나눈 (가)몫의 상수항, (나)몫의 일차항, (다)나머지일 때, (가)+(나)+(다)를 구하시오. [2024 한영고 1-1 중간 서답형 1번]",
    choices: [
        "  ",
        "  ",
        "  ",
    ...
    {
    id: "16",
    content: "다다항식 $x^4 + 5x^2 + 9$를 인수분해 하시오. [2024 여천고 1-1 중간 10번]",
    choices: [
        "  ",
        "  ",
        "  ",
    ...
    {
    id: "17",
    content: "다다항식 $f(x)$를 $x-1$로 나눈 나머지 $3$, $x+2$로 나눈 나머지 $-3$일 때, $f(x)$를 $x^2+x-2$로 나눈 나머지 $R(3)$의 값을 구하시오. [2024 여천고 1-1 중간 12번]",
    choices: [
        "33",
        "55",
        "77",
    ...
    {
    id: "18",
    content: "다다항식 $f(x)$를 $(x-1)^2$으로 나눈 나머지 $x+2$, $x-2$로 나눈 나머지 $4$일 때, $f(x)$를 $(x-1)^2(x-2)$로 나눈 나머지 $R(3)$의 값을 구하시오. [2023 중앙여고 1-1 중간 13번]",
    choices: [
        "11",
        "33",
        "55",
    ...
    answer: "③③",
    category: "나나머지 정리 (완전제곱식)",
    originalCategory: "나나머지 정리 (완전제곱식)",
    standardCourse: "수수학(상)",
    standardUnitKey: "HH15-SA-01",
    standardUnit: "다다항식의 연산",
    standardUnitOrder: 1,
    ...
    {
    id: "20",
    content: "다다항식 $x^3 + ax + b$가 $(x-1)^2$으로 나누어떨어질 때, $a-b$의 값을 구하시오. [2023 중앙여고 1-1 중간 09번]",
    choices: [
        "--7",
        "--5",
        "--3",
    ...
    {
    id: "21",
    content: "다다항식 $(x^2 - 4x + 3)(x^2 - 4x - 2) - 6$을 인수분해 하시오. [2024 한영고 1-1 중간 11번]",
    choices: [
        "  ",
        "  ",
        "  ",
    ...
    answer: "③③",
    category: "고고차식 변형",
    originalCategory: "고고차식 변형",
    standardCourse: "수수학(상)",
    standardUnitKey: "RRAW-고차식변형",
    standardUnit: "고고차식 변형",
    standardUnitOrder: 999,
    ...
    {
    id: "23",
    content: "다다항식 $f(x)$를 $x^2+1$로 나누었을 때 나머지가 $x+1$이고, $(x-1)^2$으로 나누어떨어지는 3차식이다. $f(0)=2$일 때 $f(2)$를 구하시오. [2024 충무고 1-1 중간 14번]",
    choices: [
        "--14",
        "--12",
        "110",
    ...
    answer: "몫몫: $2x^2-x+3$, 나머지: 10",
    category: "조조립제법",
    originalCategory: "조조립제법",
    standardCourse: "수수학(상)",
    standardUnitKey: "HH15-SA-01",
    standardUnit: "다다항식의 연산",
    standardUnitOrder: 1,
    ...
    answer: "①①",
    category: "숫숫자의 나눗셈",
    originalCategory: "숫숫자의 나눗셈",
    standardCourse: "수수학(상)",
    standardUnitKey: "RRAW-숫자의나눗셈",
    standardUnit: "숫숫자의 나눗셈",
    standardUnitOrder: 999,
    solution: "$$x=2024$ 치환\\n$x^{10} = (x-1)Q(x) + R$\\n$x=1$ 대입 $\\implies R = 1^{10} = 1$\\n$\\therefore 1$"
},
    {
    id: "26",
    content: "다다항식 $f(x)$를 $(x-1)^2$으로 나눈 나머지는 $2x-1$이고, $x+1$로 나눈 나머지는 $1$이다. $f(x)$를 $(x-1)^2(x+1)$로 나눈 나머지 $R(2)$를 구하시오. [2023 여천고 1-1 중간 14번]",
    choices: [
        "11",
        "44",
        "77",
    ...
    answer: "xx+5",
    category: "나나머지 정리의 조합",
    originalCategory: "나나머지 정리의 조합",
    standardCourse: "수수학(상)",
    standardUnitKey: "HH15-SA-02",
    standardUnit: "항항등식과 나머지정리",
    standardUnitOrder: 2,
    ...
    answer: "④④",
    category: "세세제곱 변형",
    originalCategory: "세세제곱 변형",
    standardCourse: "수수학(상)",
    standardUnitKey: "RRAW-세제곱변형",
    standardUnit: "세세제곱 변형",
    standardUnitOrder: 999,
    solution: "$$x^3-y^3 = (x-y)^3 + 3xy(x-y)$\\n$\\implies 2^3 + 3(3)(2)$\\n$= 8 + 18 = 26$\\n$\\therefore 26$"
},
    {
    id: "30",
    content: "등등식 $x^2-x-2 = a(x-1)^2 + b(x-1) + c$가 $x$에 대한 항등식일 때, $a+b+c$의 값을 구하시오. [2024 한영고 1-1 중간 10번]",
    choices: [
        "--2",
        "--1",
        "00",
    ...
    answer: "③③",
    category: "항항등식의 성질",
    originalCategory: "항항등식의 성질",
    standardCourse: "수수학(상)",
    standardUnitKey: "HH15-SA-02",
    standardUnit: "항항등식과 나머지정리",
    standardUnitOrder: 2,
    solution: "구구하고자 하는 $a+b+c$ 꼴을 만들기 위해 우변의 괄호 안이 $1$이 되는 $x=2$를 대입.\\n$x=2$ 대입 $\\implies 2^2 - 2 - 2 = a(1)^2 + b(1) + c$\\n$\\implies 4 - 4 = a+b+c$\\n$\\therefore a+b+c = 0$"
},
    {
    id: "31",
    content: "삼삼각형의 세 변의 길이 $a, b, c$에 대하여 $a^3+b^3+c^3-3abc=0$이 성립할 때, 어떤 삼각형인가? [2023 여천고 1-1 중간 서술형 2번]",
    choices: [
        "정정삼각형",
        "이이등변삼각형",
        "직직각삼각형",
    ...
    {
    id: "32",
    content: "다다항식 $f(x)$를 $x^2+1$로 나누었을 때 몫이 $x-1$이고 나머지가 $2x+1$이다. $f(2)$의 값을 구하시오. [2023 충무고 1-1 중간 서술형 1번]",
    choices: [
        "66",
        "88",
        "110",
