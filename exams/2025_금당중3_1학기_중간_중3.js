...
window.questionBank = [
  {
    ...
    "choices": [
      ...
      "② \\sqrt{(-3)^2} = -3",
      "③ 제곱근 6은 \\sqrt{6}이다.",
      "④ \\sqrt{25}의 제곱근은 \\pm 5이다.",
      "⑤ (-6)^2의 제곱근은 \\pm \\sqrt{6}이다."
    ],
    "answer": "③",
    "solution": "[풀이전략] 제곱근의 정의와 성질을 이용하여 각 보기의 참/거짓을 판별한다.\\n① 64의 제곱근은 $\\pm 8$이다. (거짓)\\n② $\\sqrt{(-3)^2} = \\sqrt{9} = 3$이다. (거짓)\\n③ 제곱근 6은 $\\sqrt{6}$을 의미한다. (참)\\n④ $\\sqrt{25} = 5$이므로, 5의 제곱근은 $\\pm \\sqrt{5}$이다. (거짓)\\n⑤ $(-6)^2 = 36$이므로, 36의 제곱근은 $\\pm 6$이다. (거짓)\\n\\n$\\therefore$ 정답은 ③이다."
  },
  {
    "id": 2,
    "level": "중",
    ...
    "answer": "④",
    "solution": "[풀이전략] 제곱근의 성질 $\\sqrt{a^2} = |a|$, $(\\sqrt{a})^2 = a$ ($a \\ge 0$)를 이용한다.\\n① $\\sqrt{5^2} = 5$ (참)\\n② $-(\\sqrt{11})^2 = -11$ (참)\\n③ $\\sqrt{(-7)^2} = |-7| = 7$ (참)\\n④ $(-\\sqrt{6})^2 = 6$이다. (거짓)\\n⑤ $\\sqrt{16} = \\sqrt{4^2} = 4$ (참)\\n\\n$\\therefore$ 정답은 ④이다."
  },
  {
    "id": 3,
    "level": "중",
    "category": "제곱근과 실수",
    "content": "다음 보기 중에서 무리수로 나타내어지는 것의 개수는? [4점]\\n<보기>\\n\\sqrt{\\frac{4}{25}}, \\pi, \\sqrt{9}, 0.1\\dot{1}\\dot{5}, \\sqrt{11}, 2+\\sqrt{5}, \\sqrt{1000}",
    "choices": ["① 2", "② 3", "③ 4", "④ 5", "⑤ 6"],
    "answer": "③",
    "solution": "[풀이전략] 유리수(유한소수, 순환소수, 근호 없이 나타낼 수 있는 수)와 무리수(순환하지 않는 무한소수, 근호를 없앨 수 없는 수)를 구분한다.\\n- $\\sqrt{\\frac{4}{25}} = \\frac{2}{5}$ (유리수)\\n- $\\pi$ (무한소수, 무리수)\\n- $\\sqrt{9} = 3$ (유리수)\\n- $0.1\\dot{1}\\dot{5}$ (순환소수, 유리수)\\n- $\\sqrt{11}$ (무리수)\\n- $2+\\sqrt{5}$ (무리수)\\n- $\\sqrt{1000} = 10\\sqrt{10}$ (무리수)\\n\\n무리수는 $\\pi, \\sqrt{11}, 2+\\sqrt{5}, \\sqrt{1000}$으로 총 4개이다.\\n\\n$\\therefore$ 정답은 ③이다."
  },
  {
    "id": 4,
    "level": "중",
    "category": "제곱근과 실수",
    "content": "\\sqrt{20-n}이 자연수가 되도록 하는 자연수 n값 중 가장 작은 자연수를 A, 가장 큰 자연수를 B라 할 때, A+B의 값은? [4점]",
    "choices": ["① 23", "② 24", "③ 25", "④ 26", "⑤ 27"],
    "answer": "①",
    "solution": "[풀이전략] $\\sqrt{20-n}$이 자연수가 되려면 근호 안의 수 $20-n$이 0보다 큰 제곱수여야 한다.\\n$n$이 자연수이므로 $n \\ge 1$이고, $20-n < 20$이다.\\n20보다 작은 제곱수는 1, 4, 9, 16이다.\\n- $20-n = 1 \\implies n = 19$\\n- $20-n = 4 \\implies n = 16$\\n- $20-n = 9 \\implies n = 11$\\n- $20-n = 16 \\implies n = 4$\\n자연수 $n$은 4, 11, 16, 19이다.\\n최솟값 $A = 4$, 최댓값 $B = 19$이므로\\n$A+B = 4 + 19 = 23$\\n\\n$\\therefore$ 정답은 ①이다."
  },
  {
    "id": 5,
    "level": "중",
  ...
  },
  {
    ...
    "level": "중",
    "category": "제곱근과 실수",
    "content": "다음 중 두 실수의 대소 관계가 옳지 않은 것은? [4점]",
    "choices": [
      "① \\sqrt{2}+1 < \\sqrt{3}+1",
      "② 5-\\sqrt{6} < 2-\\sqrt{6}",
      "③ \\sqrt{11}-1 > 2",
    ...
    "answer": "②",
    "solution": "[풀이전략] 양변에 같은 수를 더하거나 빼서 크기를 비교한다.\\n① 양변에서 1을 빼면 $\\sqrt{2} < \\sqrt{3}$ (참)\\n② 양변에 $\\sqrt{6}$을 더하면 $5 < 2$ (거짓)\\n③ 양변에 1을 더하면 $\\sqrt{11} > 3 = \\sqrt{9}$ (참)\\n④ 양변에 3을 더하면 $\\sqrt{7} < \\sqrt{8}$ (참)\\n⑤ 양변에서 $\\sqrt{3}$을 빼면 $\\sqrt{2} < \\sqrt{5}$ (참)\\n\\n$\\therefore$ 정답은 ②이다."
  },
  {
    "id": 7,
    "level": "중",
    "category": "근호를 포함한 식의 계산",
    "content": "다음 중 분모를 유리화한 것으로 옳지 않은 것은? [4점]",
    "choices": [
  ...
  },
  {
    ...
    "answer": "③",
    "solution": "[풀이전략] 곱셈 공식을 검증한다.\\n③ $(x+5)^2 = x^2 + 10x + 25$ 이므로 $5x$는 틀리다."
  },
  {
    "id": 16,
    "level": "중",
    "category": "다항식의 곱셈과 인수분해",
    "content": "x^2 + (2p+1)x + 9가 완전제곱식이 될 때, 상수 p의 값을 모두 곱하면? [4점]",
    "choices": ["① -\\frac{35}{4}", "② -8", "③ -\\frac{13}{2}", "④ -\\frac{9}{2}", "⑤ -\\frac{15}{4}"],
    "answer": "①",
    "solution": "[풀이전략] $2p + 1 = \\pm 2\\sqrt{9} = \\pm 6$\\n- $2p+1=6 \\implies p=5/2$\\n- $2p+1=-6 \\implies p=-7/2$\\n곱: $5/2 \\times (-7/2) = -35/4$"
  },
  {
    "id": 17,
    "level": "중",
    "category": "다항식의 곱셈과 인수분해",
    "content": "(3x-y)^2 - (2x+y)(2x-y)를 계산할 때, x^2의 계수를 a, y^2의 계수를 b라고 하자. 이때 a+b의 값을 구하면? [4점]",
    "choices": ["① 3", "② 4", "③ 5", "④ 6", "⑤ 7"],
    "answer": "⑤",
    "solution": "[풀이전략] 전개 후 계수 비교.\\n$(9x^2 - 6xy + y^2) - (4x^2 - y^2) = 5x^2 - 6xy + 2y^2$\\n$a=5, b=2 \\implies a+b=7$"
  },
  {
    "id": 18,
    "level": "중",
    "category": "다항식의 곱셈과 인수분해",
    "content": "다음 중에서 x-2를 인수로 갖지 않는 다항식은? [4점]",
    "choices": [
      "① x^2-2x",
      "② x^2-4x+4",
      "③ x^2+x-2",
    ...
    "answer": "③",
    "solution": "[풀이전략] x=2 대입 시 0이 안 되는 것 찾기.\\n③ $2^2+2-2 = 4 \\neq 0$."
  },
  {
    "id": 19,
    "level": "상",
    "category": "제곱근과 실수",
    "content": "-2 < x < \\frac{1}{3}일 때, \\sqrt{x^2+4x+4} + \\sqrt{9x^2-6x+1}을 간단히 하면? [5점]",
    "choices": ["① -2x-3", "② -2x+3", "③ 4x+1", "④ 5x-1", "⑤ 5x+1"],
    "answer": "②",
    "solution": "[풀이전략] $|x+2| + |3x-1|$.\\n주어진 범위에서 $x+2 > 0, 3x-1 < 0$ 이므로\\n$(x+2) - (3x-1) = -2x+3$."
  },
  {
    "id": 20,
    "level": "상",
    "category": "다항식의 곱셈과 인수분해",
    "content": "x+y=4이고 x^2y+xy^2-x-y=16일 때, x^2+y^2의 값을 구하면? [4점]",
    "choices": ["① 2", "② 3", "③ 4", "④ 5", "⑤ 6"],
    "answer": "⑤",
    "solution": "[풀이전략] $(x+y)(xy-1) = 16 \\implies 4(xy-1)=16 \\implies xy=5$.\\n$x^2+y^2 = 4^2 - 2(5) = 6$."
  },
  {
    "id": 21,
    "level": "하",
