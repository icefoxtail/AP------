window.examTitle = "24_신흥중_1학기_중간_중2_기출";
...
window.questionBank = [
  ...
  },
  {
    ...
    "choices": [
      "$\\frac{14}{2^2 \\times 7}$",
      "$\\frac{1}{15}$",
      "$\\frac{3 \\times 7}{2 \\times 5 \\times 7^2}$",
      "$\\frac{6}{18}$",
      "$\\frac{45}{2^2 \\times 3^2 \\times 5^2}$"
    ],
    "answer": "①, ⑤",
    "category": "유한소수 판별",
  ...
  },
  {
    ...
    "choices": [
      "항이 4개이다.",
      "$3x^2$과 $\\frac{x}{3}$은 동류항이다.",
      "간단히 했을 때, $x$의 계수는 $\\frac{1}{3}$이다.",
      "상수항은 3이다.",
      "이 식은 일차식이다."
    ],
    "answer": "③",
