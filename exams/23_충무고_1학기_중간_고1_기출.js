...
window.questionBank = [
  ...
  },
  {
    "id": "4",
    "level": "중",
    "content": "다항식 $2x^3 - 3x^2 - 12x - 7$을 인수분해하면 $(x+a)^2(bx+c)$일 때, $a+b+c$의 값은?\n(단, $a, b, c$는 상수이다.)",
    "choices": [
      "-6",
      "-5",
      "-4",
  ...
  },
  {
    "id": "6",
    "level": "중",
    "content": "모든 실수 $x$에 대하여\n$(x^2 + 2x - 3)^3 = a_6x^6 + a_5x^5 + a_4x^4 + \\cdots + a_1x + a_0$이 성립할 때, $a_0 + a_2 + a_4 + a_6$의 값은?",
    "choices": [
      "32",
      "16",
      "0",
  ...
  },
  {
    "id": "12",
    "level": "상",
    "content": "$0$이 아닌 두 실수 $a, b$에 대하여 $\\frac{\\sqrt{a}}{\\sqrt{b}} = -\\sqrt{\\frac{a}{b}}$가 성립할 때, 항상 실근이 존재하는 방정식을 <보기>에서 있는 대로 고른 것은?\n\n<보기>\nㄱ. $x^2 + ax + b = 0$\nㄴ. $ax^2 + x + b = 0$\nㄷ. $ax^2 + ax - b = 0$",
    "choices": [
      "ㄱ",
      "ㄴ",
      "ㄱ,ㄴ",
  ...
  },
  {
    "id": "14",
    "level": "중",
    "content": "모든 실수 $x$에 대하여 부등식\n$4x^3 - 2x^2 + x + \\frac{1}{2} = a\\left(x - \\frac{1}{2}\\right)^3 + b\\left(x - \\frac{1}{2}\\right)^2 + c\\left(x - \\frac{1}{2}\\right) + d$\n가 성립할 때, 상수 $a, b, c, d$에 대하여 $ac + b + d$의 값을 구하면?",
    "choices": [
      "11",
      "12",
      "13",
  ...
  },
  {
    "id": "15",
    "level": "상",
    "content": "좌표평면에서 두 이차함수 $y=x^2, y=-\\frac{1}{2}x^2+2x$의 그래프가 $x$축에 수직인 직선과 만나는 두 점을 각각 $A, B$라 하자. 점 $C(k, 0)$에 대하여 삼각형 $ABC$가 정삼각형이 되도록 하는 양수 $k$의 값은 $a+b\\sqrt{3}$이다. $a+b$의 값을 구하면?\n(단, $a, b$는 유리수이다.)",
    "choices": [
      "11",
      "12",
      "13",
  ...
  },
  {
    "id": "18",
    "level": "상",
    "content": "$x$에 대한 이차방정식 $f(x)$가 다음 조건을 만족시킨다.\n(가) $x^3 + 5x^2 + 5x - 3$를 $f(x)$로 나눈 나머지는 $g(x)$이다.\n(나) $x^3 + 5x^2 + 5x - 3$를 $g(x)$로 나눈 나머지는 $f(x) - x^2 - 2x$이다.\n$g(x)$를 $x-2$로 나눈 나머지를 구하면?",
    "choices": [
      "-1",
      "-2",
      "-3",
