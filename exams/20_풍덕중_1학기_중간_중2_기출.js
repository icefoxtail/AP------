...
window.questionBank = [
    ...
    },
    {
        ...
        choices: ["$\\angle ABD = 36^\\circ$", "$\\overline{AD} = \\overline{BD} = \\overline{BC}$", "$\\angle ADB = 112^\\circ$", "$\\triangle ABD$는 이등변삼각형이다.", "$\\triangle BCD$는 이등변삼각형이다."],
        answer: "③",
        category: "이등변삼각형의 성질",
        originalCategory: "이등변삼각형의 성질",
        standardCourse: "중2 수학",
