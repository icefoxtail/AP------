...
window.questionBank = [
  {
    ...
    "answer": "4",
    "solution_steps": [
      "1. ㄱ: $0$의 제곱근은 $0$ 하나뿐이므로 옳은 설명이다.",
      "2. ㄴ: 제곱근 $7$은 $\\sqrt{7}$을 의미하므로 옳은 설명이다.",
      "3. ㄷ: 음수의 제곱근은 존재하지 않으며, $0$의 제곱근은 $1$개이므로 모든 수의 제곱근이 $2$개라는 말은 옳지 않다.",
  ...
  },
  {
    ...
    "answer": "5",
    "solution_steps": [
      "1. $4 = \\sqrt{16}$이므로 $4 < \\sqrt{17}$임을 확인한다.",
      "2. $4+\\sqrt{17} > 0$이므로 $\\sqrt{(4+\\sqrt{17})^{2}} = 4+\\sqrt{17}$이다.",
  ...
  },
  {
    ...
    "answer": "2",
    "solution_steps": [
      "1. 정사각형의 한 변의 길이가 $\\sqrt{2}$이므로 대각선의 길이는 $\\sqrt{(\\sqrt{2})^{2}+(\\sqrt{2})^{2}} = \\sqrt{4} = 2$이다.",
      "2. 조건 $\\overline{AC}=\\overline{PC}$에 의해 점 $P$는 점 $C$를 중심으로 하고 반지름이 $2$인 원호를 따라 수직선과 만나는 점이므로 $x = C-2$이다.",
      "3. 조건 $\\overline{BD}=\\overline{BQ}$에 의해 점 $Q$는 점 $B$를 중심으로 하고 반지름이 $2$인 원호를 따라 수직선과 만나는 점이므로 $y = B+2$이다.",
      "4. 두 점 사이의 거리는 $y-x = (B+2) - (C-2) = 4 - (C-B)$이다.",
  ...
  },
  {
    ...
    "choices": [
      ...
      "② 순환소수는 유리수이다.",
      "③ 순환하지 않는 무한소수는 무리수이다.",
      "④ $\\sqrt{5}$와 $\\sqrt{6}$ 사이에는 무수히 많은 무리수가 있다.",
      "⑤ 무한소수는 모두 무리수이다."
    ],
    "answer": "5",
    "solution_steps": [
  ...
  },
  {
    ...
    "answer": "1",
    "solution_steps": [
      "1. $\\frac{\\sqrt{2}(\\sqrt{2}-1)}{(\\sqrt{2}+1)(\\sqrt{2}-1)} = \\frac{2-\\sqrt{2}}{1} = 2-\\sqrt{2}$이다.",
      "2. $\\frac{3(\\sqrt{2}+1)}{(\\sqrt{2}-1)(\\sqrt{2}+1)} = \\frac{3\\sqrt{2}+3}{1} = 3+3\\sqrt{2}$이다.",
  ...
  },
  {
    ...
    "answer": "2",
    "solution_steps": [
      "1. $\\sqrt{96} = \\sqrt{16\\times6} = 4\\sqrt{6} = 4\\sqrt{2}\\sqrt{3} = 4ab$이므로 첫 번째 상수는 $4$이다.",
  ...
  },
  {
    ...
    "answer": "3",
    "solution_steps": [
      "1. 식을 정리하면 $7\\sqrt{2} + 4\\sqrt{5} + 3\\sqrt{5} - 3\\sqrt{2}$이다.",
  ...
  },
  {
    ...
    "answer": "3,5",
    "solution_steps": [
      "1. ① $5\\sqrt{2}=\\sqrt{50} > \\sqrt{49}=7$이므로 틀리다.",
      "2. ② $-2\\sqrt{3}=-\\sqrt{12} > -\\sqrt{14}$이므로 틀리다.",
      "3. ③ $0.6=\\sqrt{0.36} < \\sqrt{0.6}$이므로 옳다.",
  ...
  },
  {
    ...
    "answer": "2",
    "solution_steps": [
      "1. 제곱근의 성질을 이용하여 각 보기를 변형한다.",
      "2. ② $\\sqrt{300} = \\sqrt{3 \\times 100} = 10\\sqrt{3}$ 이다.",
  ...
  },
  {
    ...
    "answer": "2",
    "solution_steps": [
      "1. 두 수의 합을 구하면 $(2+b) + (a-3)\\sqrt{3}$이다.",
      "2. 합이 유리수가 되려면 무리수 부분의 계수가 $0$이어야 하므로 $a-3=0$, 즉 $a=3$이다.",
      "3. 두 수의 곱을 구하면 $(2+3\\sqrt{3})(b-3\\sqrt{3}) = 2b - 6\\sqrt{3} + 3b\\sqrt{3} - 27 = (2b-27) + (3b-6)\\sqrt{3}$이다.",
  ...
  },
  {
    ...
    "answer": "3",
    "solution_steps": [
      "1. $4^{2} < 20 < 5^{2}$이므로 $\\sqrt{20}$의 정수 부분 $[\\sqrt{20}] = 4$이다.",
      "2. $2^{2} < 8 < 3^{2}$이므로 $\\sqrt{8}$의 정수 부분은 $2$이며, 소수 부분 $\\langle \\sqrt{8} \\rangle = \\sqrt{8}-2 = 2\\sqrt{2}-2$이다.",
  ...
  },
  {
    ...
    "answer": "3",
    "solution_steps": [
      "1. 가로의 길이 $\\sqrt{112} = \\sqrt{16\\times7} = 4\\sqrt{7}$ cm이다.",
      "2. 가로와 세로의 비가 $\\sqrt{7}:1$이므로 비례식을 세우면 $4\\sqrt{7} : x = \\sqrt{7} : 1$이다.",
  ...
  },
  {
    ...
    "answer": "4",
    "solution_steps": [
      "1. 두 번째 항에서 $(y-x) = -(x-y)$임을 이용하여 식을 변형한다.",
  ...
  },
  {
    ...
    "choices": [
      ...
      "③ $(4x^{2}+y^{4})(2x+y^{2})(2x-y^{2})$",
      "④ $(4x^{2}+y^{4})(4x^{2}-y^{4})(2x+y^{2})(2x-y^{2})$",
      "⑤ $(4x^{2}+y^{2})(2x+y)(2x-y)$"
    ],
    "answer": "5",
    "solution_steps": [
      "1. $16x^{4}-y^{4} = (4x^{2})^{2}-(y^{2})^{2}$ 이므로 합차 공식을 적용한다.",
      "2. $(4x^{2}+y^{2})(4x^{2}-y^{2})$ 이 된다.",
  ...
  },
  {
    ...
    "answer": "1,5",
    "solution_steps": [
      "1. $16x^{2} = (4x)^{2}$ 이고 $9 = 3^{2}$ 이다.",
      "2. 주어진 식이 완전제곱식이 되려면 일차항 $ax$는 $\\pm 2 \\times (4x) \\times 3$ 이어야 한다.",
  ...
  },
  {
    ...
    "answer": "2",
    "solution_steps": [
      "1. ②의 우변을 전개하면 $(x-1)(3x-1) = 3x^2 - 4x + 1$이다.",
  ...
  },
  {
    ...
    "answer": "2",
    "solution_steps": [
      "1. $A$ 계산: $27^{2}+2\\times3\\times27+3^{2}$ 이므로 완전제곱식 $(27+3)^{2}=30^{2}=900$ 이다.",
  ...
  },
  {
    ...
    "answer": "4",
    "solution_steps": [
      "1. 공통부분인 $x^{2}-3x$를 $t$로 치환한다. 식은 $t^{2}-2t-8$ 이 된다.",
      "2. $t$에 대해 인수분해하면 $(t-4)(t+2)$ 이다.",
      "3. 다시 환원하면 $(x^{2}-3x-4)(x^{2}-3x+2)$ 가 된다.",
  ...
  },
  {
    ...
    "answer": "5",
    "solution_steps": [
      "1. $\\overline{AD}$ 가 지름인 원의 둘레가 $12\\pi$ 이므로 지름 $\\overline{AD}=12$ 이다.",
      "2. 점 $D$ 가 $\\overline{BC}$ 의 중점이므로 $\\overline{CD}=\\overline{DB}=a$ 라 하면 $\\overline{BC}=2a$ 이다.",
  ...
  },
  {
    ...
    "answer": "4",
    "solution_steps": [
      "1. $x-1$ 이 인수이므로 식에 $x=1$ 을 대입하면 결과가 $0$ 이 되어야 한다.",
  ...
  },
  {
    ...
    "solution_steps": [
      ...
      "2. $\\sqrt{(-9)^{2}}=9$ 이므로 $9$의 양의 제곱근 $b=3$ 이다.",
