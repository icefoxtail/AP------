...
window.questionBank = [
  ...
  },
  {
    ...
    "answer": "②",
    "solution": "$42=2\\times3\\times7$, $54=2\\times3^3$\n최대공약수는 $6=2\\times3$, 최소공배수는 $378=2\\times3^3\\times7$ 이다.\n$\\square=2^a\\times3^b\\times7^c$ 라 하면\n최대공약수가 6이 되려면 $a=1$, $b\\ge1$ 이어야 하고,\n최소공배수가 378이 되려면 $a=1$, $1\\le b\\le3$, $0\\le c\\le1$ 이어야 한다.\n따라서 가능한 수는\n$6, 18, 54, 42, 126, 378$\n의 6개이다.\n이 중 42, 54는 이미 주어진 수이므로 제외하면\n$6, 18, 126, 378$\n의 4개이다.\n\\therefore 정답은 2번이다."
  },
  {
    "id": 20,
    "level": "상",
