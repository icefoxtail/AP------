...
window.questionBank = [
    ...
    },
    {
        ...
        choices: ["$(-3x^{5}) \\times 2x^{3} = -6x^{15}$", "$(2x^{2})^{3} \\times 4x = 32x^{7}$", "$(-5a^{3})^{2} \\div 10a^{3}b = -\\frac{a^{3}}{2b}$", "$12a^{2}b \\div (-3a) = -4ab$", "$(-21x^{5}) \\div (-3x^{2}) = -\\frac{7}{3}x^{3}$"],
        answer: "2, 4",
        originalCategory: "식의 계산",
        standardCourse: "중2 수학",
        standardUnitKey: "M2-02",
    ...
    },
    {
        ...
        choices: ["$a+5 < b+5$", "$-\\frac{a}{2} > -\\frac{b}{2}$", "$4a-3 < 4b-3$", "$\\frac{2a-7}{3} < \\frac{2b-7}{3}$", "$-5a - \\frac{1}{3} < -5b - \\frac{1}{3}$"],
        answer: "5",
        originalCategory: "일차부등식",
        standardCourse: "중2 수학",
        standardUnitKey: "M2-03",
