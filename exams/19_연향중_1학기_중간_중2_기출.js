window.examTitle = "19_연향중2_1학기_중간_중2_기출";
...
window.questionBank = [
  ...
  },
  {
    "id": "8",
    "category": "식의 계산",
    "content": "다음 등식을 만족시키는 네 자연수 $a, b, c, d$에 대하여 $a+b+c+d$의 값을 구하면? [4점]\n\n$20 \\times 30 \\times 40 \\times 50 \\times 60 \\times 70 = 2^{a} \\times 3^{b} \\times 5^{c} \\times 7^{d}$",
    "choices": [
      "12",
      "14",
      "16",
  ...
  },
  {
    "id": "11",
    "category": "식의 계산",
    "content": "다음 식을 전개하여 간단히 했을 때, $x^{2}$의 계수를 $a$, $xy$의 계수를 $b$라고 할 때, $a-b$의 값은? [4점]\n\n$4x(3x+2y+6) - 5x(x+y+2)$ ",
    "choices": [
      "-4",
      "-2",
      "0",
  ...
  },
  {
    "id": "18",
    "category": "일차부등식",
    "content": "다음 두 일차부등식의 해가 같을 때, 정수 $a$의 값을 구하면? [4점]\n\n$2(3-x) > 4x$, $a(x+3) > -16$",
    "choices": [
      "-4",
      "-2",
      "1",
  ...
  },
  {
    "id": "서술형2",
    "category": "식의 계산",
    "content": "두 식 $A, B$가 다음과 같을 때, $A+B$를 계산하여라. [5점]\n\n$A = (16a^{2}b - 20a^{3}) \\div (-4a^{2})$\n$B = (9a^{2} - 15ab) \\div \\frac{3}{2}a$",
    "choices": [],
    "answer": "11a-14b",
    "originalCategory": "식의 계산",
    "standardCourse": "중2 수학",
