...
- 생성 시각: 2026-09-11T08:43:15.507Z
- 인덱싱 범위(SCOPE): git-tracked + db-listed production (parity-gated) (git 등재 시험지만; textbook 교재은행·미추적 _pro 드래프트 제외)
- 시험지 수(db.js): 462
- 시험지 파일 수: 462
- 원본 문항 수(중복 제거 전): 11226
- 최종 인덱스 문항 수(중복 제거 후): 11226
- 중복 qKey로 제외된 레코드: 0 (그룹 0)
- 최종 인덱스 중복 qKey: 0
- undefined/비객체 문항 skip: 0
- db.js 크기: 477132 bytes
- 시험지 JS 총 크기: 18522368 bytes
- 인덱스 크기: 11878608 bytes
- 로드 실패 파일: 0

> 누락/시각요소/키분류 집계는 모두 "최종 인덱스 레코드(11226)" 기준이다.
...
- 시각요소 보유(hasImage=true, OR 합산): 2512
