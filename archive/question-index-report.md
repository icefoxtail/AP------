...
- 생성 시각: 2026-09-03T01:11:45.503Z
- 인덱싱 범위(SCOPE): git-tracked + db-listed (git 등재 시험지만; textbook 교재은행·미추적 _pro 드래프트 제외)
- 시험지 수(db.js): 438
- 시험지 파일 수: 451
- 원본 문항 수(중복 제거 전): 10980
- 최종 인덱스 문항 수(중복 제거 후): 10980
- 중복 qKey로 제외된 레코드: 0 (그룹 0)
- 최종 인덱스 중복 qKey: 0
- undefined/비객체 문항 skip: 0
- db.js 크기: 446984 bytes
- 시험지 JS 총 크기: 17845989 bytes
- 인덱스 크기: 11573567 bytes
- 로드 실패 파일: 0
...
- content 내부 <img>: 24
- content 내부 <svg>: 79
- content 내부 <table>: 165
- 시각요소 보유(hasImage=true, OR 합산): 2472
