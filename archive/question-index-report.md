...
- 생성 시각: 2026-09-08T21:38:56.709Z
- 인덱싱 범위(SCOPE): git-tracked + db-listed (git 등재 시험지만; textbook 교재은행·미추적 _pro 드래프트 제외)
- 시험지 수(db.js): 456
- 시험지 파일 수: 470
- 원본 문항 수(중복 제거 전): 11317
- 최종 인덱스 문항 수(중복 제거 후): 11317
- 중복 qKey로 제외된 레코드: 0 (그룹 0)
- 최종 인덱스 중복 qKey: 0
- undefined/비객체 문항 skip: 0
- db.js 크기: 465899 bytes
- 시험지 JS 총 크기: 18612479 bytes
- 인덱스 크기: 11910742 bytes
- 로드 실패 파일: 0

> 누락/시각요소/키분류 집계는 모두 "최종 인덱스 레코드(11317)" 기준이다.
