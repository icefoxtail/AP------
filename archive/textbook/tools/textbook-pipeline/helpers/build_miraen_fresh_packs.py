...
ROOT = Path.cwd()
PDF = ROOT / "_미래앤_고등_공통수학1_교과서.pdf"
OUT = ROOT / PDF.stem
GEN = OUT / "generated"
DPI = 220
SCALE = DPI / 72
...
SECTIONS = [
    {"unit": "다항식", "section": "중단원마무리", "setKey": "미래앤_공통수학1_다항식_중단원마무리_고1", "pages": [12, 13, 32, 33], "bookPart": "textbook"},
    {"unit": "다항식", "section": "대단원평가", "setKey": "미래앤_공통수학1_다항식_대단원평가_고1", "pages": [35, 36, 37], "bookPart": "textbook"},
    {"unit": "방정식과부등식", "section": "중단원마무리", "setKey": "미래앤_공통수학1_방정식과부등식_중단원마무리_고1", "pages": [56, 57, 68, 69, 88, 89], "bookPart": "textbook"},
    {"unit": "방정식과부등식", "section": "대단원평가", "setKey": "미래앤_공통수학1_방정식과부등식_대단원평가_고1", "pages": [91, 92, 93], "bookPart": "textbook"},
    {"unit": "경우의수", "section": "중단원마무리", "setKey": "미래앤_공통수학1_경우의수_중단원마무리_고1", "pages": [119, 120], "bookPart": "textbook"},
    {"unit": "경우의수", "section": "대단원평가", "setKey": "미래앤_공통수학1_경우의수_대단원평가_고1", "pages": [122, 123], "bookPart": "textbook"},
    {"unit": "행렬", "section": "중단원마무리", "setKey": "미래앤_공통수학1_행렬_중단원마무리_고1", "pages": [141, 142], "bookPart": "textbook"},
    {"unit": "행렬", "section": "대단원평가", "setKey": "미래앤_공통수학1_행렬_대단원평가_고1", "pages": [144, 145], "bookPart": "textbook"},
]
...
def main():
    ...
    for section in SECTIONS:
        ...
        for item in crops:
            js_questions.append({
                ...
                "questionType": "단답형",
                "layoutTag": "",
                "tags": ["교과서", "미래앤", "공통수학1", item["unit"], item["sectionType"]],
                "wide": False,
                "content": "",
                "choices": [],
                "image": "",
        ...
        (js_dir / f"{set_key}.js").write_text(render_js(set_key, f"미래앤 공통수학1 {section['unit']} {section['section']} 고1", js_questions), encoding="utf-8")
    ...
    write_json(GEN / "reports" / "miraen_question_crop_map.json", {"items": all_map})
    write_json(GEN / "reports" / "miraen_crop_failed.json", failures)
    write_json(GEN / "reports" / "miraen_section_detection_report.json", set_summaries)
    ...
    for unit, items in by_unit.items():
        unit_key = f"미래앤_공통수학1_{unit}_고1"
    ...
    write_json(GEN / "reports" / "miraen_fresh_unit_pack_report.json", {"packs": pack_report, "status": "ok"})
    pack_lines = "\n".join(
