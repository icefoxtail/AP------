...
test('provider dispatch converts a pre-model transport failure into an execution recovery receipt', t => {
  ...
  const packets = [
    ...
    { phase: 'U3', packet: buildAuditorPacket({ ...common, phase: 'U3', payload: buildU3CandidatePayload(candidateContext, 'recovery|1', { renderWitnesses: [] }), candidateContext, auditorSessionId: plan.contexts.U3.sessionId, contextId: plan.contexts.U3.contextId, inputVisibilityProfile: 'CANDIDATE_ONLY', priorReviewVisibility: 'NONE' }) },
