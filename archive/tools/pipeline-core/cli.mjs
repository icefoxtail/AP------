...
if (!['PASS', 'INVENTORY_ONLY', 'DRAFT_NOT_EXECUTABLE', 'CAPTURED_REVIEW_REQUIRED', 'MACHINE_EVIDENCE_READY', 'PRODUCTION', 'FROZEN', 'REPAIR_REQUIRED', 'NO_DISPATCH_LOCK', 'LOCK_RECONCILIATION_REQUIRED', 'RECOVERED_RECONCILE_REQUIRED'].includes(output.status)) process.exitCode = 1;
