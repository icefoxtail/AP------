...
export const AXIS_INPUT_PROJECTION_MAP = Object.freeze({
  ...
  MATH_A2: ['SOURCE_STEM', 'CHOICES', 'ANSWER', 'PROBLEM_ASSETS', 'SHARED_DEPENDENCIES'],
  SOLUTION: ['SOURCE_STEM', 'CHOICES', 'ANSWER', 'SOLUTION', 'SOLUTION_ASSETS', 'METADATA_TAGS', 'SHARED_DEPENDENCIES'],
  ...
  V3: ['SOURCE_STEM', 'CHOICES', 'PROBLEM_ASSETS', 'SOLUTION_ASSETS', 'ANSWER', 'SOLUTION', 'METADATA_TAGS', 'SHARED_DEPENDENCIES'],
