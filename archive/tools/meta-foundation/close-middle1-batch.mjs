...
const lines = [
  ...
  `- Worker-quality affected UIDs with targeted closure: **${validation.counts.workerQualityRejectedUidCount || 0}** (C evidence rejected: ${validation.counts.cQualityRejectedUidCount || 0}; A/B evidence rejected: ${validation.counts.abQualityRejectedUidCount || 0})`,
