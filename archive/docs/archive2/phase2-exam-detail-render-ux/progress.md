...
- No failing test points to the changed preview styles or touch-target rules. Remaining HOLDs: repository-wide baseline/fixture failures above and the two `origin/main` commits added after this branch was created; no UX or A4 output HOLD remains.
