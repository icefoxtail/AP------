...
- No failing test points to the changed preview styles or touch-target rules. Remaining HOLD: the repository-wide baseline/fixture failures above; no UX or A4 output HOLD remains.
