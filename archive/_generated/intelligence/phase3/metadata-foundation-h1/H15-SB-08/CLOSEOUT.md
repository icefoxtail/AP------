# L1 Closeout — H15-SB-08

상태: **PASS / CLOSED**  
Queue: `H15-SB-08`  
curriculum/course: **2015 / 수학(하)**  
canonical L1: **경우의 수**  
current standard key: `H15-SB-08`  
source files: **20**

## Denominator

- denominator: **47 questions**
...
- bucket: {"1":5,"2":1,"3":3,"4":37,"5":1}
- confidence: {"high":38,"medium":9}
- legacy compatibility: {"BORDERLINE_REVIEW":20,"NORMAL":14,"STRONG_CONFLICT":13}

## Review / adjudication

- first-pass freeze: PASS, 47/47
- legacy compare after freeze: PASS, 47/47
- recheck/adjudication: PASS, 47/47
- HOLD: 0
...
## Apply
- global sidecar updated: **47 records**
- updated existing: **47**
- newly registered: **0**
- global metadata record count: **11054**
- reviewStatus: `reviewed_pass` 47 / `HOLD` 0
