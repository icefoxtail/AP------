# L1 Closeout — H15-SB-07

상태: **PASS / CLOSED**  
Queue: `H15-SB-07`  
curriculum/course: **2015 / 수학(하)**  
canonical L1: **경우의 수**  
current standard key: `H15-SB-07`  
source files: **22**

## Denominator

- denominator: **62 questions**
...
- bucket: {"1":6,"3":10,"4":45,"5":1}
- confidence: {"high":45,"medium":17}
- legacy compatibility: {"BORDERLINE_REVIEW":31,"NORMAL":18,"STRONG_CONFLICT":13}

## Review / adjudication

- first-pass freeze: PASS, 62/62
- legacy compare after freeze: PASS, 62/62
- recheck/adjudication: PASS, 62/62
- HOLD: 0
...
## Apply
- global sidecar updated: **62 records**
- updated existing: **62**
- newly registered: **0**
- global metadata record count: **11054**
- reviewStatus: `reviewed_pass` 62 / `HOLD` 0
