# L1 Closeout — H22-C-06

상태: **PASS / CLOSED**  
Queue: `H22-C-06`  
curriculum/course: **2022 / 공통수학1**  
canonical L1: **방정식과 부등식**  
current standard key: `H22-C-06`  
source files: **22**

## Denominator

- denominator: **147 questions**
- solution presence: source inventory checked
- visual dependency candidates: **4**
- shared-material candidates: **0**
- source join: PASS
...
- bucket: {"1":9,"2":3,"3":8,"4":121,"5":6}
- confidence: {"high":132,"medium":15}
- legacy compatibility: {"BORDERLINE_ACCEPTABLE":70,"BORDERLINE_REVIEW":0,"NORMAL":61,"STRONG_CONFLICT":16}

## Review / adjudication

- first-pass freeze: PASS, 147/147
- legacy compare after freeze: PASS, 147/147
- recheck/adjudication: PASS, 147/147
- HOLD: 0
...
## Apply
- global sidecar updated: **147 records**
- updated existing: **147**
- newly registered: **0**
- global metadata record count: **11054**
- reviewStatus: `reviewed_pass` 147 / `HOLD` 0
