# L1 Closeout — H15-SA-04

상태: **PASS / CLOSED**  
Queue: `H15-SA-04`  
curriculum/course: `2015 / 수학(상)`  
canonical L1: `방정식과 부등식`  
current standard key: `H15-SA-04`  
source files: **21**

## Denominator

- denominator: **46 questions**
- solution presence: source inventory checked
- visual dependency candidates: **2**
...
- bucket: {"1":14,"2":2,"3":4,"4":25,"5":1}
- confidence: {"high":34,"medium":12}
- legacy compatibility: {"BORDERLINE_ACCEPTABLE":23,"BORDERLINE_REVIEW":0,"NORMAL":19,"STRONG_CONFLICT":4}

## Review / adjudication

- first-pass freeze: PASS, 46/46
- legacy compare after freeze: PASS, 46/46
- recheck/adjudication: PASS, 46/46
- HOLD: 0
...
## Apply
- global sidecar updated: **46 records**
- global metadata record count: **11038**
- reviewStatus: `reviewed_pass` 46 / `HOLD` 0
