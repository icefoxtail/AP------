# L1 Closeout — H15-SB-04

상태: **PASS / CLOSED**  
Queue: `H15-SB-04`  
curriculum/course: **2015 / 수학(하)**  
canonical L1: **함수**  
current standard key: `H15-SB-04`  
source files: **23**

## Denominator

- denominator: **93 questions**
- solution presence: source inventory checked
- visual dependency candidates: **15**
...
- bucket: {"1":3,"2":1,"3":21,"4":61,"5":7}
- confidence: {"high":59,"medium":34}
- legacy compatibility: {"BORDERLINE_ACCEPTABLE":32,"BORDERLINE_REVIEW":0,"NORMAL":40,"STRONG_CONFLICT":21}

## Review / adjudication

- first-pass freeze: PASS, 93/93
- legacy compare after freeze: PASS, 93/93
- recheck/adjudication: PASS, 93/93
- HOLD: 0
...
## Apply
- global sidecar updated: **93 records**
- updated existing: **93**
- newly registered: **0**
- global metadata record count: **11054**
- reviewStatus: `reviewed_pass` 93 / `HOLD` 0
