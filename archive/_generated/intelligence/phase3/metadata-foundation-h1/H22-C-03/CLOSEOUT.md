# L1 Closeout — H22-C-03

상태: **PASS / CLOSED**  
Queue: `H22-C-03`  
curriculum/course: **2022 / 공통수학1**  
canonical L1: **다항식**  
current standard key: `H22-C-03`  
source files: **12**

## Denominator

- denominator: **24 questions**
...
- bucket: {"3":13,"4":11}
- confidence: {"high":15,"medium":9}
- legacy compatibility: {"BORDERLINE_ACCEPTABLE":9,"BORDERLINE_REVIEW":0,"NORMAL":11,"STRONG_CONFLICT":4}

## Review / adjudication

- first-pass freeze: PASS, 24/24
- legacy compare after freeze: PASS, 24/24
- recheck/adjudication: PASS, 24/24
- HOLD: 0
...
## Apply
- global sidecar updated: **24 records**
- updated existing: **24**
- newly registered: **0**
- global metadata record count: **11054**
- reviewStatus: `reviewed_pass` 24 / `HOLD` 0
