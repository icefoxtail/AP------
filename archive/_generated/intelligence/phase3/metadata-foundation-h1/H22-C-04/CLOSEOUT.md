# L1 Closeout — H22-C-04

상태: **PASS / CLOSED**  
Queue: `H22-C-04`  
curriculum/course: **2022 / 공통수학1**  
canonical L1: **방정식과 부등식**  
current standard key: `H22-C-04`  
source files: **23**

## Denominator

- denominator: **70 questions**
- solution presence: source inventory checked
- visual dependency candidates: **0**
...
- bucket: {"1":17,"2":6,"3":10,"4":37}
- confidence: {"high":50,"medium":20}
- legacy compatibility: {"BORDERLINE_ACCEPTABLE":34,"BORDERLINE_REVIEW":0,"NORMAL":25,"STRONG_CONFLICT":11}

## Review / adjudication

- first-pass freeze: PASS, 70/70
- legacy compare after freeze: PASS, 70/70
- recheck/adjudication: PASS, 70/70
- HOLD: 0
...
## Apply
- global sidecar updated: **70 records**
- updated existing: **70**
- newly registered: **0**
- global metadata record count: **11054**
- reviewStatus: `reviewed_pass` 70 / `HOLD` 0
