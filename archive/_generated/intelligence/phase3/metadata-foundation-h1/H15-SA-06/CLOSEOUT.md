# L1 Closeout — H15-SA-06

상태: **PASS / CLOSED**  
Queue: `H15-SA-06`  
curriculum/course: `2015 / 수학(상)`  
canonical L1: `방정식과 부등식`  
current standard key: `H15-SA-06`  
source files: **2**

## Denominator

- denominator: **2 questions**
...
- legacy compatibility: {"BORDERLINE_ACCEPTABLE":0,"BORDERLINE_REVIEW":0,"NORMAL":2,"STRONG_CONFLICT":0}

## Review / adjudication

- first-pass freeze: PASS, 2/2
- legacy compare after freeze: PASS, 2/2
- recheck/adjudication: PASS, 2/2
- HOLD: 0
...
## Apply
- global sidecar updated: **2 records**
- global metadata record count: **11038**
- reviewStatus: `reviewed_pass` 2 / `HOLD` 0
