# L1 Closeout — H15-SA-07

상태: **PASS / CLOSED**  
Queue: `H15-SA-07`  
curriculum/course: `2015 / 수학(상)`  
canonical L1: `방정식과 부등식`  
current standard key: `H15-SA-07`  
source files: **17**

## Denominator

- denominator: **34 questions**
...
- bucket: {"1":3,"2":2,"3":3,"4":25,"5":1}
- confidence: {"high":27,"medium":7}
- legacy compatibility: {"BORDERLINE_ACCEPTABLE":18,"BORDERLINE_REVIEW":0,"NORMAL":11,"STRONG_CONFLICT":5}

## Review / adjudication

- first-pass freeze: PASS, 34/34
- legacy compare after freeze: PASS, 34/34
- recheck/adjudication: PASS, 34/34
- HOLD: 0
...
## Apply
- global sidecar updated: **34 records**
- global metadata record count: **11038**
- reviewStatus: `reviewed_pass` 34 / `HOLD` 0
