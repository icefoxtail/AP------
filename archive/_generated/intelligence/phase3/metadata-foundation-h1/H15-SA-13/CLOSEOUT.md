# L1 Closeout — H15-SA-13

상태: **PASS / CLOSED**  
Queue: `H15-SA-13`  
curriculum/course: `2015 / 수학(상)`  
canonical L1: `방정식과 부등식`  
current standard key: `H15-SA-13`  
source files: **8**

## Denominator

- denominator: **37 questions**
...
- bucket: {"3":2,"4":23,"5":12}
- confidence: {"medium":8,"high":29}
- legacy compatibility: {"BORDERLINE_ACCEPTABLE":12,"BORDERLINE_REVIEW":0,"NORMAL":19,"STRONG_CONFLICT":6}

## Review / adjudication

- first-pass freeze: PASS, 37/37
- legacy compare after freeze: PASS, 37/37
- recheck/adjudication: PASS, 37/37
- HOLD: 0
...
## Apply
- global sidecar updated: **37 records**
- global metadata record count: **11038**
- reviewStatus: `reviewed_pass` 37 / `HOLD` 0
