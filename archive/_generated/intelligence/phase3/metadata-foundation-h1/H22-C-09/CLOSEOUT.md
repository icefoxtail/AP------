# L1 Closeout — H22-C-09

상태: **PASS / CLOSED**  
Queue: `H22-C-09`  
curriculum/course: **2022 / 공통수학1**  
canonical L1: **행렬**  
current standard key: `H22-C-09`  
source files: **19**

## Denominator

- denominator: **83 questions**
...
- bucket: {"2":1,"3":31,"4":50,"5":1}
- confidence: {"high":56,"medium":27}
- legacy compatibility: {"BORDERLINE_ACCEPTABLE":31,"BORDERLINE_REVIEW":0,"NORMAL":31,"STRONG_CONFLICT":21}

## Review / adjudication

- first-pass freeze: PASS, 83/83
- legacy compare after freeze: PASS, 83/83
- recheck/adjudication: PASS, 83/83
- HOLD: 0
...
## Apply
- global sidecar updated: **83 records**
- updated existing: **83**
- newly registered: **0**
- global metadata record count: **11054**
- reviewStatus: `reviewed_pass` 83 / `HOLD` 0
