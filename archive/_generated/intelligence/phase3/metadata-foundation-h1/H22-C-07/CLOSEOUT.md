# L1 Closeout — H22-C-07

상태: **PASS / CLOSED**  
Queue: `H22-C-07`  
curriculum/course: **2022 / 공통수학1**  
canonical L1: **경우의 수**  
current standard key: `H22-C-07`  
source files: **15**

## Denominator

- denominator: **26 questions**
...
- bucket: {"1":1,"3":5,"4":19,"5":1}
- confidence: {"high":20,"medium":6}
- legacy compatibility: {"BORDERLINE_REVIEW":9,"NORMAL":5,"STRONG_CONFLICT":12}

## Review / adjudication

- first-pass freeze: PASS, 26/26
- legacy compare after freeze: PASS, 26/26
- recheck/adjudication: PASS, 26/26
- HOLD: 0
...
## Apply
- global sidecar updated: **26 records**
- updated existing: **26**
- newly registered: **0**
- global metadata record count: **11054**
- reviewStatus: `reviewed_pass` 26 / `HOLD` 0
