...
# L1 Closeout — H22-C2-03

상태: **PASS / CLOSED**  
Queue: `H22-C2-03`  
curriculum/course: `2022 / 공통수학2`  
canonical L1: `도형의 방정식`  
current standard key: `H22-C2-03`  
source files: **9**

## Denominator

- denominator: **45 questions**
...
- bucket: {"1":4,"2":1,"3":12,"4":26,"5":2}
- confidence: {"medium":16,"high":29}
- legacy compatibility: {"BORDERLINE_ACCEPTABLE":24,"BORDERLINE_REVIEW":0,"NORMAL":16,"STRONG_CONFLICT":5}

## Review / adjudication

- first-pass freeze: PASS, 45/45
- legacy compare after freeze: PASS, 45/45
- recheck/adjudication: PASS, 45/45
- HOLD: 0
...
## Apply
- global sidecar updated: **45 records**
- global metadata record count: **11038**
- reviewStatus: `reviewed_pass` 45 / `HOLD` 0
