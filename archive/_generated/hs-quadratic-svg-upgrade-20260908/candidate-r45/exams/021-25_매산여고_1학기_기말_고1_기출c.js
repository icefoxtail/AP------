...
window.questionBank = [
  ...
  },
  {
    ...
    "subUnitConfidence": "rule_inferred",
    "subUnitClassificationDepth": "complete_rule",
    "solutionImage": "archive/_generated/hs-quadratic-svg-upgrade-20260908/candidate-r44/assets/hs-r44-004.svg",
  ...
  },
  {
    ...
    "answer": "②",
    "solution": "[키포인트] 행렬의 각 성분을 직접 비교해 A를 정하고, 주어진 행렬 등식의 결과를 이용해 합을 계산한다.\n \n$A=\\begin{pmatrix}p&2\\\\r&3\\end{pmatrix}$이라 하자. 조건 (나)에서\n$A\\begin{pmatrix}0\\\\1\\end{pmatrix}=\\begin{pmatrix}2\\\\3\\end{pmatrix}$\n이므로 둘째 열은 $\\begin{pmatrix}2\\\\3\\end{pmatrix}$이다.\n \nA^2=3A-6E에서 (1,2)성분을 비교하면\n2p+6=6\n이므로 p=0이다. (2,2)성분을 비교하면\n2r+9=3\n이므로 r=-3이다. 따라서\n$A=\\begin{pmatrix}0&2\\\\-3&3\\end{pmatrix}$.\n \n이제 A^2를 직접 계산하면\n$A^2=\\begin{pmatrix}-6&6\\\\-9&3\\end{pmatrix}$\n이고, $A+A^2=\\begin{pmatrix}-6&8\\\\-12&6\\end{pmatrix}$이다. 모든 성분의 합은\n-6+8-12+6=-4\n이므로 정답은 ②이다.",
    "subUnitKey": "H22-C-09-CORE",
    "subUnit": "경우의 수 핵심 개념",
    "subUnitConfidence": "rule_inferred",
    "subUnitClassificationDepth": "complete_rule"
