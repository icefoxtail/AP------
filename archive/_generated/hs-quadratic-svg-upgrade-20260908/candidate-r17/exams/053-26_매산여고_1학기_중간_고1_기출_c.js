...
window.questionBank = [
  ...
  },
  {
    ...
    "answer": "⑤",
    "solution": "$y=x^2-6x+k^2-27=(x-3)^2+k^2-36$이다. x축과 한 점에서 만나려면 꼭짓점의 y좌표가 0이어야 하므로 $k^2-36=0$이다. 따라서 $k=-6$ 또는 $k=6$이고, 모든 값은 $-6,6$이므로 정답은 ⑤이다.",
    "subUnitKey": "H22-C-05-QUADRATIC_FUNCTION_GRAPH",
    "subUnit": "이차함수의 그래프",
    "subUnitConfidence": "category_or_cue_inferred",
    "subUnitClassificationDepth": "complete_category",
    "solutionImage": "archive/_generated/hs-quadratic-svg-upgrade-20260908/candidate-r6/assets/hs-r6-maesan-q6.svg",
  ...
  },
  {
    ...
    "answer": "②",
    "solution": "$y=x^2-2x=(x-1)^2-1$이다. 구간 $[1,3]$에서 꼭짓점 $x=1$의 함수값은 최솟값 $-1$이고, 오른쪽 끝점에서 $f(3)=3$이므로 최댓값은 $3$이다. 따라서 최댓값과 최솟값의 합은 $3+(-1)=2$이고 정답은 ②이다.",
    "subUnitKey": "H22-C-05-FUNCTION_BASIC",
    "subUnit": "함수의 뜻과 그래프",
    "subUnitConfidence": "category_or_cue_inferred",
    "subUnitClassificationDepth": "complete_category",
    "solutionImage": "archive/_generated/hs-quadratic-svg-upgrade-20260908/candidate-r12/assets/hs-r12-017.svg",
  ...
  },
  {
    ...
    "answer": "④",
    "solution": "두 그래프의 교점은 $x^2+4x+k=-2x+3$, 즉 $x^2+6x+k-3=0$의 실근이다. 서로 다른 두 점에서 만나려면 $D=6^2-4(k-3)=48-4k>0$이므로 $k<12$이다. 자연수 $k$의 최댓값은 $11$이고 정답은 ④이다.",
    "subUnitKey": "H22-C-05-FUNCTION_BASIC",
    "subUnit": "함수의 뜻과 그래프",
    "subUnitConfidence": "category_or_cue_inferred",
    "subUnitClassificationDepth": "complete_category",
    "solutionImage": "archive/_generated/hs-quadratic-svg-upgrade-20260908/candidate-r6/assets/hs-r6-maesan-q13.svg",
    "solutionImageAlt": "문항의 핵심 함수·부등식·기하 관계를 나타낸 후보 해설 시각자료",
    "solutionImageCaption": "후보 SVG: 문제 조건과 독립 계산으로 확정할 관계를 그림에서 확인한다.",
    "solutionImageSize": "full"
  },
  {
    ...
    "answer": "①",
    "solution": "$f(x)=2x^2-4x+7=2(x-1)^2+5$이므로 전체 최솟값은 $x=1$에서 $5$이다. 구간 $[t,t+2]$에서 이 최솟값을 가지려면 $1$이 구간에 포함되어야 하므로 $t\\le1\\le t+2$, 즉 $-1\\le t\\le1$이다. 따라서 정답은 ①이다.",
    "subUnitKey": "H22-C-05-FUNCTION_BASIC",
    "subUnit": "함수의 뜻과 그래프",
    "subUnitConfidence": "category_or_cue_inferred",
    "subUnitClassificationDepth": "complete_category",
    "solutionImage": "archive/_generated/hs-quadratic-svg-upgrade-20260908/candidate-r6/assets/hs-r6-maesan-q14.svg",
    "solutionImageAlt": "문항의 핵심 함수·부등식·기하 관계를 나타낸 후보 해설 시각자료",
    "solutionImageCaption": "후보 SVG: 문제 조건과 독립 계산으로 확정할 관계를 그림에서 확인한다.",
    "solutionImageSize": "full"
  },
