...
const job = 'past20-maesan-repair-eac09c29e';
...
const evidence = {
  ...
  observedAt,
  dispatchResult: { canonicalStatus: 'HOLD:PROVIDER_TRANSPORT_UNAVAILABLE', responseReturned: false, responseAttestationReturned: false, evidenceReturned: false, laterPhasesInvoked: false },
  sealedInputRefs: { providerPlanRef: planRef, packetRef, requestRef },
  requestInputSha: request.inputSha,
  transport: { command: 'node', args: ['alive/runtime/provider-bridge/codex-appserver-adapter.mjs', '--job', job], automaticRetry: false },
  rootCauseEvidence: 'archive/_generated/past-exams/_manual/20_매산고_2학기_중간_고1_기출_fresh_393877dda/reports/repair-eac09c29e-provider-root-cause-5.json',
...
const receipt = {
  ...
  retryLaunchCount: 0,
  usedTokens: 22843,
  usedTokensByPhase: { U1: 22843, U2: null, U3: null },
