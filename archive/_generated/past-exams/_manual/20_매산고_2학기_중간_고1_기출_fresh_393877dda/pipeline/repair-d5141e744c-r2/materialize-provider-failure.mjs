...
const evidence = {
  ...
  dispatchResult: {
    ...
    providerTurnLogPresent: false,
    dispatchClientProcessPresent: false,
  },
  sealedInputRefs: { providerPlanRef: planRef, packetRef, requestRef },
  requestInputSha: request.inputSha,
  transport: {
    command: 'node',
    args: ['alive/runtime/provider-bridge/codex-appserver-adapter.mjs', '--job', job],
    automaticRetry: false,
  },
  rootCauseEvidence: 'archive/_generated/past-exams/_manual/20_매산고_2학기_중간_고1_기출_fresh_393877dda/reports/repair-d5141e744d-provider-transport-failure.json',
...
const receipt = {
  ...
  retryLaunchCount: 0,
  usedTokens: null,
  usedTokensByPhase: { U1: null, U2: null, U3: null },
