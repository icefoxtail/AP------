...
window.questionBank = [
  ...
  },
  {
    ...
    "standardUnit": "정수와 유리수의 계산",
    "standardUnitOrder": 4,
    "content": "뚜비 이야기의 일부를 통해 알 수 있는 것으로 옳은 것을 고르시오. [4점]\\n<div class='box'>[뚜비 이야기]\\n뚜비에게 돌멩이 3개를 달아주면 뚜비는 땅으로 3칸 내려가고, 뚜비에게 달린 풍선 3개를 끊으면 땅으로 3칸 내려가므로 돌멩이를 3개 달아주는 것과 풍선 3개를 끊는 것은 같은 효과가 나타납니다.\\n반대로 뚜비에게 달린 돌멩이 3개를 끊으면 하늘로 3칸 올라가고, 뚜비에게 풍선 3개를 달면 하늘로 3칸 올라가므로 돌멩이를 3개 끊는 것과 풍선 3개를 달아주는 것은 같은 효과가 나타납니다.</div>",
    "choices": [
  ...
  },
{
    ...
    "standardUnit": "최대공약수와 최소공배수",
    "standardUnitOrder": 2,
    "content": "서로 다른 세 자연수 42, 54, □의 최대공약수가 6, 최소공배수가 378이다. □가 될 수 있는 수가 몇 개인지 고르시오. [5점]",
    "choices": [
      "6개",
      "4개",
      "2개",
