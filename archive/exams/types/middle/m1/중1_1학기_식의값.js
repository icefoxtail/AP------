...
window.questionBank = [
  {
    ...
    questionType: "객관식",
    layoutTag: "grid",
    tags: ["객관식","문자식","식의값","대입","개수세기","계수비교"],
    wide: false,
    content: "$$-x^2 + \\dfrac{x}{2} - \\dfrac{1}{3}$$",
    choices: ["항의 개수는 2개이다.","$x^2$의 계수는 $-1$이다.","위의 다항식에서 상수항은 없다.","위의 다항식은 일차식이다.","$x$의 계수는 2이다."],
    answer: "②",
  ...
  },
  {
    ...
    questionType: "객관식",
    layoutTag: "grid",
    tags: ["객관식","복수정답","문자식","식의값","대입","참거짓","계수비교"],
    wide: false,
    content: "$4a^2 - 6a + 3$에 대한 설명으로 옳은 것을 모두 고르면? (정답 2개)",
    choices: ["다항식의 항은 $4a^2$, $6a$, $3$이다.","$a$의 계수는 $-6$이다.","상수항은 3이다.","$a^2$의 계수는 2이다.","이 다항식은 일차식이다."],
    answer: "②, ③",
  ...
  },
  {
    ...
    questionType: "단답형",
    layoutTag: "grid",
    tags: ["단답형","표","문자식","식의값","대입","계산","조건해석","계수비교"],
    wide: false,
    content: "다음 표의 빈칸에 알맞은 수를 써넣어라.\n\n| 일차식 | $x+2$ | $x-1$ | $-3x+1$ | $x$ |\n|--------|--------|--------|----------|-----|\n| $x$의 계수 | 1 | | | 1 |\n| 상수항 | | 1 | | 0 |\n| $x=-1$일 때 식의 값 | | -1 | 1 | |",
    choices: [],
    answer: "| 일차식 | $x+2$ | $x-1$ | $-3x+1$ | $x$ |\n|--------|--------|--------|----------|-----|\n| $x$의 계수 | 1 | 1 | -3 | 1 |\n| 상수항 | 2 | -1 | 1 | 0 |\n| $x=-1$일 때 식의 값 | 1 | -2 | 4 | -1 |",
    solution: "[키포인트] 구하는 값은 | 일차식 | $x+2$ | $x-1$ | $-3x+1$ | $x$ |\n|--------|--------|--------|----------|-----|\n| $x$의 계수 | 1 | 1 | -3 | 1 |\n| 상수항 | 2 | -1 | 1 | 0 |\n| $x=-1$일 때 식의 값 | 1 | -2 | 4 | -1 |이다."
  },
  {
    id: 4,
    level: "하",
  ...
  },
  {
    ...
    questionType: "객관식",
    layoutTag: "grid",
    tags: ["객관식","문자식","식의값","대입","계수비교","식변형"],
    wide: false,
    content: "다음 중 옳은 것은?",
    choices: ["$-3x+2$에서 상수항은 $-3$이다.","$0.4a-2$의 $a$의 계수는 $-2$이다.","$2x$와 $2y$는 동류항이다.","$3x-1$은 단항식이다.","$x^2+x+1$에서 $x$의 계수는 1이다."],
    answer: "⑤",
  ...
  },
  {
    ...
    questionType: "객관식",
    layoutTag: "grid",
    tags: ["객관식","문자식","식의값","대입","참거짓","계수비교"],
    wide: false,
    content: "$-5x^2 + 3x - 2$에 대한 다음 설명 중 옳은 것은?",
    choices: ["단항식이다.","$x$의 계수는 3이다.","상수항은 2이다.","항은 $5x^2$, $3x$, $2$이다.","$x$에 관한 삼차식이다."],
    answer: "②",
  ...
  },
  {
    ...
    choices: ["$x - x^2 + 1$","$\\dfrac{1}{x} + 4$","$7 - 3y$","$a^2 + 2a$","$0 \\times x - 4$"],
    answer: "③",
  ...
  },
  {
    ...
    choices: ["$x$의 계수는 $-4$이다.","$x$에 대한 이차식이다.","항은 $x^2$, $4x$, $6$이다.","상수항은 6이다.","$x^2$과 $x$의 계수를 합하면 $-3$이다."],
    answer: "③",
  ...
  },
  {
    ...
    tags: ["객관식","문자식","식의값","대입","개수세기","계수비교"],
    wide: false,
    content: "**보기:** 몇 개의 항이 덧셈 기호로 연결된 식을 □이라 하고, 특히 항이 하나 뿐인 식을 □이라고 한다. 또, 차수가 1인 다항식을 □이라고 부른다.",
    choices: ["항, 계수, 상수항","다항식, 단항식, 일차방정식","다항식, 단항식, 일차식","단항식, 다항식, 일차방정식","차수, 계수, 일차식"],
    answer: "③",
  ...
  },
  {
    ...
    questionType: "객관식",
    layoutTag: "grid",
    tags: ["객관식","문자식","식의값","대입","조건해석","최대최소","규칙찾기"],
    wide: false,
  ...
  },
  {
    ...
    questionType: "객관식",
    layoutTag: "grid",
    tags: ["객관식","복수정답","문자식","식의값","대입","계수비교"],
    wide: false,
    content: "다음 중에서 일차식을 모두 찾으면? (정답 2개)",
    choices: ["$x^2 - 5x - 3$","$y + 1$","$3x + 2 - 3x$","$0 \\cdot x + 4$","$-a + 3b - 1$"],
    answer: "②, ⑤",
  ...
  },
  {
    ...
    questionType: "단답형",
    layoutTag: "grid",
    tags: ["단답형","문자식","식의값","대입","계산","조건해석","활용","실생활"],
    wide: false,
  ...
  },
  {
    ...
    tags: ["단답형","문자식","식의값","대입","계산"],
    wide: false,
    content: "$M(M(e, m(c,d)), m(a, M(b,c)))$를 구하여라.",
    choices: [],
    answer: "$e$",
  ...
  },
  {
    ...
    questionType: "단답형",
    layoutTag: "grid",
    tags: ["단답형","도형","문자식","식의값","대입","계산","개수세기"],
    wide: false,
  ...
  },
  {
    ...
    questionType: "단답형",
    layoutTag: "grid",
    tags: ["단답형","표","문자식","식의값","대입","계산","자연수조건","규칙찾기"],
    wide: false,
  ...
  },
  {
    ...
    questionType: "객관식",
    layoutTag: "grid",
    tags: ["객관식","문자식","식의값","대입","조건해석","최대최소"],
    wide: false,
    content: "$a = -\\dfrac{1}{2}$일 때, 다음 중 가장 큰 수는?",
    choices: ["$a$","$a^2$","$\\dfrac{1}{a^2}$","$-a^2$","$-\\dfrac{1}{a}$"],
    answer: "③",
  ...
  },
  {
    ...
    questionType: "단답형",
    layoutTag: "grid",
    tags: ["단답형","복수정답","문자식","식의값","대입","계산"],
    wide: false,
    content: "**(1)** $x$, $y$의 값을 각각 구하여라.\n**(2)** $x \\times y$의 값을 구하여라.",
    choices: [],
    answer: "(1) $x = 2$, $y = -6$\n(2) $x \\times y = 2 \\times (-6) = -12$",
    solution: "[키포인트] 구하는 값은 (1) $x = 2$, $y = -6$\n(2) $x \\times y = 2 \\times (-6) = -12$이다."
  },
  {
    id: 30,
    level: "하",
    ...
    choices: ["$x - 1$","$3a - 4b + 2$","$b^2 + 1$","$x \\times \\left(-\\dfrac{1}{2}y\\right) + 4$","$x \\times x \\times y$"],
    answer: "⑤",
  ...
  },
  {
    ...
    choices: ["319 m/초","322 m/초","330 m/초","336 m/초","343 m/초"],
    answer: "①",
  ...
  },
  {
    ...
    questionType: "객관식",
    layoutTag: "grid",
    tags: ["객관식","문자식","식의값","대입","참거짓","계수비교","식변형"],
    wide: false,
    content: "다음 설명 중 옳은 것은?",
    choices: ["$12x^2 - 3x + 17$에서 $12x^2$과 $-3x$는 동류항이다.","$5x + 3y - 2$에서 항은 2개이다.","$-5x^3 + 4$에서 $x$의 계수는 $-5$이다.","$3x^2$의 차수는 3이다.","$5x$는 단항식이다."],
    answer: "⑤",
  ...
  },
  {
    ...
    choices: ["16","$\\dfrac{1}{4}$","0","$-\\dfrac{1}{4}$","$-16$"],
    answer: "②",
  ...
  },
  {
    ...
    choices: ["$\\dfrac{5}{3}$","12","0","$-\\dfrac{3}{2}$","$-3$"],
    answer: "④",
  ...
  },
  {
    ...
    questionType: "객관식",
    layoutTag: "grid",
    tags: ["객관식","복수정답","문자식","식의값","대입"],
    wide: false,
    content: "다음 중 단항식을 모두 고르면? (정답 2개)",
    choices: ["$x + 1$","$-2a^2$","$-2 + y$","$x \\times 1$","$x + y$"],
    answer: "②, ④",
    solution: "[키포인트] 정답은 ②, ④이다."
  },
  {
    ...
    questionType: "객관식",
    layoutTag: "grid",
    tags: ["객관식","문자식","식의값","대입","참거짓","오류판별"],
    wide: false,
    content: "다음 중 일차식이 아닌 것은?",
    choices: ["$0.1x - 1$","$x \\times x + 1$","$2x \\div 2 + x$","$2 - 2x$","$x^2 + x - x^2$"],
    answer: "②",
  ...
  },
  {
    ...
    choices: ["5°C","10°C","15°C","20°C","25°C"],
    answer: "⑤",
  ...
  },
  {
    ...
    choices: ["$x$에 관한 일차식이다.","항이 4개이다.","상수항은 4이다.","$x$의 계수는 2이다.","$x^2$의 계수는 $\\dfrac{1}{2}$이다."],
    answer: "④ (정리 결과: $-\\dfrac{1}{2}x^2 + 2x - 4$)",
    solution: "[키포인트] 정답은 ④ (정리 결과: $-\\dfrac{1}{2}x^2 + 2x - 4$)이다."
  },
  {
    id: 46,
    level: "하",
    ...
    questionType: "단답형",
    layoutTag: "grid",
    tags: ["단답형","표","문자식","식의값","대입","계산"],
    wide: false,
    content: "$A = |2y - x^2|$, $B = \\dfrac{4y^2}{x^3}$의 곱 $A \\times B$의 값을 구하여라.",
    choices: [],
    answer: "$-45$",
  ...
  },
  {
    ...
    questionType: "단답형",
    layoutTag: "grid",
    tags: ["단답형","문자식","식의값","대입","계산","최대최소","계수비교"],
    wide: false,
    content: "$-6x^2 + 3x + 6x^2 + 4$",
    choices: [],
    answer: "1차",
  ...
  },
  {
    ...
    choices: ["$-3x$는 단항식이다.","$2x+6$은 일차식이다.","$3x^2$의 차수는 2이다.","$-5x$에서 $x$의 계수는 $-5$이다.","$\\dfrac{1}{2} \\times x - y + 3$에서 항은 4개이다."],
    answer: "⑤",
  ...
  },
  {
    ...
    choices: ["$x^2 - 5x - 3$","$3x - 5 - 3x$","$0 \\cdot x - 3$","$0.4x - 0.4$","$x^2 + 3x + 1 - x - x^2$"],
    answer: "④, ⑤",
  ...
  },
  {
    ...
    wide: false,
    content: "다음 중 단항식은?",
    choices: ["$x - 2y$","$2 \\times a^2 \\times b^3$","$-\\dfrac{1}{2}x + 3$","$a^2 - 3a$","$x \\times x + 3$"],
    answer: "②",
    solution: "[키포인트] 정답은 ②이다."
  },
  {
    ...
    tags: ["단답형","문자식","식의값","대입","계산"],
    wide: false,
    content: "$$\\dfrac{a}{ab+a+2} + \\dfrac{b}{bc+b+1} + \\dfrac{2c}{ca+2c+2}$$",
    choices: [],
    answer: "1",
    solution: "[키포인트] 구하는 값은 1이다."
  },
  {
    id: 55,
    level: "하",
    ...
    wide: false,
    content: "다음 중 단항식은?",
    choices: ["$2a - 3$","$x^2 - x + 1$","$3x - \\dfrac{1}{2}$","$3x^2y \\div 2$","$a + bxy$"],
    answer: "④",
  ...
  },
  {
    ...
    choices: ["$\\dfrac{1}{x}$","$x^2$","$x + 1 - x$","$2y^2 - y - 0.2y^2$","$x + \\dfrac{3x^2}{x}$"],
    answer: "⑤",
  ...
  },
  {
    ...
    questionType: "단답형",
    layoutTag: "grid",
    tags: ["단답형","문자식","식의값","대입","계산","계수비교"],
    wide: false,
    content: "$3y - \\dfrac{1}{6} - \\dfrac{2(2y-5)}{3}$을 간단히 했을 때 $y$의 계수를 $b$라 할 때, $\\dfrac{3}{8}a - \\dfrac{3}{5}b$의 값을 구하여라.",
    choices: [],
    answer: "2",
  ...
  },
  {
    ...
    questionType: "단답형",
    layoutTag: "grid",
    tags: ["단답형","문자식","식의값","대입","계산","조건해석","범위"],
    wide: false,
  ...
  },
  {
    ...
    questionType: "객관식",
    layoutTag: "grid",
    tags: ["객관식","문자식","식의값","대입","계수비교"],
    wide: false,
    content: "다음 중 차수가 가장 높은 것은?",
    choices: ["$x^2y$","$x^2 + y^2$","$xy^3$","$x^2yz^2$","$x^4 + y^3$"],
    answer: "④",
