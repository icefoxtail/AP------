...
window.questionBank = [
  ...
  },
  {
    ...
    "choices": [
      "$3$개월 전 $\\rightarrow$ $-3$개월",
      "해발 $6\\text{km}$ $\\rightarrow$ $+6\\text{km}$",
      "해저 $15\\text{km}$ $\\rightarrow$ $-15\\text{km}$",
      "영상 $8^\\circ\\text{C}$ $\\rightarrow$ $+8^\\circ\\text{C}$",
  ...
  },
  {
    ...
    "choices": [
      "자연수는 모두 정수라고 할 수 있다.",
      "정수 중에서는 유리수가 아닌 수도 있다.",
      "정수는 모두 유리수라고 할 수 있다.",
      "유리수 중에는 정수가 아닌 수도 있다.",
      "$0$은 양수도 음수도 아니다."
    ],
    "answer": "②",
  ...
  },
  {
    ...
    "content": "다음 중 옳지 않은 것은?",
    "choices": [
      "$(\\text{음수}) - (\\text{양수}) = (\\text{음수})$",
      "$(\\text{음수}) + (\\text{음수}) = (\\text{음수})$",
      "$(\\text{양수}) + (\\text{양수}) = (\\text{양수})$",
  ...
  },
  {
    ...
    "content": "다음 설명 중 옳은 것은?",
    "choices": [
      "정수에는 양의 정수와 음의 정수가 있다.",
      "$3$은 분수가 아니므로 유리수가 아니다.",
      "$0$은 정수이지만 유리수는 아니다.",
      "정수와 정수 사이에는 반드시 다른 정수가 있다.",
  ...
  },
  {
    ...
    "content": "다음 중 옳지 않은 것은?",
    "choices": [
      "$3,000$원 손해를 $-3,000$원이라고 하면, $5,000$원 이익은 $+5,000$원이다.",
      "정수는 양의 정수와 음의 정수로 이루어져 있다.",
      "$-\\frac{2}{3}$는 정수가 아닌 유리수이다.",
      "절댓값이 $4$인 수는 $+4, -4$이다.",
      "절댓값이 가장 작은 수는 $0$이다."
    ],
    "answer": "②",
  ...
  },
  {
    ...
    "choices": [
      "정수는 양의 정수와 $0$, 음의 정수로 나눠진다.",
      "유리수는 양의 유리수와 음의 유리수로 나눠진다.",
      "서로 다른 두 유리수 사이에는 무수히 많은 유리수가 있다.",
      "서로 다른 두 정수 사이에는 무수히 많은 정수가 있다.",
