...
window.questionBank = [
  ...
  },
  {
    ...
    "choices": [
      "$\\dfrac{13}{2}x - \\dfrac{3}{4}$",
      "$\\dfrac{13}{4}x - \\dfrac{3}{4}$",
      "$\\dfrac{15}{2}x - \\dfrac{3}{4}$",
      "$\\dfrac{13}{4}x - \\dfrac{3}{2}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "어떤 공연에 필요한 악기 수는 신디사이저 3대, 전자기타 $\\dfrac{1}{3}x$대, 베이스기타 $\\dfrac{1}{2}x$대, 드럼 1대이고, 출연자 수는 개그맨 $\\dfrac{2}{3}x$명, 가수 2명이다. 악기 수와 출연자 수의 합을 $x$에 대한 식으로 나타내면?",
    "choices": [
      "$\\dfrac{2}{3}x+3$",
      "$\\dfrac{3}{2}x+6$",
      "$\\dfrac{5}{6}x+5$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "$(6a-3) - \\left\\{\\dfrac{1}{2}(2a-6) + 2\\right\\}$를 간단히 하면?",
    "choices": [
      "$5a+2$",
      "$-3a+4$",
      "$-3a-4$",
