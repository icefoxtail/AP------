...
window.questionBank = [
  {
    ...
    choices: ["70원 이익: $+70$원","5 kg 감량: $-5$ kg","2시간 전: $-2$시간","해저 9 km: $+9$ km","출발 3일 후: $+3$일 후"],
    answer: "④",
  ...
  },
  {
    ...
    choices: ["3.5","$-\\dfrac{2}{3}$","$-\\dfrac{3}{4}$","$+\\dfrac{1}{2}$","-3"],
    answer: "②",
  ...
  },
  {
    ...
    choices: ["가장 큰 수는 5이다.","가장 작은 수는 $-\\dfrac{12}{3}$이다.","$-\\dfrac{1}{3}$보다 큰 수는 2개이다.","음수 중 가장 큰 수는 $-\\dfrac{1}{4}$이다.","절댓값이 가장 작은 수는 $-\\dfrac{1}{4}$이다."],
    answer: "③",
  ...
  },
  {
    ...
    choices: ["$-\\dfrac{1}{3}$","$-\\dfrac{2}{3}$","$-\\dfrac{3}{4}$","$-\\dfrac{11}{12}$","$-\\dfrac{13}{12}$"],
    answer: "④",
  ...
  },
  {
    ...
    choices: ["$(-2)^3\\times\\dfrac{1}{8}$","$1\\div(-1)^{401}$","$-2^2\\div(-2)^2$","$(-1)^{50}\\times(-1)^{51}$","$(-9)\\div\\left(-\\dfrac{1}{3}\\right)^2$"],
    answer: "⑤",
  ...
  },
  {
    ...
    choices: ["3","$\\dfrac{4}{3}$","$\\dfrac{1}{3}$","-1","-2"],
    answer: "⑤",
  ...
  },
  {
    ...
    choices: ["가장 작은 양의 정수는 0이다.","정수는 양의 정수와 음의 정수로 나누어진다.","가장 큰 음의 정수는 알 수 없다.","음의 부호 $-$는 생략할 수 있다.","모든 정수는 유리수이다."],
    answer: "⑤",
  ...
  },
  {
    ...
    choices: ["$-\\dfrac{1}{2}$","$\\dfrac{4}{3}$","0","-3","$\\dfrac{5}{2}$"],
    answer: "④",
  ...
  },
  {
    ...
    choices: ["$\\dfrac{3}{2}>\\dfrac{4}{3}$","$0>-3$","$-2<-\\dfrac{5}{2}$","$2<\\dfrac{7}{3}$","$-5<-1$"],
    answer: "③",
  ...
  },
  {
    ...
    wide: false,
    content: "다음 중 옳은 것은?",
    choices: ["$(+6)+(-2)=-4$","$(-7)+(+4)=+11$","$(-2)+(-5)=+7$","$(+5)-(+7)=-2$","$(-4)-(-5)=-9$"],
    answer: "④",
  ...
  },
  {
    ...
    choices: ["-6","6","$-\\dfrac{8}{3}$","$-\\dfrac{3}{8}$","$\\dfrac{3}{8}$"],
    answer: "④",
  ...
  },
  {
    ...
    choices: ["-2","$-\\dfrac{3}{2}$","-1","1","$\\dfrac{3}{2}$"],
    answer: "②",
  ...
  },
  {
    ...
    choices: ["$(-10)-(-5)$","$0\\div(+7)$","$-3^4$","$(-25)\\times(+3)\\times(-2)^2$","$(-36)\\div(-5)\\div6$"],
    answer: "⑤",
  ...
  },
  {
    ...
    choices: ["$a>0, b>0$","$a>0, b<0$","$a<0, b>0$","$a<0, b<0$","$a<0, b=0$"],
    answer: "③",
  ...
  },
  {
    ...
    choices: ["양의 정수는 1개이다.","음수는 3개이다.","정수가 아닌 유리수는 4개이다.","절댓값이 1보다 크고 2 이하인 수는 1개이다.","유리수는 모두 4개이다."],
    answer: "⑤",
  ...
  },
  {
    ...
    choices: ["$-\\dfrac17>-10$","$-0.7>-\\dfrac23$","$\\dfrac{11}{6}<2.7$","$|-8.1|>|5.3|$","$-\\dfrac25<-\\dfrac14$"],
    answer: "②",
  ...
  },
  {
    ...
    choices: ["$\\dfrac{7}{15}$","$\\dfrac35$","$\\dfrac{11}{15}$","$\\dfrac{13}{15}$","1"],
    answer: "③",
  ...
  },
  {
    ...
    choices: ["$(-4)\\times6\\div8$","$(-12)\\div(-4)$","$3\\div(-1)^3$","$(-9)\\div(+3)$","$(-2)\\div\\left(-\\dfrac23\\right)\\times\\left(-\\dfrac94\\right)$"],
    answer: "②",
  ...
  },
  {
    ...
    choices: ["$8-3\\times\\{(-4)-(-6)\\}$","$5-7+9-3$","$\\left(-\\dfrac34\\right)\\times\\left(+\\dfrac43\\right)\\div\\left(-\\dfrac23\\right)$","$(-1)^{2001}\\times(-2)^3$","$\\left(+\\dfrac92\\right)\\div(-6)\\times(-8)$"],
    answer: "④",
  ...
  },
  {
    ...
    choices: ["$-\\dfrac14$","0","$\\dfrac14$","$\\dfrac13$","$\\dfrac25$"],
    answer: "③",
  ...
  },
  {
    ...
    choices: ["$-3\\dfrac12$","$-\\dfrac53$","1","-3","$\\dfrac{12}{5}$"],
    answer: "①",
  ...
  },
  {
    ...
    wide: false,
    content: "다음 중 계산 결과가 나머지 넷과 다른 하나는?",
    choices: ["0보다 2 작은 수","$(-1)^{101}-(-1)^{100}$","$-5+8-7+2$","$(-2)^4\\div2^3$","$\\dfrac{4}{15}\\times(-6)\\div\\dfrac45$"],
    answer: "④",
  ...
  },
  {
    ...
    choices: ["$\\dfrac14$","$-\\dfrac12$","-2","4","$-\\dfrac43$"],
    answer: "③",
  ...
  },
  {
    ...
    choices: ["-4","$-\\dfrac13$","$-\\dfrac14$","$\\dfrac14$","3"],
    answer: "③",
  ...
  },
  {
    ...
    choices: ["$\\dfrac{16}{3}$","$\\dfrac{16}{9}$","$-\\dfrac{16}{15}$","$-\\dfrac{16}{9}$","$-\\dfrac{16}{3}$"],
    answer: "②",
  ...
  },
  {
    ...
    choices: ["$a+b$","$a-b$","$a\\times b$","$a\\div b$","$b-a$"],
    answer: "②",
