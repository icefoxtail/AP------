...
window.questionBank = [
  {
    ...
    "questionType": "객관식",
    "layoutTag": "grid",
    "tags": ["객관식", "좌표평면과 그래프", "점의 좌표", "그래프"],
    "wide": false,
    "content": "좌표평면 위의 점 $A,B,C,D,E$의 좌표를 나타낸 것으로 옳은 것은? [3점]",
    "choices": ["$A(1,4)$", "$B(-2,3)$", "$C(0,-4)$", "$D(-2,-1)$", "$E(-3,3)$"],
    "answer": "②",
  ...
  },
  {
    ...
    "questionType": "객관식",
    "layoutTag": "grid",
    "tags": ["객관식", "좌표평면과 그래프", "점의 좌표", "축 위의 점"],
    "wide": false,
  ...
  },
  {
    ...
    "questionType": "객관식",
    "layoutTag": "grid",
    "tags": ["객관식", "좌표평면과 그래프", "사분면", "축 위의 점"],
    "wide": false,
    "content": "좌표평면 위의 점에 대한 설명으로 옳은 것은? [4점]",
    "choices": ["$x$축 위의 모든 점은 $x$좌표가 $0$이다.", "점 $(-3,\\,0)$은 제2사분면 위의 점이다.", "$(0,\\,3)$은 어느 사분면에도 속하지 않는다.", "두 점 $(1,\\,-2)$, $(-1,\\,2)$는 같은 사분면 위에 있다.", "$y$좌표가 양수인 점은 제1사분면 또는 제2사분면의 점이다."],
    "answer": "③",
  ...
  },
  {
    ...
    "choices": ["$\\dfrac{1}{4}$", "$\\dfrac{2}{3}$", "$\\dfrac{3}{4}$", "$\\dfrac{4}{3}$", "$\\dfrac{5}{4}$"],
    "answer": "④",
  ...
  },
  {
    ...
    "choices": ["$y=-\\dfrac{1}{x}$", "$y=\\dfrac{4}{x}$", "$y=2x$", "$y=-\\dfrac{x}{2}$", "$y=-\\dfrac{1}{5}x$"],
    "answer": "①",
  ...
  },
  {
    ...
    "questionType": "객관식",
    "layoutTag": "grid",
    "tags": ["객관식", "기본도형", "직선과 반직선과 선분", "복수정답", "도형"],
    "wide": false,
    "content": "그림과 같이 직선 $l$ 위에 네 점 $A,B,C,D$가 있다. 다음 중 옳지 <u>않은</u> 것을 <u>모두</u> 고르면? (정답 2개) [4점]",
    "choices": ["$\\overleftrightarrow{AC}=\\overleftrightarrow{BD}$", "$\\overrightarrow{BC}=\\overrightarrow{BA}$", "$\\overrightarrow{AB}=\\overrightarrow{AD}$", "$\\overline{BC}=\\overline{CB}$", "$\\overrightarrow{BC}=\\overrightarrow{AC}$"],
    "answer": "②, ⑤",
  ...
  },
  {
    ...
    "questionType": "객관식",
    "layoutTag": "grid",
    "tags": ["객관식", "기본도형", "맞꼭지각", "평각", "도형"],
    "wide": false,
    "content": "오른쪽 그림에서 $\\angle x+\\angle y-\\angle z$의 값은? [4점]",
    "choices": ["$76^\\circ$", "$80^\\circ$", "$84^\\circ$", "$88^\\circ$", "$92^\\circ$"],
    "answer": "①",
  ...
  },
  {
    ...
    "questionType": "객관식",
    "layoutTag": "grid",
    "tags": ["객관식", "기본도형", "평행선", "동위각", "엇각", "도형"],
    "wide": false,
    "content": "한 평면 위의 두 직선 $l,m$이 직선 $n$과 만날 때, 그림에 대한 설명으로 옳지 <u>않은</u> 것은? [4점]",
    "choices": ["$\\angle b=\\angle f$이면 $l \\parallel m$", "$\\angle c=\\angle e$이면 $l \\parallel m$", "$\\angle f=\\angle h$이면 $l \\parallel m$", "$l \\parallel m$이면 $\\angle a=\\angle g$", "$l \\parallel m$이면 $\\angle b+\\angle e=180^\\circ$"],
    "answer": "③",
  ...
  },
  {
    ...
    "choices": ["$86^\\circ$", "$88^\\circ$", "$90^\\circ$", "$92^\\circ$", "$94^\\circ$"],
    "answer": "①",
  ...
  },
  {
    ...
    "choices": ["$\\overline{OA}=\\overline{O'A'}$", "$\\overline{OB}=\\overline{O'A'}$", "$\\overline{AB}=\\overline{A'B'}$", "$\\overline{OX}=\\overline{OY}$", "작도 순서 : ㉠→㉢→㉡→㉣→㉤"],
    "answer": "④",
  ...
  },
  {
    ...
    "questionType": "객관식",
    "layoutTag": "grid",
    "tags": ["객관식", "기본도형", "삼각형의 결정조건"],
    "wide": false,
    "content": "다음 중 $\\triangle ABC$의 모양과 크기가 하나로 정해지는 것은? [4점]",
    "choices": ["$\\overline{AB}=5\\,\\mathrm{cm}$, $\\overline{AC}=7\\,\\mathrm{cm}$, $\\angle C=50^\\circ$", "$\\overline{AB}=10\\,\\mathrm{cm}$, $\\overline{BC}=3\\,\\mathrm{cm}$, $\\overline{CA}=5\\,\\mathrm{cm}$", "$\\angle A=70^\\circ$, $\\angle B=45^\\circ$, $\\angle C=65^\\circ$", "$\\angle A=80^\\circ$, $\\overline{AB}=6\\,\\mathrm{cm}$, $\\overline{BC}=4\\,\\mathrm{cm}$", "$\\overline{AB}=10\\,\\mathrm{cm}$, $\\angle A=50^\\circ$, $\\angle B=70^\\circ$"],
    "answer": "⑤",
