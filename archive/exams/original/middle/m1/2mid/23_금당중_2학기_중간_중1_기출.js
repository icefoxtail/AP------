...
window.questionBank = [
  {
    ...
    "answer": "③",
    "solution": "좌표평면에서 점 $C$는 $x$축의 양의 방향으로 $4$, $y$축의 음의 방향으로 $1$만큼 떨어져 있으므로 $C(4,-1)$이다. 따라서 정답은 ③이다.",
    "image": "assets/images/23_금당중_2학기_중간_중1_기출/q1.png",
  ...
  },
  {
    ...
    "wide": false,
    "content": "두 순서쌍 $(3a,\\,2b+2)$와 $(8-a,\\,-2b+6)$이 서로 같을 때, $ab$의 값을 구하면? (4점)",
    "choices": [
      "$-4$",
      "$-2$",
      "$0$",
    ...
    "problemTypeKey": "PT_ORDERED_PAIR_EQUALITY",
    "templateKey": "TPL_EQUAL_COMPONENTS_TO_SOLVE_PARAMETER_PRODUCT",
    "crossConceptKeys": [],
    "conditionKeys": [],
  ...
  },
  {
    ...
    "wide": false,
    "content": "점 $\\left(-2a,\\,\\dfrac{a}{3}-1\\right)$이 $x$축 위의 점이고, 점 $(2-b,\\,-2b)$이 $y$축 위의 점일 때, $a+b$의 값을 구하면? (4점)",
    "choices": [
      "$-5$",
      "$-3$",
      "$0$",
    ...
    "subUnitConfidence": "rule_inferred",
    "subUnitClassificationDepth": "complete_rule",
    "problemTypeKey": "PT_AXIS_MEMBERSHIP_COORDINATE_CONDITION",
    "templateKey": "TPL_AXIS_POINT_ZERO_COMPONENT_SUM",
    "crossConceptKeys": [],
    "conditionKeys": [],
    "integrationPattern": "NONE",
    "difficultyBucket": 2,
  ...
  },
  {
    ...
    "wide": false,
    "content": "점 $(a,\\,b)$가 제$4$사분면 위의 점일 때, 다음 중 점 $\\left(a,\\,-\\dfrac{a}{b}\\right)$와 같은 사분면 위의 점은? (5점)",
    "choices": [
      "$(2,\\,5)$",
      "$(4,\\,-3)$",
      "$(4,\\,0)$",
    ...
    "templateKey": "TPL_QUADRANT_SIGN_TRANSFORM",
    "crossConceptKeys": [],
  ...
  },
  {
    ...
    "wide": false,
    "content": "토끼와 거북이가 경주를 할 때, $x$분 후에 출발점과 각 동물이 위치한 지점 사이의 거리를 $y\\,\\mathrm{km}$라 하자. 다음 그림은 $x$와 $y$ 사이의 관계를 그래프로 나타낸 것이다. 토끼와 거북이가 만나는 시간은 거북이가 출발한 지 몇 분 후인지를 모두 고른 것은? (4점)",
    "choices": [
      "$10$분",
      "$20$분",
      "$10$분, $20$분",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림은 어느 도시의 하루 동안 시간에 따른 기온의 변화를 그래프로 나타낸 것이다. 다음 중 옳지 않은 것은? (3점)",
    "choices": [
      "$3$시와 $9$시의 기온의 차는 $2\\,^{\\circ}\\mathrm{C}$이다.",
      "$9$시와 $21$시의 기온은 같다.",
      "하루 중 기온이 가장 높은 시각은 $15$시이다.",
      "$18$시의 기온은 $26\\,^{\\circ}\\mathrm{C}$이다.",
      "하루 중 기온이 가장 높을 때와 가장 낮을 때의 기온의 차는 $4\\,^{\\circ}\\mathrm{C}$이다."
    ],
    "answer": "①",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림과 같이 네 점 $A$, $B$, $C$, $D$가 직선 $l$ 위에 있을 때, 다음 중에서 옳지 않은 것은? (3점)",
    "choices": [
      "$\\overline{CD}=\\overline{DC}$",
      "$\\overrightarrow{AB}=\\overrightarrow{BA}$",
      "$\\overrightarrow{CA}=\\overrightarrow{CB}$",
      "$\\overrightarrow{BC}=\\overrightarrow{BD}$",
      "$\\overleftrightarrow{AB}=\\overleftrightarrow{BD}$"
    ],
    "answer": "②",
    "solution": "선분은 양 끝점의 순서를 바꾸어도 같지만, 반직선은 시작점과 방향이 중요하다. $\\overrightarrow{AB}$와 $\\overrightarrow{BA}$는 시작점과 방향이 서로 다르므로 같지 않다. 따라서 정답은 ②이다.",
    "image": "assets/images/23_금당중_2학기_중간_중1_기출/q8.png",
    "visualAssetStatus": "ready",
  ...
  },
  {
    ...
    "wide": false,
    "content": "아래 그림에서 두 점 $M$, $N$은 각각 $\\overline{AB}$, $\\overline{AM}$의 중점이다. $\\overline{AB}=2\\overline{BC}$, $\\overline{NM}=3\\,\\mathrm{cm}$일 때, $\\overline{AC}$의 길이는? (4점)",
    "choices": [
      "$12\\,\\mathrm{cm}$",
      "$14\\,\\mathrm{cm}$",
      "$15\\,\\mathrm{cm}$",
    ...
    "templateKey": "TPL_TWO_MIDPOINTS_WITH_SEGMENT_LENGTH_RATIO",
    "crossConceptKeys": [],
    "conditionKeys": [],
    "integrationPattern": "SEQUENTIAL",
    "difficultyBucket": 2,
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림에서 $\\angle a$의 크기는? (3점)",
    "choices": [
      "$90^{\\circ}$",
      "$100^{\\circ}$",
      "$110^{\\circ}$",
    ...
    "answer": "④",
    "solution": "직각과 $30^{\\circ}$인 각을 합한 각의 맞꼭지각이 $\\angle a$이다. 따라서 $a=90+30=120^{\\circ}$이므로 정답은 ④이다.",
    "image": "assets/images/23_금당중_2학기_중간_중1_기출/q10.png",
    "visualAssetStatus": "ready",
    "subUnitKey": "M1-05-BASIC_FIGURE",
    "subUnit": "점·선·면과 각",
    "subUnitConfidence": "rule_inferred",
    "subUnitClassificationDepth": "complete_rule",
    "problemTypeKey": "PT_ANGLE_CHASE_VERTICAL_AND_RIGHT_ANGLE",
    "templateKey": "TPL_VERTICAL_ANGLE_FROM_RIGHT_ANGLE_PLUS_GIVEN",
    "crossConceptKeys": [],
    "conditionKeys": [],
    "integrationPattern": "SEQUENTIAL",
    "difficultyBucket": 1,
  ...
  },
  {
    ...
    "wide": false,
    "content": "삼각형의 두 변의 길이가 각각 $5\\,\\mathrm{cm}$, $8\\,\\mathrm{cm}$일 때, 다음 중에서 나머지 한 변의 길이가 될 수 있는 것은 모두 몇 개인가? (4점)<div class=\"note-box\">$3\\,\\mathrm{cm}\\qquad5\\,\\mathrm{cm}\\qquad9\\,\\mathrm{cm}\\qquad11\\,\\mathrm{cm}\\qquad15\\,\\mathrm{cm}$</div>",
    "choices": [
      "$1$개",
      "$2$개",
      "$3$개",
    ...
    "templateKey": "TPL_FILTER_CANDIDATE_SIDE_LENGTHS_BY_TRIANGLE_INEQUALITY",
    "crossConceptKeys": [],
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 중에서 오른쪽 직육면체에 대한 설명으로 옳지 않은 것은? (4점)",
    "choices": [
      "$\\overline{AC}$와 꼬인 위치에 있는 모서리는 $6$개이다.",
      "$\\overline{EG}$와 수직인 모서리는 $2$개이다.",
      "꼭짓점 $G$와 면 $AEHD$ 사이의 거리는 $3\\,\\mathrm{cm}$이다.",
      "면 $AEGC$와 평행한 모서리는 $2$개이다.",
    ...
    "subUnitConfidence": "rule_inferred",
    "subUnitClassificationDepth": "complete_rule",
    "problemTypeKey": "PT_RECTANGULAR_PRISM_RELATION_STATEMENT_JUDGMENT",
    "templateKey": "TPL_FIND_FALSE_CUBOID_RELATION_OR_DISTANCE_CLAIM",
    "crossConceptKeys": [],
    "conditionKeys": [],
    "integrationPattern": "NONE",
    "difficultyBucket": 3,
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림은 직사각형 모양의 종이를 선분 $HE$, 선분 $EF$를 접는 선으로 하여 접은 것이다. $\\angle CGE=50^{\\circ}$, $\\angle DCF=18^{\\circ}$일 때, $\\angle CEG+\\angle CEF$의 크기는? (5점)",
    "choices": [
      "$72^{\\circ}$",
      "$94^{\\circ}$",
      "$96^{\\circ}$",
    ...
    "templateKey": "TPL_TWO_FOLDS_RECTANGLE_ANGLE_TRANSFER",
    "crossConceptKeys": [],
    "conditionKeys": [],
    "integrationPattern": "SEQUENTIAL",
    "difficultyBucket": 4,
  ...
  },
  {
    ...
    "wide": false,
    "content": "오른쪽 그림은 직선 $l$ 위에 있지 않은 한 점 $P$를 지나면서 직선 $l$과 평행한 직선을 작도한 것이다. 다음 중 옳지 않은 것은? (4점)",
    "choices": [
      "$\\overline{DQ}=\\overline{PB}$이다.",
      "$\\angle APB=\\angle DQC$이다.",
      "$\\overline{AB}=\\overline{PA}$이다.",
      "작도 순서는 ㉣ → ㉠ → ㉤ → ㉡ → ㉥ → ㉢이다.",
    ...
    "templateKey": "TPL_COPY_ANGLE_TO_CONSTRUCT_PARALLEL_LINE",
    "crossConceptKeys": [],
    "conditionKeys": [],
    "integrationPattern": "NONE",
    "difficultyBucket": 3,
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 중 $\\triangle ABC$가 한 가지로 정해지는 것은? (4점)",
    "choices": [
      "$\\overline{AC}=8\\,\\mathrm{cm}$, $\\overline{BC}=5\\,\\mathrm{cm}$, $\\angle A=40^{\\circ}$",
      "$\\overline{BC}=4\\,\\mathrm{cm}$, $\\angle B=30^{\\circ}$, $\\angle C=70^{\\circ}$",
      "$\\overline{AB}=5\\,\\mathrm{cm}$, $\\overline{BC}=11\\,\\mathrm{cm}$, $\\overline{CA}=6\\,\\mathrm{cm}$",
      "$\\angle A=45^{\\circ}$, $\\angle B=70^{\\circ}$, $\\angle C=65^{\\circ}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "아래 그림에서 $\\overline{BC}=\\overline{EF}$일 때, 두 가지 조건을 추가하여 $\\triangle ABC\\equiv\\triangle DEF$가 되도록 하려고 한다. 다음 중 이때 필요한 조건이 아닌 것은? (4점)",
    "choices": [
      "$\\angle A=\\angle D$, $\\angle B=\\angle E$",
      "$\\overline{AB}=\\overline{DE}$, $\\angle B=\\angle E$",
      "$\\overline{CA}=\\overline{FD}$, $\\angle C=\\angle F$",
    ...
    "templateKey": "TPL_REJECT_AMBIGUOUS_SSA_CONGRUENCE_DATA",
    "crossConceptKeys": [],
    "conditionKeys": [],
    "integrationPattern": "NONE",
    "difficultyBucket": 3,
  ...
  },
  {
    ...
    "wide": false,
    "content": "오른쪽 그림과 같은 정사각형 $ABCD$에서 $\\overline{EB}=\\overline{FC}$이고, $\\angle CDF=15^{\\circ}$일 때, $\\angle DCE$의 크기는? (4점)",
    "choices": [
      "$75^{\\circ}$",
      "$70^{\\circ}$",
      "$65^{\\circ}$",
    ...
    "templateKey": "TPL_SQUARE_SAS_CONGRUENCE_ANGLE_TRANSFER",
  ...
  },
  {
    ...
    "wide": false,
    "content": "오른쪽 그림에서 $\\triangle ABC$와 $\\triangle CDE$는 정삼각형이고 $\\angle DBE=70^{\\circ}$일 때, $\\angle x$의 크기는? (5점)",
    "choices": [
      "$100^{\\circ}$",
      "$110^{\\circ}$",
      "$120^{\\circ}$",
  ...
  },
  {
    ...
    "templateKey": "TPL_VERTICAL_ANGLE_LINEAR_AND_RIGHT_ANGLE_EQUATIONS",
    "crossConceptKeys": [],
    "conditionKeys": [],
    "integrationPattern": "SEQUENTIAL",
    "difficultyBucket": 2,
  ...
  },
  {
    ...
    "subUnitClassificationDepth": "complete_rule",
    "problemTypeKey": "PT_ANGLE_MEASURE_FROM_ALGEBRAIC_RELATIONS",
    "templateKey": "TPL_PERPENDICULAR_LINE_ANGLE_RATIO_CHAIN",
    "crossConceptKeys": [],
    "conditionKeys": [],
    "integrationPattern": "SEQUENTIAL",
    "difficultyBucket": 3,
  ...
  },
  {
    ...
    "subUnitConfidence": "candidate_evidence",
    "subUnitClassificationDepth": "complete_candidate",
    "problemTypeKey": "PT_TRAPEZOID_AREA_FROM_CONGRUENT_TRIANGLES",
    "templateKey": "TPL_USE_TRIANGLE_CONGRUENCE_TO_RECOVER_TRAPEZOID_BASE_SUM",
    "crossConceptKeys": [],
    "conditionKeys": [],
    "integrationPattern": "SEQUENTIAL",
    "difficultyBucket": 4,
