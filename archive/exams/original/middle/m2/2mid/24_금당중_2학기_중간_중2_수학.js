...
window.questionBank=[
  {
    ...
    "wide": false,
    "content": "$\\triangle ABC\\sim\\triangle DEF$이고 닮음비가 $3:1$이다. $BC=24$, $AC=18$, $DE=7$일 때, $\\triangle DEF$의 둘레는? [3점]",
    "choices": [
      "$18\\mathrm{cm}$",
      "$21\\mathrm{cm}$",
      "$23\\mathrm{cm}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "$M$은 $AB$의 중점이고 $MN\\parallel BC$이다. $AB=7$, $BC=11$일 때, 그림의 $x+y$는? [3점]",
    "choices": [
      "$6\\mathrm{cm}$",
      "$7\\mathrm{cm}$",
      "$8\\mathrm{cm}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "두 삼각기둥은 서로 닮은 도형이고, $EF=2\\mathrm{cm}$에 대응하는 모서리가 $KL=4\\mathrm{cm}$이다. 작은 삼각기둥의 부피가 $12\\mathrm{cm}^3$일 때, 큰 삼각기둥의 부피는? [3점]",
    "choices": [
      "$24\\mathrm{cm}^3$",
      "$48\\mathrm{cm}^3$",
      "$72\\mathrm{cm}^3$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "$D,E$는 각각 $AB,AC$의 연장선 위에 있고 $BC\\parallel DE$이다. $AD=12$, $DB=4$, $DE=9$, $CE=3$일 때, $\\triangle ABC$의 둘레는? [4점]",
    "choices": [
      "$17\\mathrm{cm}$",
      "$18\\mathrm{cm}$",
      "$19\\mathrm{cm}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "$DE\\parallel BC$, $DF\\parallel BE$이고 $AF=9$, $FE=6$일 때, $EC$의 길이는? [4점]",
    "choices": [
      "10",
      "$\\dfrac{32}{3}$",
      "12",
  ...
  },
  {
    ...
    "wide": false,
    "content": "점 $G$가 $\\triangle ABC$의 무게중심일 때, 옳지 않은 것을 모두 고르면? (정답 2개) [4점]",
    "choices": [
      "$GB:GC=1:1$",
      "$AG=2GD$",
      "사각형 $AFGE$와 $\\triangle GBC$의 넓이가 같다.",
  ...
  },
  {
    ...
    "wide": false,
    "content": "$G$는 $\\triangle ABC$의 무게중심이고 $DA\\parallel EF$, $DE=EC$이다. $AG=12\\mathrm{cm}$일 때, $EF$의 길이는? [4점]",
    "choices": [
      "$8\\mathrm{cm}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "점 $G$가 $\\triangle ABC$의 무게중심이고 $\\triangle ADE$의 넓이가 $30\\mathrm{cm}^2$일 때, $\\triangle GDE$의 넓이는? [4점]",
    "choices": [
      "$6\\mathrm{cm}^2$",
      "$9\\mathrm{cm}^2$",
      "$10\\mathrm{cm}^2$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "직사각형 $ABCD$에서 $BE$를 접는 선으로 하여 $C$가 $AD$ 위의 $C'$에 오도록 접었다. $AB=8$, $BC=10$, $DE=3$일 때, $DC'$의 길이는? [4점]",
    "choices": [
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 중 미지수가 2개인 일차방정식인 것은? [3점]",
    "choices": [
      "$x-3y=12$",
      "$2x+y+1$",
      "$x^2-3$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "일차방정식 $4x+3y=19$를 만족시키는 자연수 $x,y$의 순서쌍 $(x,y)$의 개수는? [3점]",
    "choices": [
      "1",
      "2",
      "3",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 연립방정식 중 해가 $x=1$, $y=-1$인 것은? [4점]",
    "choices": [
  ...
  },
  {
    ...
    "wide": false,
    "content": "연립방정식 $\\begin{cases}x+2y=5\\\\5x-ay=7\\end{cases}$의 해가 $3x-2y=-1$을 만족시킬 때, $a$는? [4점]",
    "choices": [
      "$-3$",
      "$-2$",
      "$-1$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "재열이와 철우가 가위바위보를 하여 이긴 사람은 한 계단 올라가고 진 사람은 두 계단 내려갔다. 그 결과 처음의 위치보다 재열이는 1계단 내려가고 철우는 4계단 내려가 있었다. 두 사람이 가위바위보를 한 전체 횟수를 구하면? (단, 비긴 경우는 없었다고 한다.) [4점]",
    "choices": [
      "1",
      "2",
      "3",
  ...
  },
  {
    ...
    "wide": false,
    "content": "연립방정식 $\\begin{cases}2ax-by=2\\\\bx+ay=4\\end{cases}$을 풀면서 $a,b$를 바꾸어 놓아 $x=1,y=-2$를 얻었다. 처음 연립방정식의 해는? [5점]",
    "choices": [
      "$x=0,y=2$",
      "$x=1,y=-2$",
      "$x=-1,y=2$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "[서술형 1] 직사각형 $ABCD$에서 $O$는 대각선 $BD$의 중점이고, $O$에서 $BD$에 수직인 직선과 $AD$, $BC$의 교점을 각각 $E$, $F$라 하자. $BO=5\\,\\mathrm{cm}$, $BC=8\\,\\mathrm{cm}$, $DC=6\\,\\mathrm{cm}$일 때, 다음 물음에 답하시오.\n(1) 문제 해결을 위한 닮은 두 삼각형을 찾고 닮음조건을 쓰시오. [2점]\n(2) (1)에서 찾은 두 닮은 삼각형의 닮음비를 쓰시오. [1점]\n(3) $EO$의 길이를 구하시오. [2점]",
    "choices": [],
  ...
  },
  {
    ...
    "wide": false,
    "content": "[서술형 2] 사다리꼴 $ABCD$에서 $AD\\parallel EF\\parallel BC$, $AE=8\\,\\mathrm{cm}$, $EB=4\\,\\mathrm{cm}$, $AD=6\\,\\mathrm{cm}$, $BC=15\\,\\mathrm{cm}$일 때, $PQ$의 길이를 구하시오. [5점] (부분점수 있음)",
    "choices": [],
    "answer": "$8\\mathrm{cm}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "[서술형 3] 지윤이네 반은 학교 체육 대회를 위해 응원 도구를 구입하려고 한다. 응원 막대 24개와 나팔 6개의 가격은 34200원이고, 응원 막대 20개와 나팔 10개의 가격은 33000원이다.\n(1) 응원 막대 1개의 가격을 $x$원, 나팔 1개의 가격을 $y$원으로 놓고 문제의 뜻에 맞는 연립방정식을 세우시오. [2점]\n(2) (1)에서 세운 연립방정식을 풀고, 응원 막대 1개와 나팔 1개의 가격을 각각 구하시오. [3점]",
    "choices": [],
  ...
  },
  {
    ...
    "wide": false,
    "content": "[서술형 4] 다음 네 일차방정식이 한 쌍의 공통인 해를 가질 때, 두 수 $a$, $b$에 대하여 다음 물음에 답하시오.\n$3x-5y=27,\\quad x-ay=16,\\quad bx-y=23,\\quad -2x+3y=-17$\n(1) 공통인 해를 구하시오. [2점]\n(2) $ab$의 값을 구하시오. [3점] (부분점수 있음)",
    "choices": [],
