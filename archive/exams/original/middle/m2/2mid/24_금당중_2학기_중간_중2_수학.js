window.examTitle="24_금당중_2학기_중간_중2_수학";
...
window.questionBank=[
  {
    ...
    "wide": false,
    "content": "그림에서 $\\triangle ABC$∽$\\triangle DEF$이고, 닮음비가 $3:1$일 때, $\\triangle DEF$의 둘레의 길이는? [3점]",
    "choices": [
      "$18\\mathrm{cm}$",
      "$21\\mathrm{cm}$",
      "$23\\mathrm{cm}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 중 항상 닮은 도형이라고 할 수 없는 것은? [4점]",
    "choices": [
      "한 내각의 크기가 같은 두 이등변삼각형",
      "반지름의 길이가 다른 두 원",
      "중심각의 크기가 같은 두 부채꼴",
      "한 예각의 크기가 같은 두 직각삼각형",
  ...
  },
  {
    ...
    "wide": false,
    "content": "$\\triangle ABC$에서 점 $M$은 $\\overline{AB}$의 중점이고 $\\overline{MN}\\parallel\\overline{BC}$일 때, $x+y$의 값은? [3점]",
    "choices": [
      "$6\\mathrm{cm}$",
      "$7\\mathrm{cm}$",
      "$8\\mathrm{cm}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "두 삼각기둥은 서로 닮은 도형이고, $\\overline{EF}=2\\mathrm{cm}$에 대응하는 모서리가 $\\overline{KL}=4\\mathrm{cm}$이다. 작은 삼각기둥의 부피가 $12\\mathrm{cm}^3$일 때 큰 삼각기둥의 부피는? [3점]",
    "choices": [
      "$24\\mathrm{cm}^3$",
      "$48\\mathrm{cm}^3$",
      "$72\\mathrm{cm}^3$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "그림과 같은 $\\triangle ABC$에서 두 점 $D$, $E$는 각각 $\\overline{AB}$, $\\overline{AC}$의 연장선 위의 점이고 $\\overline{BC}\\parallel\\overline{DE}$일 때, $\\triangle ABC$의 둘레 길이는? [4점]",
    "choices": [
      "$17\\mathrm{cm}$",
      "$18\\mathrm{cm}$",
      "$19\\mathrm{cm}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림과 같은 $\\triangle ABC$에서 $\\overline{DE}\\parallel\\overline{BC}$, $\\overline{DF}\\parallel\\overline{BE}$이고, $\\overline{AF}=9$, $\\overline{FE}=6$일 때 $\\overline{EC}$의 길이는? [4점]",
    "choices": [
      "10",
      "$\\dfrac{32}{3}$",
      "12",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림에서 점 $G$가 $\\triangle ABC$의 무게중심일 때, 다음 중 옳지 않은 것은? (정답 2개) [4점]",
    "choices": [
      "$\\overline{GB}:\\overline{GC}=1:1$",
      "$\\overline{AG}=2\\overline{GD}$",
      "$\\square AFGE=\\triangle GBC$",
      "$\\triangle ABC=6\\triangle GBD$",
      "$\\overline{GF}=\\dfrac13\\overline{CG}$"
    ],
    "answer": "①, ⑤",
  ...
  },
  {
    ...
    "wide": false,
    "content": "점 $G$는 $\\triangle ABC$의 무게중심이고, $\\overline{DA}\\parallel\\overline{EF}$, $\\overline{DE}=\\overline{EC}$이다. $\\overline{AG}=12\\mathrm{cm}$일 때, $\\overline{EF}$의 길이는? [4점]",
    "choices": [
      "$8\\mathrm{cm}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림에서 점 $G$가 $\\triangle ABC$의 무게중심이고, $\\triangle ADE$의 넓이가 $30\\mathrm{cm}^2$일 때 $\\triangle GDE$의 넓이는? [4점]",
    "choices": [
      "$6\\mathrm{cm}^2$",
      "$9\\mathrm{cm}^2$",
      "$10\\mathrm{cm}^2$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 직사각형 $ABCD$에서 $\\overline{BE}$를 접는 선으로 하여 꼭짓점 $C$가 $\\overline{AD}$ 위의 점 $C'$에 오도록 접었을 때, $\\overline{DC'}$의 길이는? [4점]",
    "choices": [
      "$\\dfrac{10}{3}\\mathrm{cm}$",
      "$4\\mathrm{cm}$",
      "$\\dfrac{14}{3}\\mathrm{cm}$",
      "$5\\mathrm{cm}$",
      "$\\dfrac{16}{3}\\mathrm{cm}$"
    ],
    "answer": "②",
  ...
  },
  {
    ...
    "wide": false,
    "content": "일차방정식 $4x+3y=19$를 만족시키는 자연수 $x$와 $y$의 순서쌍 $(x,y)$의 개수는? [3점]",
    "choices": [
      "1",
      "2",
      "3",
  ...
  },
  {
    ...
    "wide": false,
    "content": "두 순서쌍 $(1,2)$와 $(p,-\\dfrac12p)$가 모두 일차방정식 $ax+3y=8$의 해일 때, $a+p$의 값을 구하면? (단, $a$는 수이다.) [4점]",
    "choices": [
      "10",
      "12",
      "14",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 연립방정식 중에서 해가 $x=1$, $y=-1$인 것은? [4점]",
    "choices": [
  ...
  },
  {
    ...
    "wide": false,
    "content": "연립방정식 $\\begin{cases}3(x+2)=9-(y-x)\\\\3x-2=x-3y+3\\end{cases}$을 풀면? [4점]",
    "choices": [
      "$x=-1,y=-1$",
      "$x=1,y=1$",
      "$x=1,y=-1$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "연립방정식 $\\begin{cases}x+2y=5\\\\5x-ay=7\\end{cases}$의 해가 일차방정식 $3x-2y=-1$을 만족시킬 때, 수 $a$의 값은? [4점]",
    "choices": [
      "$-3$",
      "$-2$",
      "$-1$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "연립방정식 $\\begin{cases}0.4x+0.1y=1.1\\\\\\dfrac12x-\\dfrac16y=\\dfrac12\\end{cases}$의 해가 $(a,b)$일 때, $a+b$는? [4점]",
    "choices": [
      "2",
      "3",
      "4",
  ...
  },
  {
    ...
    "wide": false,
    "content": "재열이와 철우가 가위바위보를 하여 이긴 사람은 한 계단 올라가고, 진 사람은 두 계단 내려가기로 했다. 그 결과 처음의 위치보다 재열이는 1계단 내려가고 철우는 4계단을 내려가 있었다. 두 사람이 가위바위보를 한 전체 횟수를 구하면? [4점]\n(단, 비긴 경우는 없었다고 한다.)",
    "choices": [
      "1",
      "2",
      "3",
  ...
  },
  {
    ...
    "wide": false,
    "content": "연립방정식 $\\begin{cases}2ax-by=2\\\\bx+ay=4\\end{cases}$을 푸는데 잘못하여 $a$, $b$를 바꾸어 놓고 풀었더니 $x=1$, $y=-2$를 얻었다. 처음 연립방정식의 해는? (단, $a$와 $b$는 수이다.) [5점]",
    "choices": [
      "$x=0,y=2$",
      "$x=1,y=-2$",
      "$x=-1,y=2$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 보기의 함수 중 $f(3)=7$를 만족시키는 것은? [4점]\n<div class=\"note-box\">ㄱ. $f(x)=-3x+1$　　ㄴ. $f(x)=\\dfrac{x+7}{2}$<br>ㄷ. $f(x)=2x+1$　　ㄹ. $f(x)=\\dfrac{21}{x}$</div>",
    "choices": [
      "ㄱ, ㄴ",
      "ㄴ, ㄷ",
      "ㄴ, ㄹ",
  ...
  },
  {
    ...
    "wide": false,
    "content": "[서술형1] 다음 직사각형 $ABCD$에서 대각선 $\\overline{BD}$의 중점을 $O$라 하고, 점 $O$에서 $\\overline{BD}$에 수직인 직선과 $\\overline{AD}$, $\\overline{BC}$의 교점을 각각 $E$, $F$라고 하자. $\\overline{BO}=5\\mathrm{cm}$, $\\overline{BC}=8\\mathrm{cm}$, $\\overline{DC}=6\\mathrm{cm}$이고, $\\overline{EO}$의 길이를 구하려고 할 때 다음 물음에 답하시오.\n(1) 문제 해결을 위한 닮음인 두 삼각형을 찾고 닮음조건을 쓰시오. [2점]\n(2) (1)에서 찾은 두 닮은 삼각형의 닮음비를 쓰시오. [1점]\n(3) $\\overline{EO}$의 길이를 구하시오. [2점]",
    "choices": [],
  ...
  },
  {
    ...
    "wide": false,
    "content": "[서술형2] 다음 그림의 사다리꼴 $ABCD$에서 $\\overline{AD}\\parallel\\overline{EF}\\parallel\\overline{BC}$이고, $\\overline{AE}=8\\mathrm{cm}$, $\\overline{EB}=4\\mathrm{cm}$, $\\overline{AD}=6\\mathrm{cm}$, $\\overline{BC}=15\\mathrm{cm}$일 때 $\\overline{PQ}$의 길이를 구하시오. [5점] (부분점수 있음)",
    "choices": [],
    "answer": "$8\\mathrm{cm}$",
