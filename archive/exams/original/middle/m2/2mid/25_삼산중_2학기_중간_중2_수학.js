window.examTitle = "25_삼산중_2학기_중간_중2_수학";
window.questionBank = [
  {
    "id": 1,
    "level": "중",
    ...
    "wide": false,
    "content": "다음 그림에서 점 $I$가 $\\triangle ABC$의 내심일 때, $\\angle IBD$의 크기와 점 $I$에서 변 $AB$에 이르는 거리의 값을 바르게 짝지은 것을 고르면? [4점]",
    "choices": [
      "$25^\\circ,\\ 4\\mathrm{cm}$",
      "$30^\\circ,\\ 4\\mathrm{cm}$",
      "$35^\\circ,\\ 4\\mathrm{cm}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림에서 점 $O$가 $\\triangle ABC$의 외심일 때, $\\triangle OAD$와 합동인 삼각형을 고르면? [4점]",
    "choices": [
      "$\\triangle OAF$",
      "$\\triangle OBD$",
      "$\\triangle OCF$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 직각삼각형 중에서 서로 합동인 것끼리 짝짓고, 합동조건과 바르게 연결된 것을 고르면? [4점]",
    "choices": [
      "$(ㄱ,ㄷ)$, ASA 합동",
      "$(ㄱ,ㅁ)$, RHS 합동",
      "$(ㄴ,ㅁ)$, RHS 합동",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 직각이등변삼각형 $ABC$에서 꼭짓점 $A$를 지나는 직선 $l$을 긋고, 두 점 $B$와 $C$에서 직선 $l$에 내린 수선의 발을 각각 $D$와 $E$라 하자. $BD=4\\mathrm{cm}$, $CE=3\\mathrm{cm}$일 때, $DE$의 길이를 구하는 과정의 빈칸에 알맞은 것을 바르게 짝지은 것은? [4점]\\n$\\triangle ABD\\equiv\\triangle CAE$ (□ 합동)\\n따라서 $DE=$ □",
    "choices": [
      "RHS, $6\\mathrm{cm}$",
      "RHA, $6\\mathrm{cm}$",
      "SAS, $6\\mathrm{cm}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림에서 점 $I$는 $\\triangle ABC$의 내심이다. $\\angle AID:\\angle BIE:\\angle CIF=4:6:5$일 때, $\\angle ABC$의 크기를 구하면? [4점]",
    "choices": [
      "$36^\\circ$",
      "$37^\\circ$",
      "$38^\\circ$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 평행사변형 $ABCD$에서 $\\angle CAD$의 이등분선과 $BC$의 연장선이 만나는 점을 $E$라 하자. $\\angle B=68^\\circ$, $\\angle ACD=42^\\circ$일 때, $\\angle E$의 크기를 구하면? [4점]",
    "choices": [
      "$20^\\circ$",
      "$25^\\circ$",
      "$30^\\circ$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 마름모 $ABCD$에서 $AC=14\\mathrm{cm}$, $BD=18\\mathrm{cm}$이고, $BC$ 위의 점 $P$에 대하여 $BP:PC=2:1$일 때, 삼각형 $DBP$의 넓이를 구하면? [5점]",
    "choices": [
      "$41\\mathrm{cm}^2$",
      "$42\\mathrm{cm}^2$",
      "$43\\mathrm{cm}^2$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "오른쪽 그림과 같이 반지름의 길이가 $4\\mathrm{cm}$인 원 $O$ 위에 점 $B$가 있다. 직사각형 $OABC$에서 $AC$의 길이를 구하면? [4점]",
    "choices": [
      "$2\\mathrm{cm}$",
      "$3\\mathrm{cm}$",
      "$4\\mathrm{cm}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림과 같이 $BD=10\\mathrm{cm}$인 정사각형 $ABCD$가 있다. 두 대각선의 교점을 $O$라 하고 $AO=x\\mathrm{cm}$, $\\angle DPO=55^\\circ$, $\\angle PDC=y^\\circ$라 할 때, $x+y$의 값을 구하면? [4점]",
    "choices": [
      "10",
      "15",
      "20",
  ...
  },
  {
    ...
    "wide": false,
    "content": "오른쪽 평행사변형 $ABCD$에서 두 변 $AB$와 $CD$의 중점을 각각 $M$과 $N$이라고 하자. $\\angle BNC=50^\\circ$, $\\angle ADM=20^\\circ$일 때, $\\angle BMD$의 크기를 구하면? [4점]",
    "choices": [
      "$110^\\circ$",
      "$115^\\circ$",
      "$120^\\circ$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "진수는 50원, 100원, 500원짜리 동전을 각각 6개씩 갖고 있다. 가게에서 800원짜리 과자를 살 때, 거스름돈 없이 그 값을 지불하는 모든 방법의 수를 구하면? [4점]",
    "choices": [
      "4가지",
      "5가지",
      "6가지",
  ...
  },
  {
    ...
    "wide": false,
    "content": "0, 1, 2, 3, 4, 5가 각각 하나씩 적힌 카드 6장이 있다. 이 중에서 두 장을 뽑아 두 자리 자연수를 만들 때, 만들 수 있는 두 자리 자연수 중에서 2의 배수의 개수를 구하면? [4점]",
    "choices": [
      "13개",
      "14개",
      "15개",
  ...
  },
  {
    ...
    "wide": false,
    "content": "두 사람이 가위바위보를 할 때, 승부가 나는 경우의 수를 구하면? [3점]",
    "choices": [
      "3",
      "4",
      "5",
  ...
  },
  {
    ...
    "wide": false,
    "content": "처음 만난 세 명의 학생이 서로 한 번씩 악수를 할 때, 악수의 총 횟수를 구하면? [3점]",
    "choices": [
      "1회",
      "2회",
      "3회",
  ...
  },
  {
    ...
    "wide": false,
    "content": "삼산이네 반에서 남학생 후보 4명과 여학생 후보 4명 중에서 대표를 뽑으려 한다. 다음 두 가지 상황의 경우의 수를 구해서 합한 값을 구하면? [4점]\\n(1) 남학생 후보 또는 여학생 후보 중에서 1명을 대표로 뽑는 경우의 수\\n(2) 후보들 중에서 남학생 대표 1명, 여학생 대표 1명을 뽑는 경우의 수",
    "choices": [
      "21",
      "22",
      "23",
  ...
  },
  {
    ...
    "wide": false,
    "content": "아래 그림과 같이 집에서 학교까지 가는 길은 2가지, 학교에서 도서관으로 가는 길은 3가지, 집에서 도서관으로 바로 가는 길은 2가지가 있다. 집에서 도서관으로 갈 수 있는 모든 경우의 수를 구하면? (단, 같은 지점을 두 번 이상 지나지 않는다.) [4점]",
    "choices": [
      "4가지",
      "5가지",
      "6가지",
  ...
  },
  {
    ...
    "wide": false,
    "content": "[서술형 1] 다음 그림과 같이 $AB=BC$인 이등변삼각형 $ABC$에서 $\\angle C$의 이등분선과 변 $AB$의 교점을 $D$라고 할 때, $AC$의 길이를 구하려 한다. $BD=4\\mathrm{cm}$, $\\angle DBC=36^\\circ$이다.\\n(1) 이등변삼각형이 되는 조건을 한 문장으로 서술하여라. [1점]\\n(2) (1)의 내용을 증명 없이 사용하고 $AC$의 길이를 구하는 과정을 서술하여라. [4점]",
    "choices": [],
  ...
  },
  {
    ...
    "wide": false,
    "content": "[서술형 2] 다음 그림에서 사각형 $ABCD$가 평행사변형이 되는 이유를 서술하여라. (단, 평행사변형이 되는 조건 중에서 고른다.) [각 2점]",
    "choices": [],
  ...
  },
  {
    ...
    "wide": false,
    "content": "[서술형 4] 삼산이는 다음 지도에서 학교, 은행, 병원으로부터 같은 거리에 있는 지점을 찾으려 한다.\\n(1) 삼산이가 찾는 지점은 어디인지 쓰시오. [1점]\\n(2) 그 지점에 대한 수학 용어를 쓰고, 그 지점을 찾을 때 필요한 각도, 방법과 그 수학 용어와 관련된 성질을 1가지 서술하여라. [5점, 부분점수 있음]",
    "choices": [],
