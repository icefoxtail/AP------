...
window.questionBank=[
  {
    ...
    "wide": false,
    "content": "다음 보기의 일차함수 중 그 그래프가 $x$의 값이 증가할 때, $y$의 값도 증가하는 직선인 것을 모두 고른 것은? [3점]<br><div class=\"note-box\">(ㄱ) $y=3x-1$<br>(ㄴ) $y=\\dfrac{1}{4}x+2$<br>(ㄷ) $y=-\\dfrac{2}{3}x-5$<br>(ㄹ) $y=-x+3$</div>",
    "choices": [
      "(ㄱ), (ㄴ)",
      "(ㄱ), (ㄹ)",
      "(ㄱ), (ㄷ)",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림과 같은 직선을 그래프로 하는 일차함수의 식은? [3점]",
    "choices": [
      "$y=3x+2$",
      "$y=\\dfrac{3}{2}x+3$",
      "$y=\\dfrac{2}{3}x+5$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 중 두 일차함수 $y=ax-3$과 $y=-2x+b$의 그래프가 서로 평행하기 위한 상수 $a$, $b$의 조건으로 옳은 것은? [4점]",
    "choices": [
      "$a=-2$, $b\\ne3$",
      "$a=-2$, $b\\ne-3$",
      "$a=-2$, $b=-3$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 중 두 점 $(1,-2)$, $(3,2)$를 지나는 직선을 그래프로 하는 일차함수의 식은? [4점]",
    "choices": [
      "$y=2x+4$",
      "$y=2x$",
      "$y=-2x-4$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "일차방정식 $2x+y+a=0$의 그래프를 $y$축의 방향으로 $-5$만큼 평행이동하였더니 $bx+y+4=0$의 그래프가 되었다. 이때, $y=ax+b$의 그래프의 $x$절편은? [5점]",
    "choices": [
      "$-2$",
      "$-1$",
      "$0$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "30톤의 물을 채울 수 있는 수족관에 3톤의 물이 들어 있었고 이 수족관에 물을 가득 채우기 위해 매분 0.3톤의 물을 채워 넣었다. 이 수족관에 물을 가득 채우려면 시간이 얼마나 더 걸리겠는가? [4점]",
    "choices": [
      "60분",
      "70분",
      "80분",
  ...
  },
  {
    ...
    "wide": false,
    "content": "두 자연수 $p$, $q$에 대하여 두 일차방정식 $x=p$, $y=q$의 그래프와 $x$축, $y$축으로 둘러싸인 사각형의 넓이가 $12$일 때, 다음 중 순서쌍 $(p,q)$가 될 수 없는 것은? [4점]",
    "choices": [
      "$(2,6)$",
      "$(3,4)$",
      "$(4,2)$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림에서 연립방정식 $\\begin{cases}x-y=1\\\\-3x+9y=3\\end{cases}$의 해를 나타내는 점은? [5점]",
    "choices": [
      "A",
      "B",
      "C",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 연립방정식을 각각 그래프로 나타내었을 때, 다음 중 두 그래프가 일치하는 것은? [4점]",
    "choices": [
      "$\\begin{cases}x+y=1\\\\2x+2y=6\\end{cases}$",
      "$\\begin{cases}x-y=3\\\\2x-2y=6\\end{cases}$",
      "$\\begin{cases}x-y=5\\\\2x-2y=5\\end{cases}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림과 같은 이등변삼각형 $ABC$에서 꼭지각 $\\angle A$의 이등분선과 $BC$와의 교점을 $D$라고 할 때, $BD$의 길이는? [3점]",
    "choices": [
      "$5\\,\\mathrm{cm}$",
      "$6\\,\\mathrm{cm}$",
      "$7\\,\\mathrm{cm}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림과 같이 $AB=AC$인 $\\triangle ABC$에서 점 $A$를 지나고 $BC$에 평행한 직선 $AD$를 그을 때, $\\angle DAC$의 크기는? [4점]",
    "choices": [
      "$50^\\circ$",
      "$51^\\circ$",
      "$52^\\circ$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림과 같이 $\\angle AOB$의 이등분선 위의 한 점 $P$에서 각의 두 변 $OA$, $OB$에 내린 수선의 발을 각각 $C$, $D$라고 할 때, 다음 중 옳지 않은 것은? [4점]",
    "choices": [
      "$\\angle PCO=\\angle PDO=90^\\circ$",
      "$\\angle OPC=\\angle POD$",
      "$\\triangle POC\\cong\\triangle POD$",
      "$OC=OD$",
      "$PC=PD$"
    ],
    "answer": "②",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림과 같이 $AB=AC$인 이등변삼각형 $ABC$에서 $BC$의 중점을 $M$이라고 하자. 점 $M$에서 $AB$, $AC$에 내린 수선의 발을 각각 $D$, $E$라고 할 때, $AD+AE$의 길이는? [4점]",
    "choices": [
      "$8\\,\\mathrm{cm}$",
      "$10\\,\\mathrm{cm}$",
      "$12\\,\\mathrm{cm}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림에서 점 $O$는 $\\triangle ABC$의 외심이고, $\\angle OAC=36^\\circ$, $\\angle OBC=34^\\circ$일 때, $\\angle OAB$의 크기는? [3점]",
    "choices": [
      "$20^\\circ$",
      "$21^\\circ$",
      "$22^\\circ$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림에서 $\\triangle ABC$는 $\\angle A=90^\\circ$인 직각삼각형이다. 점 $O$는 $\\triangle ABC$의 외심이고, $\\triangle AOC$의 둘레의 길이가 $18\\,\\mathrm{cm}$일 때, 외접원 $O$의 둘레의 길이는? [5점]",
    "choices": [
      "$8\\pi\\,\\mathrm{cm}$",
      "$10\\pi\\,\\mathrm{cm}$",
      "$12\\pi\\,\\mathrm{cm}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림에서 점 $I$가 $\\triangle ABC$의 내심일 때, 다음 중 옳은 것은? [4점]",
    "choices": [
      "$IA=IB=IC$",
      "$\\angle IAD=\\angle IBD$",
      "$\\triangle IDA\\cong\\triangle IDB$",
      "$\\triangle IDB\\cong\\triangle IEB$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림에서 점 $I$가 $\\triangle ABC$의 내심일 때, $\\angle x$의 크기는? [3점]",
    "choices": [
      "$25^\\circ$",
      "$30^\\circ$",
      "$35^\\circ$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림과 같은 평행사변형 $ABCD$에서 $AB=7\\,\\mathrm{cm}$, $BD=10\\,\\mathrm{cm}$, $\\angle ADC=70^\\circ$일 때, 다음 중 옳지 않은 것은? [4점]",
    "choices": [
      "$\\angle ABC=70^\\circ$",
      "$DC=7\\,\\mathrm{cm}$",
      "$\\angle BCD=110^\\circ$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 보기의 조건을 모두 만족시키는 사각형 $ABCD$는 어떤 사각형인가? [5점]<br><div class=\"note-box\">(ㄱ) $AB\\parallel CD$, $AB=CD$<br>(ㄴ) $AB=AD$<br>(ㄷ) $AC=BD$<br>(ㄹ) $AC\\perp BD$</div>",
    "choices": [
      "정사각형",
      "마름모",
      "직사각형",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림에서 $AC\\parallel DE$이고 $\\triangle ABE=17\\,\\mathrm{cm}^2$, $\\triangle ABC=8\\,\\mathrm{cm}^2$일 때, $\\triangle ACD$의 넓이는? [5점]",
    "choices": [
      "$5\\,\\mathrm{cm}^2$",
      "$6\\,\\mathrm{cm}^2$",
      "$7\\,\\mathrm{cm}^2$",
