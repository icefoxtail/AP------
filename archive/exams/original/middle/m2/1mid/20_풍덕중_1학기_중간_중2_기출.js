...
window.questionBank = [
  {
    ...
    "wide": false,
    "solution": "1단계: 순환소수에서 순환마디는 소수점 아래에서 일정하게 반복되는 부분이며, 양 끝의 숫자 위에 점을 찍어 나타낸다.\n2단계: $2.374374374\\dots$에서 소수점 아래 반복되는 구간(순환마디)은 $374$이다.\n3단계: 순환마디가 세 자리 이상일 때는 양 끝 숫자 위에만 점을 찍으므로 $2.\\dot{3}7\\dot{4}$로 표기해야 옳다.",
    "level": "중"
  },
  {
    "id": 2,
    ...
    "wide": false,
    "solution": "1단계: 기약분수로 나타내었을 때 분모의 소인수가 $2$ 또는 $5$뿐인 분수는 유한소수로 나타낼 수 있다.\n2단계: ㄱ. 분모 소인수 $2, 5$ (유한), ㄴ. $\\frac{11}{2 \\times 5^2}$ (유한), ㄷ. 분모 소인수 $7$ (무한)이다.\n3단계: ㄹ. $\\frac{21}{140} = \\frac{3}{20} = \\frac{3}{2^2 \\times 5}$ 이므로 분모 소인수가 $2, 5$뿐이다(유한). 따라서 ㄱ, ㄴ, ㄹ이다.",
    "level": "중"
  },
  {
    "id": 3,
    ...
    "wide": false,
    "solution": "1단계: 순환소수가 되려면 기약분수의 분모에 $2, 5$ 이외의 소인수가 존재해야 한다.\n2단계: $x \\in \\{1, 2, \\dots, 10\\}$ 중 $2, 5$ 이외의 소인수를 가진 후보는 $3, 6, 7, 9$이다.\n3단계: $x=7$인 경우 분자의 $7$과 약분되어 분모에 $2, 5$만 남으므로 제외된다. 따라서 가능한 $x$는 $3, 6, 9$이며 합은 $3+6+9=18$이다.",
    "level": "중"
  },
  {
    "id": 4,
    ...
    "wide": false,
    "solution": "1단계: 순환소수 $x = 0.2272727\\dots$에서 소수점 아래 부분이 일치하는 두 식을 만든다.\n2단계: $1000x = 227.2727\\dots$이고, $10x = 2.2727\\dots$이다.\n3단계: 두 식을 빼면 소수점 아래 부분이 소거되므로 $1000x - 10x$가 가장 적절하다.",
    "level": "중"
  },
  {
    "id": 5,
    ...
    "tags": ["기출","객관식","보기판단","개념판단","순환소수"],
    "wide": false,
    "solution": "1단계: 순환소수는 모두 분수 꼴로 나타낼 수 있으므로 유리수이다(① 참).\n2단계: 무한소수 중 비순환 무한소수는 유리수가 아니며(② 거짓), 모든 순환소수는 분수 표현이 가능하다(③ 거짓).\n3단계: 기약분수 중 분모에 $2, 5$ 이외의 소인수가 있으면 순환소수가 되며(④ 거짓), 정수가 아닌 유리수는 유한소수나 순환소수로 분류된다(⑤ 참).",
    "level": "중"
  },
  {
    "id": 6,
  ...
  },
  {
    ...
    "wide": false,
    "solution": "1단계: $81$을 소인수분해하면 $3^4$이므로 $81^3 = (3^4)^3 = 3^{12}$이다.\n2단계: $A = 3^3$을 이용하여 $3^{12}$을 표현하면 $(3^3)^4 = A^4$이다.\n3단계: 따라서 $\\frac{1}{81^3} = \\frac{1}{3^{12}} = \\frac{1}{A^4}$이다.",
    "level": "중"
  },
  {
    "id": 8,
    ...
    "wide": false,
    "solution": "1단계: 조건 (1)에서 $\\frac{2^5}{3^{5a}} = \\frac{2^5}{3^{20}}$이므로 $5a=20$, $a=4$이다.\n2단계: 조건 (2)에 $a=4$를 대입하면 $(\\frac{7^4}{5^2})^4 = \\frac{7^{16}}{5^8}$이므로 $c=16, b=8$이다.\n3단계: $a+b+c = 4+8+16 = 28$이다.",
    "level": "중"
  },
  {
    "id": 9,
    ...
    "tags": ["기출","객관식","보기판단","계산","식변형","식의계산"],
    "wide": false,
    "solution": "1단계: ① $4x^2 \\times (-5x^3)$의 계수를 계산하면 $4 \\times (-5) = -20$이다.\n2단계: 지수법칙에 의해 문자를 계산하면 $x^2 \\times x^3 = x^{2+3} = x^5$이다.\n3단계: 따라서 결과는 $-20x^5$이 되어야 하므로 $20x^5$로 표기된 ①번은 옳지 않다.",
    "level": "중"
  },
  {
    "id": 10,
    ...
    "wide": false,
    "solution": "1단계: 삼각형의 넓이 공식은 $넓이 = \\frac{1}{2} \\times 밑변 \\times 높이$이다.\n2단계: $50x^2y^8 = \\frac{1}{2} \\times 20x^3y \\times h$ 식을 세우면 $50x^2y^8 = 10x^3y \\times h$이다.\n3단계: $h = \\frac{50x^2y^8}{10x^3y} = 5 \\times x^{2-3} \\times y^{8-1} = 5x^{-1}y^7 = \\frac{5y^7}{x}$이다.",
    "level": "중"
  },
  {
    "id": 11,
  ...
  },
  {
    ...
    "tags": ["기출","객관식","계산","도형"],
    "wide": false,
    "solution": "1단계: 피타고라스 정리에 의해 직각삼각형에서 빗변의 길이의 제곱은 나머지 두 변의 길이의 제곱의 합과 같다.\n2단계: $x^2 = 6^2 + 8^2 = 36 + 64 = 100$이다.\n3단계: $x > 0$이므로 $x = 10$이다.",
    "level": "중"
  },
  {
    "id": 14,
    ...
    "wide": false,
    "solution": "1단계: 직각삼각형의 각 변을 한 변으로 하는 세 정사각형의 넓이 사이에는 빗변 위의 정사각형 넓이가 나머지 두 정사각형 넓이의 합과 같다는 성질이 있다.\n2단계: $(정사각형  AFGB) = (정사각형  ACDE) + (정사각형  IBHC)$이다.\n3단계: $46 = ACDE + 25$이므로 $ACDE = 46 - 25 = 21$이다. 따라서 $21cm^2$이다.",
    "level": "중"
  },
  {
    "id": 15,
    ...
    "wide": false,
    "solution": "1단계: 가장 긴 변의 길이를 $c$, 나머지 두 변의 길이를 $a, b$라 할 때 $c^2 < a^2 + b^2$이면 예각삼각형이다.\n2단계: ④번의 경우 $6^2 = 36$이고 $4^2 + 5^2 = 16 + 25 = 41$이다.\n3단계: $36 < 41$이 성립하므로 예각삼각형이다.",
    "level": "중"
  },
  {
    "id": 16,
    ...
    "tags": ["기출","객관식","계산","도형"],
    "wide": false,
    "solution": "1단계: 삼각형의 내심 $I$에 대하여 $\\angle BIC = 90^\\circ + \\frac{1}{2}\\angle A$의 관계가 성립한다.\n2단계: $110^\\circ = 90^\\circ + \\frac{1}{2}\\angle A$ 식을 세워 정리하면 $20^\\circ = \\frac{1}{2}\\angle A$이다.\n3단계: 따라서 $\\angle A = 40^\\circ$이다.",
    "level": "중"
  },
  {
    "id": 17,
  ...
  },
  {
    ...
    "wide": false,
    "solution": "1단계: $x+1 \\le 3x-9$를 정리하면 $2x \\ge 10$, 즉 $x \\ge 5$이다.\n2단계: $5x-a \\ge 4x+2$를 정리하면 $x \\ge a+2$이다.\n3단계: 두 부등식의 해가 같으므로 $a+2=5$에서 $a=3$이다.",
    "level": "중"
  },
  {
    "id": 20,
  ...
  },
  {
    ...
    "wide": false,
    "solution": "1단계: 순환소수 $0.\\dot{1}5384\\dot{6}$의 순환마디는 반복되는 구간인 $1, 5, 3, 8, 4, 6$이다.\n2단계: 순환마디의 길이는 $6$이므로 $100$을 $6$으로 나누면 $100 = 6 \\times 16 + 4$이다.\n3단계: 나머지가 $4$이므로 순환마디의 $4$번째 숫자인 $8$이 $100$번째 자리의 숫자이다.",
    "level": "중"
  },
  {
    "id": 22,
    ...
    "wide": false,
    "solution": "1단계: 잘못된 식 $A \\times 2a^2b = 16a^4b^3$에서 $A = \\frac{16a^4b^3}{2a^2b} = 8a^2b^2$이다.\n2단계: 바른 계산은 $A \\div 2a^2b$이므로 $8a^2b^2 \\div 2a^2b$를 계산한다.\n3단계: 계수는 $8 \\div 2 = 4$, 문자는 $a^2 \\div a^2 = 1, b^2 \\div b = b$이므로 최종 결과는 $4b$이다.",
    "level": "중"
  },
  {
    "id": 23,
    ...
    "wide": false,
    "solution": "1단계: 직각삼각형의 외심은 빗변의 중점이므로 외접원의 반지름 $R = \\frac{1}{2}\\overline{AB} = \\frac{20}{2} = 10cm$이다.\n2단계: $\\triangle ABC$의 넓이는 $\\frac{1}{2} \\times 16 \\times 12 = 96cm^2$이다.\n3단계: 내접원의 반지름을 $r$이라 하면 $96 = \\frac{1}{2}r(20+16+12) = 24r$에서 $r=4cm$이다.",
    "level": "중"
  },
  {
    "id": 24,
    ...
    "wide": false,
    "solution": "1단계: 세 나무를 꼭짓점으로 하는 삼각형을 가정할 때, 세 꼭짓점으로부터 같은 거리에 있는 점은 외심이다.\n2단계: 삼각형의 외심은 세 변의 수직이등분선의 교점이다.\n3단계: 따라서 세 변의 수직이등분선을 그어 만나는 점을 찾으면 보물의 위치를 알 수 있다.",
    "level": "중"
  }
];
