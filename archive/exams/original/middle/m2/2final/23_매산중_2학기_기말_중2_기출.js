window.examTitle = "23_매산중_2학기_기말_중2_기출";
...
window.questionBank = [
  {
    ...
    "wide": false,
    "content": "오른쪽 그림에서 $l\\parallel m\\parallel n$일 때, $x$의 값은? (3점)",
    "choices": [
      "$4$",
      "$5$",
      "$6$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 삼각형 $ABC$에서 세 변 $\\overline{AB}$, $\\overline{BC}$, $\\overline{AC}$의 중점을 각각 $D$, $E$, $F$라고 할 때, 다음 중 옳지 않은 것은? (4점)",
    "choices": [
      "$\\overline{AD}=\\overline{EF}=5\\,\\mathrm{cm}$",
      "$\\overline{BC}\\parallel\\overline{DF}$",
      "$\\triangle ADF\\sim\\triangle ABC$이고 닮음비는 $1:2$이다.",
      "$\\triangle DEF$의 둘레는 $15\\,\\mathrm{cm}$이다.",
      "$\\triangle ABC$의 넓이는 $\\triangle DEF$의 넓이의 $3$배이다."
    ],
    "answer": "⑤",
  ...
  },
  {
    ...
    "wide": false,
    "content": "오른쪽 그림에서 두 점 $G$, $G'$은 각각 삼각형 $ABC$, $GBC$의 무게중심이다. $\\overline{AM}=36\\,\\mathrm{cm}$일 때, $\\overline{AG'}$의 길이는? (4점)",
    "choices": [
      "$26\\,\\mathrm{cm}$",
      "$28\\,\\mathrm{cm}$",
      "$30\\,\\mathrm{cm}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림에서 두 삼각기둥 (가)와 (나)는 닮은 도형이고 (가)와 (나)의 부피는 각각 $54\\,\\mathrm{cm}^3$, $128\\,\\mathrm{cm}^3$일 때, 두 삼각기둥 (가)와 (나)의 겉넓이의 비는? (4점)",
    "choices": [
      "$3:4$",
      "$6:8$",
      "$9:16$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "오른쪽 그림에서 $\\overline{DE}=2\\,\\mathrm{cm}$일 때, $\\dfrac{y}{x}$의 값은? (4점)",
    "choices": [
      "$\\dfrac32$",
      "$2$",
      "$\\dfrac52$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 삼각형 $ABC$에서 $\\overline{BD}=\\overline{DC}$, $\\overline{AE}=\\overline{EF}=\\overline{FC}$이고 점 $P$는 $\\overline{DE}$와 $\\overline{BF}$의 교점이다. $\\triangle ABC=36\\,\\mathrm{cm}^2$일 때, 사각형 $ABPE$의 넓이는? (5점)",
    "choices": [
      "$12\\,\\mathrm{cm}^2$",
      "$15\\,\\mathrm{cm}^2$",
      "$16\\,\\mathrm{cm}^2$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "오른쪽 그림과 같은 원뿔 모양의 그릇에 일정한 속도로 물을 채우고 있다. 물을 전체 높이의 $\\dfrac13$만큼 채우는 데 $3$초가 걸렸을 때, 가득 채우려면 앞으로 몇 초가 더 걸리는가? (4점)",
    "choices": [
      "27초",
      "54초",
      "68초",
  ...
  },
  {
    ...
    "wide": false,
    "content": "삼각형의 세 변의 길이가 다음과 같을 때, 직각삼각형이 아닌 것을 모두 고른 것은? (정답 2개) (3점)",
    "choices": [
      "$3,\\ 4,\\ 5$",
      "$4,\\ 5,\\ 6$",
      "$5,\\ 6,\\ 8$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "오른쪽 그림과 같이 $\\overline{AB}=\\overline{AC}=10\\,\\mathrm{cm}$, $\\overline{BC}=12\\,\\mathrm{cm}$인 이등변삼각형 $ABC$의 넓이는? (4점)",
    "choices": [
      "$48\\,\\mathrm{cm}^2$",
      "$60\\,\\mathrm{cm}^2$",
      "$64\\,\\mathrm{cm}^2$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "오른쪽 그림과 같이 $\\angle A=90^\\circ$이고 $\\overline{BC}=12\\,\\mathrm{cm}$인 직각삼각형 $ABC$의 각 변을 지름으로 하는 세 반원 $P$, $Q$, $R$의 넓이의 합은? (4점)",
    "choices": [
      "$18\\pi\\,\\mathrm{cm}^2$",
      "$36\\pi\\,\\mathrm{cm}^2$",
      "$54\\pi\\,\\mathrm{cm}^2$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "오른쪽 그림과 같이 한 변의 길이가 $17$인 정사각형 $ABCD$에서 네 개의 직각삼각형 $ABE$, $BCF$, $CDG$, $DAH$는 모두 합동이고 $\\overline{AE}=15$일 때, 사각형 $EFGH$의 둘레는? (4점)",
    "choices": [
      "$28$",
      "$32$",
      "$36$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "오른쪽 그림은 $\\overline{AB}=12$, $\\overline{AC}=9$인 직각삼각형 $ABC$를 이용하여 피타고라스 나무를 그린 것이다. 색칠한 부분의 넓이는? (단, 세 직각삼각형은 모두 닮은 도형이다.) (4점)",
    "choices": [
      "$225$",
      "$450$",
      "$675$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "오른쪽 그림과 같이 넓이가 $36\\,\\mathrm{cm}^2$인 정사각형 $ABCD$와 넓이가 $4\\,\\mathrm{cm}^2$인 정사각형 $GCEF$를 세 점 $B$, $C$, $E$가 한 직선 위에 있도록 이어 붙였을 때, $\\overline{AH}$의 길이는? (단, 점 $H$는 $\\overline{AE}$와 $\\overline{CD}$의 교점이다.) (4점)",
    "choices": [
      "$6\\,\\mathrm{cm}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "오른쪽 그림과 같이 가로, 세로의 길이가 각각 $10\\,\\mathrm{cm}$, $8\\,\\mathrm{cm}$인 직사각형 모양의 종이를 접어서 점 $D$가 선분 $BC$와 만나는 점을 $P$라고 할 때, $\\triangle PCQ$의 넓이는? (4점)",
    "choices": [
      "$6\\,\\mathrm{cm}^2$",
      "$12\\,\\mathrm{cm}^2$",
      "$24\\,\\mathrm{cm}^2$",
  ...
  },
  {
    ...
    "tags": [],
    "wide": false,
    "content": "서로 다른 두 개의 주사위를 던질 때, 두 눈의 수의 합이 $2$ 또는 $7$이 되는 경우의 수는? (4점)",
    "choices": [
      "$6$",
      "$7$",
      "$8$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "$0$부터 $4$까지의 숫자가 각각 하나씩 적힌 $5$장의 카드가 있다. 이 중에서 $3$장의 카드를 한 장씩 차례대로 뽑아 만들 수 있는 세 자리 자연수의 개수는? (4점)",
    "choices": [
      "28개",
      "30개",
      "36개",
  ...
  },
  {
    ...
    "tags": [],
    "wide": false,
    "content": "사건 $A$가 일어날 확률을 $p$라고 할 때, 다음에서 옳지 않은 것은? (3점)",
    "choices": [
      "각 경우가 일어날 가능성이 모두 같을 때, $p$는 <span style=\"display:inline-flex;flex-direction:column;vertical-align:middle;text-align:center;line-height:1.1;\"><span style=\"display:block;border-bottom:1px solid currentColor;padding:0 2px;\">(사건 $A$가 일어나는 경우의 수)</span><span style=\"display:block;padding:0 2px;\">(일어나는 모든 경우의 수)</span></span>이다.",
      "$p$의 값의 범위는 $0\\lt p\\lt 1$이다.",
  ...
  },
  {
    ...
    "tags": [],
    "wide": false,
    "content": "서로 다른 두 개의 주사위를 동시에 던질 때, 적어도 하나는 $3$ 이상의 눈이 나올 확률은? (4점)",
    "choices": [
      "$\\dfrac19$",
      "$\\dfrac13$",
      "$\\dfrac12$",
  ...
  },
  {
    ...
    "tags": [],
    "wide": false,
    "content": "서로 다른 두 개의 주사위 $A$, $B$를 동시에 던져서 나오는 눈의 수를 각각 $a$, $b$라고 할 때, 일차방정식 $ax-b=0$의 해가 $x=1$ 또는 $x=2$일 확률은? (5점)",
    "choices": [
      "$\\dfrac29$",
      "$\\dfrac16$",
      "$\\dfrac14$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "$A$주머니에는 모양과 크기가 같은 흰 구슬 $3$개, 검정 구슬 $4$개가 들어 있고, $B$주머니에는 모양과 크기가 같은 흰 구슬 $2$개, 검은 구슬 $3$개가 들어 있다. 두 주머니에서 각각 한 개의 구슬을 꺼낼 때, 두 구슬의 색이 다를 확률은? (5점)",
    "choices": [
      "$\\dfrac5{35}$",
      "$\\dfrac7{35}$",
      "$\\dfrac{12}{35}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "[서답형 2][서술형]\n[수준별 2-①] 다음 직각삼각형에서 $x$의 값을 구하는 풀이과정과 답을 쓰시오. (4점)\n[수준별 2-②] 다음 그림과 같이 밑면의 반지름의 길이가 $6\\,\\mathrm{cm}$이고 부피가 $96\\pi\\,\\mathrm{cm}^3$인 원뿔이 있다. 원뿔의 옆넓이를 구하는 풀이과정과 답을 쓰시오. (5점)",
    "choices": [],
  ...
  },
  {
    ...
    "wide": false,
    "content": "[서답형 4][서술형]\n[수준별 4-①] 다음은 민수네 반 학생 $24$명의 혈액형을 조사하여 나타낸 표이다. 민수네 반 학생 중에서 임의로 한 명을 뽑을 때, 그 학생이 O형일 확률을 구하는 풀이과정과 답을 쓰시오. (4점)\n<table class=\"question-table\"><tr><th>혈액형</th><th>A형</th><th>B형</th><th>O형</th><th>AB형</th></tr><tr><th>학생 수 (명)</th><td>3</td><td>4</td><td>9</td><td>8</td></tr></table>\n[수준별 4-②] 다음 그림과 같은 표적에 화살을 쏠 때, 색칠한 부분을 맞힐 확률을 구하는 풀이과정과 답을 쓰시오. (단, 표적을 벗어나거나 경계선에 맞는 경우는 없다.) (5점)",
    "choices": [],
