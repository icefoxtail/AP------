...
window.questionBank = [
  {
    ...
    questionType: "객관식",
    layoutTag: "grid",
    "tags": ["객관식","제곱근","근호","표해석","참거짓","조건해석","계산","개념"],
    wide: false,
...
[결론] 따라서 옳은 것은 ③이다.`
  },
  {
    ...
    questionType: "객관식",
    layoutTag: "grid",
    "tags": ["객관식","제곱근","근호","참거짓","오류판별","조건해석","계산","개념"],
    wide: false,
...
[결론] 따라서 옳지 않은 것은 ④이다.`
  },
  {
    ...
    questionType: "객관식",
    layoutTag: "grid",
    "tags": ["객관식","제곱근","근호","무리수","유리수","순환소수","유한소수","개수세기"],
    wide: false,
...
[결론] 따라서 옳지 않은 것은 ②이다.`
  },
  {
    ...
    questionType: "객관식",
    layoutTag: "grid",
    "tags": ["객관식","제곱근","근호","무리수","유리수","분모유리화","참거짓","오류판별"],
    wide: false,
...
[결론] 따라서 정답은 ②이다.`
  },
  {
    ...
    wide: false,
    content: String.raw`$(2x+a)(3x+5)$를 전개한 식이 $6x^2+bx+10$일 때, $a+b$의 값을 구하면?`,
    choices: ["12", "14", "16", "18", "20"],
    answer: "④",
    solution: String.raw`[키포인트] 분배법칙을 이용해 식을 전개하고 각 항의 계수를 비교한다.
...
[결론] 따라서 정답은 ④이다.`
  },
  {
    ...
    wide: false,
    content: String.raw`다음 중에서 옳지 않은 것은?`,
    choices: [
    ...
    answer: "⑤",
    solution: String.raw`[키포인트] 곱셈 공식을 적용하여 전개 결과의 정확성을 확인한다.
...
[결론] 따라서 옳지 않은 것은 ⑤이다.`
  },
  {
    ...
    questionType: "객관식",
    layoutTag: "grid",
    "tags": ["객관식","제곱근","근호","다항식","인수분해","완전제곱식","계수비교","조건해석"],
    wide: false,
...
[결론] 따라서 정답은 ①이다.`
  },
  {
    ...
    "tags": ["객관식","다항식","인수분해","전개","계수비교","조건해석","계산"],
    wide: false,
    content: String.raw`$(3x-y)^2-(2x+y)(2x-y)$를 계산할 때, $x^2$의 계수를 $a$, $y^2$의 계수를 $b$라고 하자. 이때 $a+b$의 값을 구하면?`,
    choices: ["3", "4", "5", "6", "7"],
    answer: "⑤",
    solution: String.raw`[키포인트] 곱셈 공식을 이용하여 식을 전개하고 동류항을 정리한다.
...
[결론] 따라서 정답은 ⑤이다.`
  },
  {
    ...
    wide: false,
    content: String.raw`다음 중에서 $x-2$를 인수로 갖지 않는 다항식은?`,
    choices: [
      String.raw`$x^2-2x$`,
      String.raw`$x^2-4x+4$`,
      String.raw`$x^2+x-2$`,
    ...
    answer: "③",
    solution: String.raw`[키포인트] 각 식을 인수분해하여 $(x-2)$가 포함되는지 확인한다.
...
[결론] 따라서 정답은 ②이다.`
  },
  {
    ...
    questionType: "객관식",
    layoutTag: "grid",
    "tags": ["객관식","다항식","인수분해","공통인수","대입","조건해석","계산","응용"],
    wide: false,
    content: String.raw`$x+y=4$이고 $x^2y+xy^2-x-y=16$일 때, $x^2+y^2$의 값을 구하면?`,
    choices: ["2", "3", "4", "5", "6"],
    answer: "⑤",
    solution: String.raw`[키포인트] 공통인수로 묶어 인수분해한 후 곱셈 공식의 변형을 활용한다.
...
[결론] 따라서 $A+B$의 값은 $\frac{1}{5}$이다.`
  },
  {
    ...
    tags: ["서술형"],
    wide: false,
    content: String.raw`[서술형3] 한 변의 길이가 각각 $x$와 $y$인 두 정사각형이 있다. 두 정사각형의 둘레의 길이의 합은 $44$이고, 넓이의 합은 $65$이다. 다음 물음에 풀이 과정을 쓰고 답을 구하시오.
...
(3) 곱셈 공식을 이용하여 두 정사각형의 둘레의 길이의 곱을 구하시오.`,
    ...
    solution: String.raw`[키포인트] 도형의 길이와 넓이 조건을 식화하고 곱셈 공식 변형을 이용한다.
...
[결론] 따라서 구하는 값은 $448$이다.`
  },
  {
    ...
    tags: ["서술형"],
    wide: false,
    content: String.raw`[서술형4] 다음 두 다항식을 인수분해하여 공통인수를 구하고자 한다. 다음 물음에 풀이 과정을 쓰고 답을 구하시오.
다항식: $2x^2-5x-3, x^2-8x+15$
(1) 두 다항식을 각각 인수분해하여라.
(2) 두 다항식의 공통인수를 구하여라.`,
    choices: [],
    answer: String.raw`(1) $(2x+1)(x-3), (x-3)(x-5)$, (2) $x-3$`,
    solution: String.raw`[키포인트] 각 다항식을 인수분해하여 공통으로 포함된 일차식을 찾는다.
