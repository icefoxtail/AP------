...
window.questionBank = [
  ...
  },
  {
    ...
    choices: [`$P\\cap Q=\\varnothing$`, `$P\\cup Q=Q$`, `$P^C\\subset Q$`, `$Q-P=\\varnothing$`, `$P-Q=\\varnothing$`],
    answer: `①`,
  ...
  },
  {
    ...
    choices: [`$p\\Rightarrow\\sim r$`, `$r\\Rightarrow\\sim p$`, `$p\\Rightarrow\\sim s$`, `$s\\Rightarrow\\sim q$`, `$q\\Rightarrow s$`],
    answer: `⑤`,
  ...
  },
  {
    ...
    choices: [`$7!$`, `$5!\\times2!$`, `$3!\\times2!\\times2!$`, `$4!\\times3!\\times2!$`, `$3!\\times3!\\times2!\\times2!$`],
    answer: `④`,
  ...
  },
  {
    ...
    choices: [`정의역은 $\\{x\\mid x\\ge-2\\}$이다.`, `치역은 $\\{y\\mid y\\le1\\}$이다.`, `함수 $y=-\\sqrt{2x}$의 그래프를 $x$축의 방향으로 2만큼, $y$축의 방향으로 1만큼 평행이동한 것이다.`, `제1사분면을 지나지 않는다.`, `$f^{-1}(x)=\\dfrac12(x-1)^2-2$ $(x\\le1)$이다.`],
    answer: `③`,
  ...
  },
  {
    ...
    choices: [`$\\dfrac{11}{6}$`, `$-\\dfrac{11}{6}$`, `$0$`, `$\\dfrac{13}{6}$`, `$-\\dfrac{13}{6}$`],
    answer: `②`,
  ...
  },
  {
    ...
    choices: [`$3\\sqrt7$`, `$8$`, `$5\\sqrt3$`, `$4\\sqrt5$`, `$9$`],
    answer: `②`,
  ...
  },
  {
    ...
    choices: [`$\\dfrac{13}{4}$`, `$\\dfrac72$`, `$\\dfrac{15}{4}$`, `$4$`, `$\\dfrac{17}{4}$`],
    answer: `③`,
