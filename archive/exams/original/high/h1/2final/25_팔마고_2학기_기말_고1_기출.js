...
window.questionBank = [
  ...
  },
  {
    ...
    "answer": "③",
    "solution":"[키포인트] 두 그래프의 평행이동 관계를 이용해 곡선 사이의 띠를 평행사변형으로 바꾸어 넓이를 구한다.\n\n그림에서\n$P=(0,2),\\quad Q=(3,0),\\quad A=(4,4),\\quad B=(7,2)$\n이다. $y=\\sqrt{x-3}$의 그래프는 $y=\\sqrt{x}+2$의 그래프를 오른쪽으로 3, 아래쪽으로 2만큼 옮긴 것이다. 따라서 곡선 $PA$의 각 점을 같은 방향으로 옮기면 곡선 $QB$가 된다.\n\n곡선 사이의 띠에서 선분 $PQ$를 직선으로 바꾸어 생각하면 평행이동으로 잘라 붙인 도형은 평행사변형 $PABQ$와 같은 넓이를 갖는다. 이 평행사변형을 가로 7, 세로 4인 직사각형 안에 넣어 계산한다. 직사각형의 넓이는 $7\\cdot4=28$이다.\n\n직사각형에서 평행사변형 바깥에 생기는 네 직각삼각형의 넓이는 각각 $\\dfrac12\\cdot4\\cdot2=4$, $\\dfrac12\\cdot3\\cdot2=3$, $\\dfrac12\\cdot4\\cdot2=4$, $\\dfrac12\\cdot3\\cdot2=3$이다. 따라서 $[PABQ]=28-(4+3+4+3)=14$이다.\n\n그런데 실제 그림의 아래쪽 경계는 선분 $PQ$가 아니라 $P\\to O\\to Q$이다. 직각삼각형 $POQ$의 넓이는 $\\dfrac12\\cdot3\\cdot2=3$이다. 그러므로 실제 곡선으로 둘러싸인 영역의 넓이는 $14+3=17$이다.\n\n따라서 정답은 ③이다.",
    "subUnitKey": "H22-C2-09-FUNCTION_BASIC",
    "subUnit": "함수의 뜻과 그래프",
    "subUnitConfidence": "category_or_cue_inferred",
    "subUnitClassificationDepth": "complete_category"
