...
window.questionBank = [
  ...
  },
  {
    ...
    "solution":"[키포인트] 결론의 부정을 가정하고, 홀수의 제곱을 직접 나타내어 모순을 만든다.\n\n결론이 거짓이라고 가정하면 $a,b,c$가 모두 홀수이다. 그러므로 어떤 정수 $m,n,r$에 대하여\n$a=2m+1,\\quad b=2n+1,\\quad c=2r+1$\n로 나타낼 수 있다.\n\n홀수의 제곱은\n$(2m+1)^2=4m(m+1)+1$\n이다. $m$과 $m+1$ 중 하나는 짝수이므로 $4m(m+1)$은 4의 배수이다. 따라서 홀수의 제곱을 4로 나누었을 때의 나머지는 항상 1이다. 즉\n$a^2=4u+1,\\quad b^2=4v+1,\\quad c^2=4w+1$\n인 정수 $u,v,w$가 존재한다.\n\n그러면\n$a^2+b^2=4(u+v)+2$\n이고 $c^2=4w+1$이다. 첫째 식을 4로 나눈 나머지는 2이고 둘째 식을 4로 나눈 나머지는 1이므로\n$a^2+b^2=c^2$\n가 성립할 수 없다. 이는 주어진 등식과 모순이다.\n\n따라서 $a,b,c$가 모두 홀수라는 가정이 거짓이다. 그러므로 $a,b,c$ 중 적어도 하나는 짝수이다.",
    "subUnitKey": "H22-C2-06-CORE",
    "subUnit": "명제 핵심 개념",
    "subUnitConfidence": "rule_inferred",
    "subUnitClassificationDepth": "complete_rule"
