...
window.questionBank=[
  ...
  },
  {
    ...
    "solutionImage": "assets/images/22_순천여고_2학기_기말_고1_기출/q07-solution.svg",
    "solutionImageAlt": "유리함수가 네 사분면을 지나는 모습을 나타낸 해설 그래프",
    "solutionImageCaption": "k=3일 때 점근선 x=−1, y=−2를 기준으로 네 사분면 통과를 확인한다.",
  ...
  },
  {
    ...
    "solutionImage": "assets/images/22_순천여고_2학기_기말_고1_기출/q08-solution.svg",
    "solutionImageAlt": "유리함수와 직선이 만나지 않는 모습을 나타낸 해설 그래프",
    "solutionImageCaption": "k=8일 때 판별식 D=(k−1)(k−9)<0이므로 두 그래프가 만나지 않음을 확인한다.",
    "solutionImageSize": "full",
    "subUnitKey": "H15-SB-04-RATIONAL_BASIC",
    "subUnit": "유리함수의 뜻과 계산",
    "subUnitConfidence": "category_or_cue_inferred",
...
const COMPLETION = {
  ...
  9: ["④","[키포인트] 원의 중심에서 직선까지의 거리가 반지름보다 작으면 직선과 원이 두 점에서 만난다.\n조건 정리: 지름의 양 끝점은 $(0,4)$, $(2,0)$이다.\n풀이 방향: 원의 중심과 반지름을 구한 뒤 점과 직선 사이의 거리 조건을 적용한다.\n정석 풀이: 중심은 두 점의 중점인 $(1,2)$이고 반지름은 $\\sqrt5$이다. 직선 ,x-y+k=0$과 중심 사이의 거리는 $\\dfrac{|2-2+k|}{\\sqrt{2^2+(-1)^2}}=\\dfrac{|k|}{\\sqrt5}$이다. 두 점에서 만나려면 $\\dfrac{|k|}{\\sqrt5}\\lt\\sqrt5$, 즉 $|k|\\lt5$여야 한다. 가능한 정수는 $-4,-3,\\ldots,4$의 9개이다.\n\n계산/도식 확인: |k|=5이면 중심에서 직선까지의 거리가 반지름과 같아 한 점에서 접하고, |k|<5일 때만 두 점에서 만난다. 따라서 끝점을 제외한 −5<k<5의 정수 −4부터 4까지 모두 9개이다.\n따라서 정답은 ④이다."],
...
for (const question of window.questionBank) {
  ...
  question.wide = false;
  if (question.standardUnitKey !== "H15-SA-11") {
