...
window.questionBank = [
  ...
  },
  {
    ...
    "answer": "③",
    "solution": "[키포인트] 식을 전개한 뒤 서로 곱이 일정한 두 양수에 산술평균과 기하평균의 관계를 적용한다.\n조건 정리: $a,b$가 양수이므로 $\\frac{4a}{b}$와 $\\frac{b}{a}$도 양수이다.\n식 정리: $(2a+b)(\\frac1a+\\frac2b)=4+\\frac{4a}{b}+\\frac{b}{a}$이다.\n부등식 적용: 산술평균과 기하평균의 관계에 따라 $\\frac{4a}{b}+\\frac{b}{a}\\ge2\\sqrt{4}=4$이므로 전체 식은 $8$ 이상이다.\n등호 조건 확인: $\\frac{4a}{b}=\\frac{b}{a}$, 즉 $b=2a$일 때 등호가 성립한다.\n따라서 최솟값은 $8$이고, 정답은 ③이다.",
  ...
  },
  {
    ...
    "solutionImage": "assets/images/22_매산고_2학기_중간_고1_기출/q06-solution.svg",
    "solutionImageAlt": "U={1,…,10}, A={2,4,6}, B={1,3,5,7,9}에서 X에 고정되는 원소와 자유 원소 {8,10}을 구분한 표",
    "solutionImageCaption": "X∪A=X와 X−B=X에서 반드시 포함·제외되는 원소와 2²=4개의 X를 표시한 상태표",
  ...
  },
  {
    ...
    "answer": "⑤",
    "solution": "[키포인트] 그래프에서 $1$의 반복함수값이 이루는 주기를 찾는다.\n조건 정리: 그래프에서 $f(1)=2$, $f(2)=3$, $f(3)=1$이다.\n풀이 방향: $1\\to2\\to3\\to1$의 길이 $3$인 주기를 확인하고, 반복 횟수를 $3$의 묶음으로 나눈 나머지를 이용한다.\n정석 풀이: $104=3\\times34+2$이므로 $f^{104}(1)=f^2(1)=3$이다. $203=3\\times67+2$이므로 $f^{203}(1)=f^2(1)=3$이고, $301=3\\times100+1$이므로 $f^{301}(1)=f(1)=2$이다. 따라서 합은 $3+3+2=8$이다.\n따라서 정답은 ⑤이다.",
    "image": "assets/images/22_매산고_2학기_중간_고1_기출/q09.png",
    "imageSize": "large",
    "solutionImage": "assets/images/22_매산고_2학기_중간_고1_기출/q09.png",
    "solutionImageAlt": "함수 f의 반복주기를 읽는 원본 그래프",
    "solutionImageCaption": "f(1)=2, f(2)=3, f(3)=1의 3주기 대응을 읽는다.",
  ...
  },
  {
    ...
    "choices": [],
    "answer": "$41$",
    "solution": "[키포인트] $a(n-a)$는 a와 n-a를 바꾸어도 같으므로 입력을 합이 n인 쌍으로 묶는다.\n$a(n-a)=b(n-b)$에서 $(a-b)(n-a-b)=0$이므로 서로 다른 입력이 겹치려면 $a+b=n$이다. $n=21$이면 1부터 20까지가 $(1,20),(2,19),\\ldots,(10,11)$의 10쌍으로 모두 묶여 중복이 최대가 된다. 따라서 $k=21$이다.\n$B_{21}$의 최솟값은 $1\\cdot20=20$이므로 $\\alpha=20$이고 $k+\\alpha=41$이다.\n[시각자료 읽기] 그림의 열 쌍은 합이 21인 두 입력이 같은 출력값을 만든다는 뜻이다. 열 쌍이 10개이므로 |B₂₁|=10이고 가장 작은 출력은 1×20=20이다.",
    "solutionImage": "assets/images/22_매산고_2학기_중간_고1_기출/q17-solution.svg",
    "solutionImageAlt": "A={1,…,20}에서 n=21일 때 (1,20)부터 (10,11)까지의 실제 10쌍과 각 출력값을 모두 표시한 도식",
    "solutionImageCaption": "a(21−a)의 중복쌍 10개, 최솟값 α=20, k=21, k+α=41을 함께 표시한 문항 전용 도식",
    "solutionImageSize": "full",
    "subUnitKey": "H15-SB-01-SET_BASIC",
    "subUnit": "집합의 뜻과 표현",
    "subUnitConfidence": "category_or_cue_inferred",
  ...
  },
  {
    ...
    "solutionImage": "assets/images/22_매산고_2학기_중간_고1_기출/q19-solution.svg",
    "solutionImageAlt": "200명에서 합집합 140명, 바깥 60명, 교집합 t에 따라 제주도만 85−t/2명이 되는 Venn diagram",
    "solutionImageCaption": "t=0에서 제주도만 85명, t=110에서 30명이 되어 최댓값과 최솟값의 합 115를 얻는 인원 배치",
    "solutionImageSize": "full",
    "subUnitKey": "H15-SB-01-SET_OPERATION",
    "subUnit": "집합의 연산",
    "subUnitConfidence": "category_or_cue_inferred",
  ...
  },
  {
    ...
    "imageSize": "large",
    "solutionImage": "assets/images/22_매산고_2학기_중간_고1_기출/q20.png",
    "solutionImageAlt": "정육각형 위를 움직이는 점 P와 삼각형 PFA의 원본 그림",
    "solutionImageCaption": "점 P의 이동거리 x에 따른 삼각형 높이와 합성함수 구간을 확인한다.",
    "solutionImageSize": "large",
    "subUnitKey": "H15-SB-03-COMPOSITE_FUNCTION",
    "subUnit": "합성함수",
    "subUnitConfidence": "rule_inferred",
