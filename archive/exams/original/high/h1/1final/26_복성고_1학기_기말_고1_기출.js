...
window.questionBank = [
  ...
  },
  {
    ...
    "wide": false,
    "content": "이차부등식 $x^2+2(3-k)x+11\\le0$에 대한 설명으로 옳은 것만을 보기에서 있는 대로 고른 것은? [4.2점]<br><div class='note-box'>(가) $k=9$일 때, 이차부등식의 해는 $1\\le x\\le11$이다.<br>(나) 이차부등식의 해가 존재하도록 하는 $k$값의 범위는 $k\\lt3-\\sqrt{11}$ 또는 $k\\gt3+\\sqrt{11}$이다.<br>(다) 이차부등식의 해가 존재하지 않도록 하는 모든 정수 $k$값의 합은 21이다.</div>",
    "choices": [
      "(가)",
      "(나)",
      "(나),(다)",
  ...
  },
  {
    ...
    "wide": false,
    "content": "1부터 $n$($n\\ge8$)까지의 자연수 중에서 서로 다른 5개의 수를 뽑으려고 한다. 뽑은 5개의 수를 작은 것부터 크기 순서대로 나열했을 때, 3번째에 놓이는 수가 6인 경우의 수가 200 이상이 되도록 하는 자연수 $n$의 최솟값을 풀이과정과 함께 구하시오. [5점, 부분점수 있음]",
    "choices": [],
    "answer": "$13$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "$x$에 대한 연립부등식 $\\begin{cases}|x-k|\\lt3\\\\x^2-3x-4\\le0\\end{cases}$을 만족시키는 정수 $x$가 존재할 때, 이 연립부등식을 만족시키는 모든 정수 $x$값의 합을 $p$라고 하자. $p=10$이 되도록 하는 모든 정수 $k$값의 합을 풀이과정과 함께 구하시오. [7점, 부분점수 있음]",
    "choices": [],
    "answer": "$5$",
