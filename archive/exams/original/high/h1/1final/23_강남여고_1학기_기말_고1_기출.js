...
window.questionBank = [
  ...
  },
  {
    ...
    "answer": "②",
    "solution": "[키포인트] 원이 직선에 접하면 원의 중심에서 직선까지의 거리가 반지름이다.\n원의 중심은 원점 $O(0,0)$이다.\n직선 $3x-y-10=0$까지의 거리는\n$\\dfrac{|3\\cdot0-0-10|}{\\sqrt{3^2+(-1)^2}}=\\dfrac{10}{\\sqrt{10}}=\\sqrt{10}$이다.\n[보강] 직선의 법선 방향은 $(3,-1)$이므로 원점에서 직선에 내린 수선의 발은 $H(3,-1)$이다. 실제로 $3\\cdot3-(-1)-10=0$이므로 $H$는 직선 위에 있고, $OH=\\sqrt{3^2+(-1)^2}=\\sqrt{10}$이다. 원과 직선이 접한다는 것은 이 수선의 길이 $OH$가 반지름 $r$과 같다는 뜻이다.\n따라서 반지름 $r=\\sqrt{10}$이다.\n따라서 정답은 ②이다.",
    "solutionImage": "assets/images/23_강남여고_1학기_기말_고1_기출/q06-solution.svg",
    "solutionImageAlt": "중심 O(0,0)의 원과 직선 3x−y−10=0이 접하고, 수선의 발 H(3,−1)까지의 거리 OH가 반지름 √10임을 나타낸 좌표평면",
    "solutionImageCaption": "원과 직선이 접하면 중심에서 직선까지의 수선의 길이가 반지름입니다.",
  ...
  },
  {
    ...
    "questionType": "객관식",
    "layoutTag": "grid",
    "tags": ["객관식","원의 방정식","원과 직선","위치 관계","도형"],
    "wide": false,
    ...
    "answer": "⑤",
    "solution": "[키포인트] 원과 직선이 만나지 않으려면 원의 중심에서 직선까지의 거리가 반지름보다 커야 한다.\n원 $x^2+y^2=2$의 중심은 $(0,0)$이고 반지름은 $\\sqrt2$이다.\n직선 $y=-x+k$를 정리하면 $x+y-k=0$이다.\n원점에서 이 직선까지의 거리는 $\\dfrac{|k|}{\\sqrt{1^2+1^2}}=\\dfrac{|k|}{\\sqrt2}$이다.\n만나지 않으려면\n$\\dfrac{|k|}{\\sqrt2}>\\sqrt2$이어야 하므로 $|k|>2$이다.\n[보강] 경계값 $|k|=2$에서는 중심에서 직선까지의 거리가 반지름과 같아 직선이 원에 접한다. 따라서 이 경계는 포함되지 않고, 직선이 원에서 완전히 떨어지는 두 바깥쪽 경우 $|k|>2$만 남는다.\n따라서 $k<-2$ 또는 $k>2$이다.\n따라서 정답은 ⑤이다.",
    "solutionImage": "assets/images/23_강남여고_1학기_기말_고1_기출/q14-solution.svg",
    "solutionImageAlt": "중심 O(0,0), 반지름 √2인 원과 경계 직선 x+y=2, x+y=−2가 접하는 모습을 통해 교점 없음의 조건 |k|>2를 나타낸 좌표평면",
    "solutionImageCaption": "|k|=2는 접하는 경계이고, 교점이 없으려면 그 바깥쪽 평행선이어야 합니다.",
    "solutionImageSize": "full",
  ...
  },
  {
    ...
    "answer": "②",
    "solution": "[키포인트] 외부의 한 점에서 원에 그은 접선의 길이는 중심까지의 거리와 반지름으로 이루어진 직각삼각형에서 구한다.\n원의 방정식을 정리하면\n$x^2-2x+y^2+4y=0$,\n$(x-1)^2+(y+2)^2=5$이다.\n따라서 중심은 $C(1,-2)$, 반지름은 $\\sqrt5$이다.\n점 $A(-2,2)$와 중심 $C(1,-2)$ 사이의 거리는\n$AC=\\sqrt{(1+2)^2+(-2-2)^2}=\\sqrt{3^2+(-4)^2}=5$이다.\n접점을 $T$라 하면 $T$는 원 위의 점이므로 $CT=\\sqrt5$이고, 원의 중심과 접점을 이은 반지름은 그 점에서 접선에 수직이다. 따라서 $CT\\perp AT$이고, 삼각형 $ACT$는 $T$에서 직각인 직각삼각형이다.\n$AT^2=AC^2-CT^2=5^2-(\\sqrt5)^2=25-5=20$이다.\n따라서 $AT=2\\sqrt5$이다.\n따라서 정답은 ②이다.",
    "solutionImage": "assets/images/23_강남여고_1학기_기말_고1_기출/q15-solution.svg",
    "solutionImageAlt": "중심 C(1,−2), 반지름 √5인 원에 외부점 A(−2,2)에서 접선 AT를 그어 CT와 AT가 수직인 직각삼각형을 나타낸 그림",
    "solutionImageCaption": "접점에서는 반지름과 접선이 수직이므로 피타고라스 정리를 적용할 수 있습니다.",
    "solutionImageSize": "full",
    "subUnitKey": "H15-SA-11-TANGENT",
    "subUnit": "원과 접선",
    "subUnitConfidence": "category_or_cue_inferred",
  ...
  },
  {
    ...
    "solutionImage": "assets/images/23_강남여고_1학기_기말_고1_기출/q16-solution.svg",
  ...
  },
  {
    ...
    "answer": "⑤",
    "solution": "직사각형을 좌표평면에 놓아 $A=(0,10)$, $D=(6,10)$, $B=(0,0)$, $C=(6,0)$으로 두자. 출발점 $S$는 $AD$의 중점이므로 $S=(3,10)$이다.\n\n$CD=AB=10$이고 $CT:TD=1:4$이므로 $CT=2$이다. 따라서 도착점은 $T=(6,2)$이다.\n\n경로가 $AB$, $BC$를 차례로 지나므로 두 변을 차례로 펼친다. $AB$를 기준으로 반사하면 $T$는 $T_1=(-6,2)$로 옮겨지고, 이어서 $BC$를 기준으로 반사하면 $T_1$은 $T_2=(-6,-2)$로 옮겨진다. 반사는 거리를 보존하므로 원래의 꺾인 경로는 펼친 그림에서 $S$와 $T_2$를 잇는 꺾인 경로와 길이가 같다.\n\n따라서 삼각부등식에 의해 최단 경로는 $S$와 $T_2$를 잇는 선분이다. 이 선분은 $x=0$과 만나는 점의 $y$좌표가 $6$이므로 $AB$를 통과하고, $y=0$과 만나는 점의 $x$좌표가 $-\\dfrac92$이므로 펼쳐진 뒤의 $BC$도 통과한다. 따라서 주어진 통과 순서를 만족한다.\n\n두 점의 가로 차이와 세로 차이는 각각 $|3-(-6)|=9$, $|10-(-2)|=12$이므로 최단거리는\n$\\sqrt{9^2+12^2}=\\sqrt{225}=15$이다.\n\n따라서 정답은 ⑤이다.",
    "solutionImage": "assets/images/23_강남여고_1학기_기말_고1_기출/q17-solution.svg",
  ...
  },
  {
    ...
    "solutionImage": "assets/images/23_강남여고_1학기_기말_고1_기출/q20-solution.svg",
  ...
  },
  {
    ...
    "questionType": "객관식",
    "layoutTag": "grid",
    "tags": ["객관식","원의 방정식","삼각형","외접원","최댓값","도형"],
    "wide": false,
    ...
    "answer": "④",
    "solution": "[키포인트] 같은 현 $AB$를 보는 원주각이 $45^\\circ$이면, 중심각은 $90^\\circ$이므로 원의 반지름을 구할 수 있다.\n두 점 $A(-1,-9)$, $B(5,3)$ 사이의 거리는\n$AB=\\sqrt{(5+1)^2+(3+9)^2}=\\sqrt{6^2+12^2}=6\\sqrt5$이다.\n원주각 $\\angle APB=45^\\circ$에 대응하는 중심각 $\\angle ACB$는 $90^\\circ$이다.\n따라서 직각이등변삼각형 $ACB$에서 $AB=\\sqrt2\\,R$이므로\n$R=\\dfrac{6\\sqrt5}{\\sqrt2}=3\\sqrt{10}$이다.\n중심 $C$는 선분 $AB$의 수직이등분선 위에 있다.\n선분 $AB$의 중점은 $M(2,-3)$이고, $CM^2=R^2-\\left(\\dfrac{AB}{2}\\right)^2=90-45=45$이다.\n[보강] $AB$의 기울기는 $\\dfrac{3-(-9)}{5-(-1)}=2$이므로 수직이등분선의 기울기는 $-\\dfrac12$이다. 중점 $M(2,-3)$을 지나므로 수직이등분선은 $y=-\\dfrac12x-2$이다. 중심을 $C(x,y)$라 두면 $CM^2=(x-2)^2+(y+3)^2=45$이고, $y+3=-\\dfrac12(x-2)$이므로 $\\dfrac54(x-2)^2=45$이다. 따라서 $x-2=\\pm6$이고, 수직이등분선에 대입하면 $C=(-4,0)$ 또는 $(8,-6)$이다.\n원점과의 거리는 각각 $4$, $10$이므로 최댓값은 $10$이다.\n따라서 정답은 ④이다.",
    "solutionImage": "assets/images/23_강남여고_1학기_기말_고1_기출/q21-solution.svg",
    "solutionImageAlt": "현 AB의 중점 M과 수직이등분선 위의 두 가능한 원의 중심 C₁(−4,0), C₂(8,−6), 원점 O를 나타낸 좌표평면",
    "solutionImageCaption": "두 중심 후보 중 원점에서 더 먼 C₂까지의 거리가 최댓값입니다.",
    "solutionImageSize": "full",
  ...
  },
  {
    ...
    "solutionImageAlt": "직선의 방정식 문항 24의 독립 풀이 사실 기반 해설 도형",
    "solutionImageCaption": "독립 풀이에서 확정한 점·도형·관계를 좌표평면에 표시한 해설 자료",
    "solutionImageSize": "full",
  ...
  },
  {
    ...
    "solutionImage": "assets/images/23_강남여고_1학기_기말_고1_기출/q25-solution.svg",
    "solutionImageAlt": "평면좌표 문항 25의 독립 풀이 사실 기반 해설 도형",
    "solutionImageCaption": "독립 풀이에서 확정한 점·도형·관계를 좌표평면에 표시한 해설 자료",
    "solutionImageSize": "full",
