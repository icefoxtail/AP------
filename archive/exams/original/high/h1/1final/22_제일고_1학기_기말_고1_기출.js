...
window.questionBank = [
  ...
  },
  {
    ...
    "solutionImage": "assets/images/22_제일고_1학기_기말_고1_기출/q05-solution.svg",
  ...
  },
  {
    ...
    "solutionImage": "assets/images/22_제일고_1학기_기말_고1_기출/q06-solution.svg",
    "solutionImageAlt": "평면좌표 문항 6의 핵심 관계를 표시한 해설 도형",
    "solutionImageCaption": "풀이에 필요한 점·도형·관계를 좌표평면에 표시한 해설 자료",
    "solutionImageSize": "full",
  ...
  },
  {
    ...
    "answer": "③",
    "solution": "[키포인트] 점의 실제 순서와 거리 관계를 먼저 정리한 뒤, 내분점은 좌표 또는 수직선의 위치로 구한다.\n\n계산을 쉽게 하기 위해 수직선 위에서 $A=0$, $B=12$라고 두자.\n$P$는 선분 $AB$ 안에 있고 $AP:PB=1:3$이므로\n$AP=12\\times\\dfrac{1}{1+3}=3$이다. 따라서 $P$의 위치는 $3$이다.\n\n점 $Q$는 선분 밖에서 $A$ 쪽에 있으므로 점의 순서는\n$Q\\text{ — }A\\text{ — }P\\text{ — }B$\n이다. $AQ=x$라 두면 $QB=x+12$이고, 문제의 비에 따라\n$AQ:QB=1:3$이다. 따라서\n$x:(x+12)=1:3$\n$3x=x+12$\n$x=6$이다. 그러므로 $Q$의 위치는 $-6$이다.\n\n이제 점의 순서에 따라 $PQ=PA+AQ=3+6=9$이다.\n따라서 정답은 ③이다.",
    "solutionImage": "assets/images/22_제일고_1학기_기말_고1_기출/q07-solution.svg",
    "solutionImageAlt": "수직선 위에서 Q-A-P-B의 실제 순서와 AP:PB=1:3, AQ:QB=1:3을 표시한 그림",
    "solutionImageCaption": "선분 안의 내분점 P와 선분 밖의 점 Q를 점의 순서와 거리 관계로 확인한다.",
    "solutionImageSize": "full",
    "subUnitKey": "H22-C2-01-COORDINATE_METRIC",
    "subUnit": "평면좌표와 거리",
    "subUnitConfidence": "category_or_cue_inferred",
  ...
  },
  {
    ...
    "answer": "①",
    "solution": "[키포인트] 선분 밖의 점은 실제 점의 순서와 거리 관계를 먼저 세우고, 각 좌표의 변화량을 따로 계산한다.\n\n$A(a,3)$, $B(-2,6)$, $C(6,b)$라 하자.\n$AB$에서 점 $D$는 $B$ 쪽 바깥에 있으므로 순서는 $A\\text{ — }B\\text{ — }D$이다. $AB$의 x좌표 변화량은 $-2-a$, y좌표 변화량은 $3$이다. 점의 순서 $A-B-D$에서 문제의 3:1 거리비는 $AD:BD=3:1$이다. $AB=AD-BD=2BD$이므로 $BD=AB/2$이다. 따라서 $B$에서 같은 방향으로 그 변화량의 절반만큼 더 가면 $D$이므로\n$x_D=-2+\\dfrac{-2-a}{2}=\\dfrac{-6-a}{2}$,\n$y_D=6+\\dfrac{3}{2}=\\dfrac{15}{2}$이다.\n\n$BC$에서 점 $E$는 $C$ 쪽 바깥에 있으므로 순서는 $B\\text{ — }C\\text{ — }E$이다. $BC$의 x좌표 변화량은 $8$, y좌표 변화량은 $b-6$이다. 따라서\n$x_E=6+\\dfrac{8}{2}=10$,\n$y_E=b+\\dfrac{b-6}{2}=\\dfrac{3b-6}{2}$이다.\n\n$AC$에서 점 $F$는 $C$ 쪽 바깥에 있으므로 순서는 $A\\text{ — }C\\text{ — }F$이다. $AC$의 x좌표 변화량은 $6-a$, y좌표 변화량은 $b-3$이다. 따라서\n$x_F=6+\\dfrac{6-a}{2}=\\dfrac{18-a}{2}$,\n$y_F=b+\\dfrac{b-3}{2}=\\dfrac{3b-3}{2}$이다.\n\n$D,E,F$의 무게중심이 $(2,6)$이므로 x좌표를 따로 평균 내면\n$\\dfrac{\\frac{-6-a}{2}+10+\\frac{18-a}{2}}{3}=2$\n$\\dfrac{16-a}{3}=2$\n$a=10$이다. y좌표를 따로 평균 내면\n$\\dfrac{\\frac{15}{2}+\\frac{3b-6}{2}+\\frac{3b-3}{2}}{3}=6$\n$\\dfrac{3+3b}{3}=6$\n$b=5$이다.\n따라서 $a+b=10+5=15$이므로 정답은 ①이다.",
    "solutionImage": "assets/images/22_제일고_1학기_기말_고1_기출/q08-solution.svg",
    "solutionImageAlt": "삼각형의 세 변 밖에 놓인 D, E, F의 실제 순서와 좌표별 변화를 표시한 그림",
    "solutionImageCaption": "A-B-D, B-C-E, A-C-F의 점 순서와 각 좌표 변화량으로 세 점의 위치를 확인한다.",
    "solutionImageSize": "full",
    "subUnitKey": "H22-C2-01-COORDINATE_METRIC",
    "subUnit": "평면좌표와 거리",
    "subUnitConfidence": "category_or_cue_inferred",
  ...
  },
  {
    ...
    "solutionImage": "assets/images/22_제일고_1학기_기말_고1_기출/q09-solution.svg",
  ...
  },
  {
    ...
    "answer": "②",
    "solution": "[키포인트] 완전제곱식으로 바꾸어 원의 중심과 반지름을 찾는다.\n\n$x^2+y^2-8x+6y-24=0$에서 $x$, $y$끼리 모아 정리하면\n$x^2-8x+y^2+6y=24$이다.\n완전제곱식을 만들면\n$(x-4)^2-16+(y+3)^2-9=24$\n$(x-4)^2+(y+3)^2=49$이다.\n따라서 중심은 $(4,-3)$, 반지름은 $7$이다.\n$a=4$, $b=-3$, $r=7$이므로\n$a+b+r=4-3+7=8$이다.\n\n계산/도식 확인: 표준형 $(x-4)^2+(y+3)^2=7^2$에서 중심은 $(4,-3)$, 반지름은 $7$이다. 그림처럼 $a+b+r$에는 중심의 두 좌표와 반지름을 각각 부호까지 정확히 대입한다.\n따라서 정답은 ②이다.",
    "solutionImage": "assets/images/22_제일고_1학기_기말_고1_기출/q13-solution.svg",
    "solutionImageAlt": "표준형 (x−4)²+(y+3)²=49의 중심 (4,−3)과 반지름 7을 표시한 그림",
  ...
  },
  {
    ...
    "answer": "④",
    "solution": "[키포인트] 원이 두 좌표축에 동시에 접하면 중심에서 두 축까지의 거리가 모두 반지름과 같다.\n\n두 축에 동시에 접하는 원의 중심을 $(a,a)$, 반지름을 $|a|$라고 둘 수 있다.\n이 원이 점 $(2,4)$를 지나므로\n$(2-a)^2+(4-a)^2=a^2$이다.\n전개하면\n$a^2-4a+4+a^2-8a+16=a^2$\n$a^2-12a+20=0$\n$(a-2)(a-10)=0$이다.\n따라서 $a=2$ 또는 $a=10$이다.\n반지름은 각각 $2$, $10$이므로 두 원의 둘레의 합은\n$2\\pi\\cdot2+2\\pi\\cdot10=4\\pi+20\\pi=24\\pi$이다.\n\n계산/도식 확인: 두 축에 동시에 접하는 원의 중심은 부호까지 고려하면 $(r,r),(r,-r),(-r,r),(-r,-r)$ 중 하나이다. 점 $(2,4)$를 대입하면 다른 세 경우는 각각 $r^2+4r+20=0$, $r^2-4r+20=0$, $r^2+12r+20=0$이 되어 양의 $r$를 주지 않는다. 따라서 제1사분면 중심 $(r,r)$만 남고, $(2-r)^2+(4-r)^2=r^2$에서 $r=2,10$을 얻는다.\n따라서 정답은 ④이다.",
    "solutionImage": "assets/images/22_제일고_1학기_기말_고1_기출/q14-solution.svg",
    "solutionImageAlt": "점 (2,4)를 지나는 두 축 접선 원의 중심 (2,2), (10,10)을 표시한 그림",
    "solutionImageCaption": "축 접하는 원의 사분면 경우를 확인한 뒤 두 반지름의 둘레를 더한다.",
    "solutionImageSize": "full",
  ...
  },
  {
    ...
    "questionType": "단답형",
    "layoutTag": "grid",
    "tags": ["서술형","원의 방정식","좌표축 접원","중심","반지름","거리","도형"],
    "wide": false,
  ...
  },
  {
    ...
    "choices": [],
    "answer": "$10$",
    "solution": "[키포인트] 점의 실제 순서와 거리 관계를 먼저 정리한 뒤, 좌표의 변화를 이용해 자취의 원을 구한다.\n\n문제의 비 조건에서 점의 순서는 $A-P-Q$이다. 따라서 한 직선 위에서\n$AQ=AP+PQ$이고, $AQ:PQ=3:2$이다. 그러므로\n$PQ=2AP$, $AQ=3AP$이다.\n\n점 $P$의 좌표를 $(u,v)$, 점 $Q$의 좌표를 $(x,y)$라고 하자. $A=(-2,0)$에서 $P$까지의 x좌표 변화량은 $u+2$, y좌표 변화량은 $v$이다. $A$에서 $Q$까지의 거리가 $3$배이고 같은 방향으로 움직이므로 좌표 변화량도 각각 $3$배이다. 따라서\n$x+2=3(u+2)$, $y=3v$이다.\n즉\n$u=\\dfrac{x-4}{3}$, $v=\\dfrac y3$이다.\n\n점 $P(u,v)$는 원 $x^2+y^2-2x=0$, 즉\n$(u-1)^2+v^2=1$\n위에 있다. 여기에 $u=\\dfrac{x-4}{3}$, $v=\\dfrac y3$을 대입하면\n$\\left(\\dfrac{x-4}{3}\\right)^2+\\left(\\dfrac y3\\right)^2-2\\left(\\dfrac{x-4}{3}\\right)=0$이다.\n양변에 $9$를 곱하면\n$(x-4)^2+y^2-6(x-4)=0$이다.\n전개하여 정리하면\n$x^2+y^2-14x+40=0$이고, 완전제곱식으로 바꾸면\n$(x-7)^2+y^2=9$이다.\n\n따라서 자취의 중심은 $(7,0)$, 반지름은 $3$이므로\n$a=7$, $b=0$, $r=3$이다.\n그러므로 $a+b+r=7+0+3=10$이다.",
    "solutionImage": "assets/images/22_제일고_1학기_기말_고1_기출/q21-solution.svg",
    "solutionImageAlt": "A-P-Q의 실제 순서와 거리 관계, 그리고 P와 Q의 원형 자취를 표시한 그림",
    "solutionImageCaption": "점의 순서 A-P-Q와 AQ=3AP에 따른 좌표 변화로 두 원의 관계를 확인한다.",
    "solutionImageSize": "full",
    "subUnitKey": "H22-C2-03-CIRCLE_EQUATION",
    "subUnit": "원의 방정식",
    "subUnitConfidence": "category_or_cue_inferred",
