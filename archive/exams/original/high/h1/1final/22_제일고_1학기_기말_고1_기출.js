...
window.questionBank = [
  ...
  },
  {
    ...
    "solutionImageAlt": "평면좌표 문항 6의 독립 풀이 사실 기반 해설 도형",
    "solutionImageCaption": "독립 풀이에서 확정한 점·도형·관계를 좌표평면에 표시한 해설 자료",
    "solutionImageSize": "full",
  ...
  },
  {
    ...
    "answer": "④",
    "solution": "[키포인트] 원이 두 좌표축에 동시에 접하면 중심에서 두 축까지의 거리가 모두 반지름과 같다.\\n\\n두 축에 동시에 접하는 원의 중심을 $(a,a)$, 반지름을 $|a|$라고 둘 수 있다.\\n이 원이 점 $(2,4)$를 지나므로\\n$(2-a)^2+(4-a)^2=a^2$이다.\\n전개하면\\n$a^2-4a+4+a^2-8a+16=a^2$\\n$a^2-12a+20=0$\\n$(a-2)(a-10)=0$이다.\\n따라서 $a=2$ 또는 $a=10$이다.\\n반지름은 각각 $2$, $10$이므로 두 원의 둘레의 합은\\n$2\\pi\\cdot2+2\\pi\\cdot10=4\\pi+20\\pi=24\\pi$이다.\\n따라서 정답은 ④이다.\n[보강] 두 축에 동시에 접하는 원의 중심은 부호까지 고려하면 $(r,r),(r,-r),(-r,r),(-r,-r)$ 중 하나이다. 점 $(2,4)$를 대입하면 다른 세 경우는 각각 $r^2+4r+20=0$, $r^2-4r+20=0$, $r^2+12r+20=0$이 되어 양의 $r$를 주지 않는다. 따라서 제1사분면 중심 $(r,r)$만 남고, $(2-r)^2+(4-r)^2=r^2$에서 $r=2,10$을 얻는다.",
