...
window.questionBank = [
  ...
  },
  {
    ...
    "wide": false,
    "content": "부등식 $|x+1|+|x-2|\\le5$의 해와 이차부등식 $ax^2+bx+c\\le0$의 해가 같을 때, $\\dfrac{bc}{a^2}$의 값은? (단, $a,b,c$는 상수이다.) [4.5점]",
    "choices": [
      "$-6$",
      "$-4$",
      "$2$",
