...
window.questionBank = [
  ...
  },
  {
    ...
    "wide": false,
    "content": "서답형 6.(서술형)<br>최고차항의 계수가 1인 다항식 $f(x)$가 다음 두 조건을 만족시킨다.<div class='note-box'>(가) 다항식 $f(x)$를 다항식 $g(x)$로 나눈 몫과 나머지는 모두 $g(x)+x^2$이다.<br>(나) 방정식 $f(x)=0$은 서로 다른 세 정수근 $3,\\alpha,\\beta$를 가진다.</div>$\\alpha,\\beta$의 값을 구하는 과정과 정답을 서술하시오. (단, $\\alpha\\gt\\beta$) [7점]",
    "choices": [],
  ...
  },
  {
    ...
    "wide": false,
    "content": "서답형 7.(서술형)<br>서로 다른 종류의 음료 3개와 같은 종류의 빵 2개를 4명의 학생에게 나누어 주려고 한다. 아무것도 받지 못하는 학생이 없도록 음료와 빵을 나누어 주는 경우의 수를 구하려고 할 때, 다음 물음의 조건에 따른 경우의 수를 구하는 과정과 정답을 서술하시오. [총 7점, 부분점수 있음]<div class='note-box'>(1) 1명의 학생이 빵을 2개 받는 경우 [2점]<br>(2) 1명의 학생이 음료 1개와 빵 1개를 받는 경우 [2점]<br>(3) 1명의 학생이 음료 2개를 받는 경우 [3점]</div>",
    "choices": [],
    "answer": "$24,\\ 72,\\ 36$",
