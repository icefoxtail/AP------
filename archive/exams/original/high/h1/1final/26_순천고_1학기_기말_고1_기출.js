...
window.questionBank = [
  ...
  },
  {
    ...
    "wide": false,
    "content": "서답형 1.(단답형)<br>서답형 1.(단답형)<br>서답형 1.(단답형)<br>서답형 1.(단답형)<br>서답형 1.(단답형)<br>부등식 $|x+1|+|x-2|\\le9$를 만족시키는 정수 $x$의 개수를 구하시오. [3점]",
    "choices": [],
    "answer": "$10$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "서답형 2.(단답형)<br>서답형 2.(단답형)<br>서답형 2.(단답형)<br>서답형 2.(단답형)<br>서답형 2.(단답형)<br>지름의 길이가 $80$인 원에 내접하는 직사각형의 가로와 세로의 길이의 비가 $4:3$일 때, 직사각형의 넓이를 구하시오. [3점]",
    "choices": [],
    "answer": "$3072$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "서답형 3.(단답형)<br>서답형 3.(단답형)<br>서답형 3.(단답형)<br>서답형 3.(단답형)<br>서답형 3.(단답형)<br>두 이차함수 $y=f(x)$, $y=g(x)$의 그래프가 다음 그림과 같을 때, 부등식 $0\\lt f(x)\\lt g(x)$를 만족시키는 정수 $x$의 값을 구하시오. [4점]",
    "choices": [],
    "answer": "$-4$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "서답형 4.(단답형)<br>서답형 4.(단답형)<br>서답형 4.(단답형)<br>서답형 4.(단답형)<br>서답형 4.(단답형)<br>원가가 250원인 연필을 300원에 팔면 하루에 500개가 팔리고, 판매 가격을 5원 올릴 때마다 하루에 10개씩 덜 팔린다. 하루의 이익이 최대가 되도록 하는 연필 한 개의 판매 가격을 구하시오. [5점]",
    "choices": [],
    "answer": "$400$원",
  ...
  },
  {
    ...
    "wide": false,
    "content": "서답형 5.(서술형)<br>서답형 5.(서술형)<br>서답형 5.(서술형)<br>서답형 5.(서술형)<br>서답형 5.(서술형)<br>$\\begin{cases}x^2-y^2=0\\\\3x^2-2xy+y^2=24\\end{cases}$의 해 중 $(a>0,\\ b>0)$인 해를 $x=a$, $y=b$라 할 때, $a+b$를 구하는 과정을 서술하시오. [6점]",
    "choices": [],
    "answer": "$4\\sqrt3$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "서답형 6.(서술형)<br>서답형 6.(서술형)<br>서답형 6.(서술형)<br>서답형 6.(서술형)<br>서답형 6.(서술형)<br>최고차항의 계수가 1인 다항식 $f(x)$가 다음 두 조건을 만족시킨다.<div class='note-box'>(가) 다항식 $f(x)$를 다항식 $g(x)$로 나눈 몫과 나머지는 모두 $g(x)+x^2$이다.<br>(나) 방정식 $f(x)=0$은 서로 다른 세 정수근 $3,\\alpha,\\beta$를 가진다.</div>$\\alpha,\\beta$의 값을 구하는 과정과 정답을 서술하시오. (단, $\\alpha\\gt\\beta$) [7점]",
    "choices": [],
  ...
  },
  {
    ...
    "wide": false,
    "content": "서답형 7.(서술형)<br>서답형 7.(서술형)<br>서답형 7.(서술형)<br>서답형 7.(서술형)<br>서답형 7.(서술형)<br>서로 다른 종류의 음료 3개와 같은 종류의 빵 2개를 4명의 학생에게 나누어 주려고 한다. 아무것도 받지 못하는 학생이 없도록 음료와 빵을 나누어 주는 경우의 수를 구하려고 할 때, 다음 물음의 조건에 따른 경우의 수를 구하는 과정과 정답을 서술하시오. [총 7점, 부분점수 있음]<div class='note-box'>(1) 1명의 학생이 빵을 2개 받는 경우 [2점]<br>(2) 1명의 학생이 음료 1개와 빵 1개를 받는 경우 [2점]<br>(3) 1명의 학생이 음료 2개를 받는 경우 [3점]</div>",
    "choices": [],
    "answer": "$24,\\ 72,\\ 36$",
