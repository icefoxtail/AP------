...
window.questionBank = [
  ...
  },
  {
    ...
    "answer": "⑤",
    "solution": "[키포인트] $-1$이 $k$의 값에 관계없이 근이므로 대입한 식의 $k$의 계수와 상수항이 모두 $0$이다.\n\n$x=-1$을 대입하면\n$1-k(2a-1)-(a^2+2)k+b+3=b+4-(a+1)^2k=0$이다.\n이 식이 모든 실수 $k$에 대하여 성립하므로 $b+4=0$, $(a+1)^2=0$이다. 따라서 $a=-1$, $b=-4$이고 $a+b=-5$이다. 정답은 ⑤이다.",
    "subUnitKey": "H22-C-04-COMPLEX_ROOT",
    "subUnit": "복소수와 이차방정식",
    "subUnitConfidence": "category_or_cue_inferred",
    "subUnitClassificationDepth": "complete_category"
  ...
  },
  {
    ...
    "answer": "③",
    "solution": "[키포인트] $((1-i)/\\sqrt{2})^2=-i$를 이용해 $z_n=(-i)^n+ni^n$으로 바꾸고, 네 항씩 묶어 합한다.\n\n$(-i)^4=i^4=1$이므로 $(-i)^n$을 $n=1$부터 $30$까지 더하면 $-1-i$이다. 한편 $n=4m+1,\\ldots,4m+4$일 때 $ni^n$의 네 항의 합은 $(4m+1)i-(4m+2)-(4m+3)i+(4m+4)=2-2i$이다.\n따라서 $n=1$부터 $28$까지 $ni^n$의 합은 $7(2-2i)=14-14i$이고, 나머지 두 항은 $29i-30$이다. 그러므로 $n=1$부터 $30$까지 $ni^n$의 합은 $-16+15i$이다.\n결국 $z_1+\\cdots+z_{30}=(-1-i)+(-16+15i)=-17+14i$이므로 $a+b=-3$이다. 정답은 ③이다.",
    "subUnitKey": "H22-C-04-COMPLEX_ROOT",
    "subUnit": "복소수와 이차방정식",
    "subUnitConfidence": "category_or_cue_inferred",
    "subUnitClassificationDepth": "complete_category"
  ...
  },
  {
    ...
    "choices": [],
    "answer": "1) 합: 5, 곱: 3  2) $24x^2+4x-2=0$",
    "solution": "[키포인트] 원래 이차방정식의 근과 계수의 관계로 $\\alpha+\\beta=5$, $\\alpha\\beta=3$을 얻은 뒤, 새 두 근의 합과 곱을 구한다.\n\n1) $x^2-5x+3=0$의 두 근이 $\\alpha,\\beta$이므로 $\\alpha+\\beta=5$, $\\alpha\\beta=3$이다.\n\n2) 각 근은 $\\alpha^2-5\\alpha+3=0$을 만족하므로 $\\alpha^2-3\\alpha-1=2\\alpha-4$이고, $\\beta^2-3\\beta-1=2\\beta-4$이다. 두 분모의 곱은 $(2\\alpha-4)(2\\beta-4)=4\\alpha\\beta-8(\\alpha+\\beta)+16=12-40+16=-12$로 $0$이 아니다.\n따라서 새 두 근의 합은 $((2\\alpha-4)+(2\\beta-4))/(-12)=(2(\\alpha+\\beta)-8)/(-12)=-1/6$이고, 곱은 $1/(-12)=-1/12$이다. 구하는 이차방정식은 $x^2+(1/6)x-1/12=0$에 $24$를 곱한 $24x^2+4x-2=0$이다.",
  ...
  },
  {
    ...
    "choices": [],
    "answer": "12",
    "solution": "[키포인트] 삼각형 $ABC$에서 사각형 $PQCR$ 바깥의 두 직각삼각형 $APR$, $BPQ$의 넓이를 뺀다.\n\n$A=(0,0)$, $B=(6,0)$, $C=(0,6)$으로 두고 $P=(t,0)$라 하자. $P$는 두 꼭짓점이 아니므로 $0\\lt t\\lt6$이다. $BC$의 방정식은 $x+y=6$이고, $P$를 지나 $BC$와 평행한 직선이 $AC$와 만나는 점은 $R=(0,t)$이다. $P$에서 $BC$에 내린 수선의 발은 $Q=((t+6)/2,(6-t)/2)$이다.\n\n$[ABC]=18$, $[APR]=t^2/2$, $[BPQ]=(6-t)^2/4$이므로\n$[PQCR]=18-t^2/2-(6-t)^2/4=(-3t^2+12t+36)/4=12-3(t-2)^2/4$이다.\n$0\\lt t\\lt6$에서 $t=2$일 때 이 값이 최대이고, 그 최댓값은 $12$이다.",
    "subUnitKey": "H22-C-05-QUADRATIC_FUNCTION_GRAPH",
    "subUnit": "이차함수의 그래프",
    "subUnitConfidence": "category_or_cue_inferred",
    "subUnitClassificationDepth": "complete_category"
