...
window.questionBank = [
  ...
  },
  {
    ...
    "answer": "⑤",
    "solution": "x=−1이 모든 실수 k에서 근이므로 대입하면 1−(2a−1)k−(a²+2)k+b+3=0, 즉 b+4−(a+1)²k=0이다. 모든 k에서 성립하므로 b+4=0, (a+1)²=0이다. 따라서 a=−1, b=−4이고 a+b=−5이므로 정답은 ⑤이다.",
    "subUnitKey": "H22-C-04-COMPLEX_ROOT",
    "subUnit": "복소수와 이차방정식",
    "subUnitConfidence": "category_or_cue_inferred",
    "subUnitClassificationDepth": "complete_category"
  ...
  },
  {
    ...
    "answer": "③",
    "solution": "w=(1−i)/√2이므로 w²=−i, 1/w^(2n)=i^n이고 z_n=(−i)^n+n i^n.\n나머지별로 z_n은 n≡0: 1+n, n≡1: (n−1)i, n≡2: −(n+1), n≡3: (1−n)i이다.\n실수부 합은 n=4q(q=1,…,12)에서 12+4·78=324, n=4q+2(q=0,…,12)에서 −(4·78+39)=−351이므로 a=−27.\n허수부 합은 n=4q+1(q=0,…,12)에서 4·78=312, n=4q+3(q=0,…,11)에서 −(4·66+24)=−288이므로 b=24. 따라서 a+b=−3, 정답은 ③이다.",
    "subUnitKey": "H22-C-04-COMPLEX_ROOT",
    "subUnit": "복소수와 이차방정식",
    "subUnitConfidence": "category_or_cue_inferred",
    "subUnitClassificationDepth": "complete_category"
  ...
  },
  {
    ...
    "solution": "근과 계수의 관계로 α+β=5, αβ=3이다. α²−5α+3=0이므로 α²−3α−1=2α−4이며 β도 같다. 두 분모의 합은 2(α+β)−8=2, 곱은 4αβ−8(α+β)+16=−12이다. 변환된 두 근의 합은 2/(−12)=−1/6, 곱은 1/(−12)=−1/12이다. monic 이차식은 x²+⅙x−1/12=0이므로 계수를 24배 하여 24x²+4x−2=0을 얻는다.",
  ...
  },
  {
    ...
    "choices": [],
    "answer": "12",
    "solution": "A=(0,0), B=(6,0), C=(0,6), P=(t,0), 0<t<6으로 둔다. BC는 x+y=6, P에서 BC에 수직인 직선은 y=x−t이므로 Q=((t+6)/2,(6−t)/2)이다. P를 지나 BC에 평행한 직선은 y=−x+t이고 AC와 만나는 점은 R=(0,t)이다. [ABC]=18, [APR]=t²/2, [BPQ]=½(6−t)·(6−t)/2=(6−t)²/4이다. 따라서 [PQCR]=18−t²/2−(6−t)²/4=12−¾(t−2)². t=2는 허용되므로 최댓값은 12이다.",
    "subUnitKey": "H22-C-05-QUADRATIC_FUNCTION_GRAPH",
    "subUnit": "이차함수의 그래프",
    "subUnitConfidence": "category_or_cue_inferred",
    "subUnitClassificationDepth": "complete_category"
