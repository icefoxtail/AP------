...
window.questionBank = [
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림과 같이 정원을 만들기 위하여 길이가 240m인 끈을 모두 사용하여 직사각형 모양의 2개의 영역으로 경계를 나누어서 구분하였다. 큰 영역은 정사각형으로 만들고, 두 개의 영역의 넓이의 합이 최대가 되도록 할 때 그때 정사각형 영역의 한 변의 길이는? (단, 끈의 두께는 생각하지 않는다.) [4.9점]",
    "choices": ["10m","20m","30m","40m","50m"],
    "image": "assets/images/23_매산고_1학기_중간_고1_기출/q10-question-figure.png",
    "answer": "④",
    "solution": "정사각형의 한 변을 x, 두 영역을 포함한 바깥 직사각형의 가로를 y라 하자. 끈은 바깥 둘레에 2x+2y, 안쪽 칸막이에 x가 쓰이므로 3x+2y=240, 즉 y=120−3x/2이다.\n두 영역의 넓이 합은 xy이다. 다른 직사각형의 가로는 y−x이고, 정사각형이 더 큰 영역이므로 x²≥x(y−x), 즉 y≤2x. 두 영역이 모두 존재하려면 y>x이다. y를 대입하면 240/7≤x<48이다.\nA(x)=xy=−3x²/2+120x=−3(x−40)²/2+2400이므로 최대는 x=40에서 나온다. 이때 y=60이고 다른 영역의 가로는 20이므로 정사각형 넓이가 더 크다. 구하는 한 변은 40m이다.",
  ...
  },
  {
    ...
    "wide": false,
    "content": "[서술형 2] 이차함수 $y=-x^2+6x$의 그래프가 직선 $y=ax+b$의 그래프와 한 점 $C$에서 접하며 점 $C$에서 $x$축에 내린 수선의 발을 $D$라 하고 직선 $y=ax+b$의 $x$절편과 $y$절편을 각각 점 $A$, $B$라고 하자. 두 삼각형 $ABO$와 삼각형 $ACD$를 만들 때, 큰 삼각형의 넓이가 작은 삼각형 넓이의 $9$배가 되도록 하는 $a$에 대하여 $b$의 절댓값을 구하시오. (단, $a$, $b$는 $0$이 아닌 실수이고 $O$는 원점을 나타낸다.) [10점]",
    "choices": [],
    "answer": "$|b|=\\frac{(a-6)^2}{4}$",
    "solution": "포물선을 y=−x²+6x라 하고, 접점 C의 x좌표를 t라 하자.\nC=(t,−t²+6t)이고 접점은 포물선 위에 있으므로 0<t<6이다.\n\n포물선의 기울기는 −2x+6이므로 C에서의 접선은\ny−(−t²+6t)=(6−2t)(x−t)\n이다. 정리하면\ny=(6−2t)x+t²\n이므로 a=6−2t, b=t²이다.\n문제에서 a≠0이므로 t≠3이다. 또한 0<t<6이므로 b>0이다.\n\n접선의 x절편을 A=(−b/a,0), y절편을 B=(0,b), 원점을 O=(0,0)이라 하자.\nC에서 x축에 내린 수선의 발은 D=(t,0)이다.\n\nOA=|b/a|=t²/(2|3−t|), OB=b=t²이므로\n[ABO]=½·OA·OB=t⁴/(4|3−t|)이다.\n\n또\nAD=|t+b/a|\n   =|t+t²/(6−2t)|\n   =t(6−t)/(2|3−t|)\n이고, DC=t(6−t)이다.\n따라서\n[ACD]=½·AD·DC\n      =t²(6−t)²/(4|3−t|)이다.\n\n그러므로\n[ACD]/[ABO]=(6−t)²/t²이다.\n\n큰 삼각형의 넓이가 작은 삼각형 넓이의 9배이므로 이 비는 9 또는 1/9이다.\n0<t<6이므로 t와 6−t는 모두 양수이다.\n\n(6−t)²/t²=9이면 6−t=3t이므로 t=3/2이다.\n(6−t)²/t²=1/9이면 3(6−t)=t이므로 t=9/2이다.\n\nt=3/2일 때 a=3, b=9/4이다.\nt=9/2일 때 a=−3, b=81/4이다.\n따라서 가능한 쌍은 (a,|b|)=(3,9/4), (−3,81/4)이다.\n\na=6−2t에서 t=(6−a)/2이고 b=t²>0이므로\n|b|=b=t²=(a−6)²/4이다.",
    "subUnitKey": "H15-SA-13-QUADRATIC_APPLICATION",
    "subUnit": "이차함수의 활용",
    "subUnitConfidence": "rule_inferred",
    "subUnitClassificationDepth": "complete_rule",
