...
window.questionBank = [
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음 그림과 같이 정원을 만들기 위하여 길이가 $240m$인 끈을 모두 사용하여 직사각형 모양의 $2$개의 영역으로 나누어 구획하였다. 그 영역은 정사각형으로 만들고, 두 개의 영역의 넓이의 합이 최대가 되도록 할 때, 그때 정사각형 영역의 한 변의 길이는? (단, 끈의 두께는 생각하지 않는다.) [4.9점]",
  ...
  },
  {
    ...
    "wide": false,
    "content": "[서술형 2] 이차함수 $y=-x^2+6x$의 그래프와 직선 $y=ax+b$의 그래프와 점 $C$에서 접할 때, 점 $C$에서 $x$축에 내린 수선의 발을 $D$라 하고, 직선 $y=ax+b$의 $x$절편과 $y$절편을 각각 점 $A,B$라 하자. 두 삼각형 $ABO$와 삼각형 $ACD$를 만들 때, 큰 삼각형의 넓이가 작은 삼각형 넓이의 9배가 되도록 하는 직선의 기울기 $a$의 최댓값의 절댓값을 구하시오. (단, $a,b$는 0이 아닌 실수이고, $O$는 원점이다.) [10점]",
    "choices": [],
    "answer": "12",
