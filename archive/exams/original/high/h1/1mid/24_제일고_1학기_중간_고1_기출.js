...
window.questionBank = [
  ...
  },
  {
    ...
    "solutionImage": "assets/images/24_제일고_1학기_중간_고1_기출/q11-solution.svg",
    "solutionImageAlt": "선분 AB의 4등분점 중 B에 가장 가까운 점 P의 위치와 좌표를 표시한 그림",
    "solutionImageCaption": "A-P1-P2-P-B의 순서와 AP:PB=3:1을 좌표별 내분공식으로 확인한다.",
  ...
  },
  {
    ...
    "solutionImageCaption": "평행 관계 · 수직 관계 · (a,b)=(1,3): 첫째와 둘째 수직, 첫째와 셋째 평행 · (a,b)=(3,1): 첫째와 둘째 수직, 첫째와 셋째 평행",
    "solutionImageSize": "full",
    "subUnitKey": "H22-C2-02-RELATION",
    "subUnit": "두 직선의 관계",
    "subUnitConfidence": "rule_inferred",
