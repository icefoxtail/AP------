...
window.questionBank = [
  ...
  },
  {
    ...
    "answer": "④",
    "solution": "[원문 대조 보류] 현재 production content에는 ‘행렬 상등’이라는 말과 함께 x-1=p, y=11이 기록되어 있지만, 상등을 이루는 실제 두 행렬이 누락되어 있어 이 관계가 어떤 성분 비교에서 나온 것인지 확인할 수 없다. 저장소와 로컬 원본 시험지 폴더에서도 해당 원본 스캔을 찾지 못했다. 보이는 조건만 임시로 사용하면 x=p+1이고 x≤50이므로 p≤49, 50 이하의 가장 큰 소수는 47이어서 x+y+p=106이지만, 이는 누락된 행렬 상등을 확인한 결론이 아니다. 따라서 추측으로 행렬을 복원하지 않고 HOLD_SOURCE_EVIDENCE_MISSING으로 남긴다.",
    "subUnitKey": "H22-C-09-CORE",
    "subUnit": "경우의 수 핵심 개념",
    "subUnitConfidence": "rule_inferred",
    "subUnitClassificationDepth": "complete_rule"
