...
window.questionBank = [
  ...
  },
  {
    ...
    "wide": false,
    "content": "세 다항식 $A=x^2-xy+2y^2$, $B=x^2+xy+y^2$, $C=x^2-y^2$에 대하여 $(A+2B)-(B+C)$를 계산한 식에서 $xy$의 계수는? [4.1점]",
    "choices": [
      "−4",
      "−2",
      "0",
    ...
    "answer": "③",
    "solution": "A+2B=(x²−xy+2y²)+2(x²+xy+y²)=3x²+xy+4y².\nB+C=(x²+xy+y²)+(x²−y²)=2x²+xy.\n따라서 (A+2B)−(B+C)=x²+4y²이고 xy의 계수는 0이므로 정답은 ③이다.",
  ...
  },
  {
    ...
    "wide": false,
    "content": "다음은 다항식 $3x^2-5x+6$을 $x-1$로 나누는 과정을 나타낸 것이다. 이때 상수 $a,b$에 대하여 $a+b$의 값은? [4.3점]<br><div class=\"question-table-wrap\"><table class=\"question-table\"><tr><td></td><td>$ax-2$</td></tr><tr><td>$x-1)$</td><td>$3x^2-5x+6$</td></tr><tr><td></td><td>$3x^2-3x$</td></tr><tr><td></td><td>$-2x+6$</td></tr><tr><td></td><td>$-2x+2$</td></tr><tr><td></td><td>$4$</td></tr></table></div>",
    "choices": [
      "3",
      "4",
      "5",
    ...
    "answer": "⑤",
    "solution": "나머지가 b이므로 3x²−5x+6=(x−1)(ax−2)+b이다.\n우변을 전개하면 ax²−(a+2)x+2+b이다. 계수를 비교하여 a=3, a+2=5, 2+b=6이므로 a=3, b=4이다.\na+b=3+4=7이므로 정답은 ⑤이다.",
    "subUnitKey": "H22-C-01-POLYNOMIAL_BASIC",
    "subUnit": "다항식의 연산",
    "subUnitConfidence": "category_or_cue_inferred",
    "subUnitClassificationDepth": "complete_category"
  ...
  },
  {
    ...
    "wide": false,
    "content": "소수 $p$와 50 이하의 자연수 $x,y$에 대하여 두 행렬 $A=\\begin{pmatrix}xy-p&0\\\\0&x-y\\end{pmatrix}$, $B=\\begin{pmatrix}x+y-1&0\\\\0&p-1\\end{pmatrix}$가 $A=B$일 때, $p$의 최댓값은? [4.8점]",
    "choices": [
      "41",
      "43",
      "47",
    ...
    "answer": "③",
    "solution": "xy−p=x+y−1에서 (x−1)(y−1)=p이고, x−y=p−1이다. u=x−1, v=y−1로 두면 uv=p, u−v=p−1이므로 uv−u+v−1=0, 즉 (u+1)(v−1)=0이다. x는 자연수라 u+1>0이므로 v=1, y=2이고 p=u=x−1이다. x≤50이므로 p≤49, 따라서 가장 큰 가능 소수는 47이다. x=48, y=2, p=47은 두 행렬 성분을 모두 같게 하므로 최댓값은 47, 정답은 ③이다.",
    "subUnitKey": "H22-C-09-CORE",
    "subUnit": "경우의 수 핵심 개념",
    "subUnitConfidence": "rule_inferred",
    "subUnitClassificationDepth": "complete_rule"
  },
  {
    ...
    "wide": false,
    "content": "모든 실수 $x$에 대하여 최고차항의 계수가 1인 두 이차다항식 $P(x),Q(x)$가 다음 조건을 만족시킨다.<div class=\"question-table-wrap\"><table class=\"question-table\"><tr><td>(가) $P(x)-Q(x)=2$</td></tr><tr><td>(나) $10-Q(x)$는 $x+1$로 나누어떨어진다.</td></tr><tr><td>(다) $P(x)Q(x)=0$의 근은 연속하는 네 자연수이다.</td></tr></table></div>다항식 $P(x)Q(x)+k$가 실수 $a,b$에 대하여 이차식 $x^2+ax+b$의 제곱으로 인수분해될 때, 상수 $k+a+b$의 값은? [4.9점]",
    "choices": [
      "1",
      "2",
      "3",
    ...
    "answer": "①",
    "solution": "P−Q=2이므로 P,Q의 x계수와 두 근의 합이 같다. 연속한 네 자연수 n,n+1,n+2,n+3을 같은 합으로 나누는 두 쌍은 (n,n+3),(n+1,n+2)뿐이다. 두 곱은 n²+3n, n²+3n+2이고 P의 상수항이 더 크므로 Q는 양 끝 근, P는 가운데 근을 갖는다.\nQ(−1)=10이므로 (n+1)(n+4)=10, 즉 (n+6)(n−1)=0이다. n=1이므로 Q=(x−1)(x−4)=x²−5x+4, P=(x−2)(x−3)=x²−5x+6.\nPQ=(x²−5x+5)²−1이므로 PQ+k=(x²−5x+5)²+(k−1). (x²+ax+b)²와 계수 비교하면 2a=−10, a²+2b=35이므로 a=−5, b=5. 상수항에서 24+k=25이므로 k=1. 따라서 k+a+b=1, 정답은 ①이다.",
  ...
  },
  {
    ...
    "wide": false,
    "content": "[서술형 1] $x$에 대한 이차방정식 $x^2-2(k-1)x+k^2-ak+b-3=0$이 실수 $k$의 값에 관계없이 항상 중근을 가질 때, 상수 $a,b$에 대하여 다항식 $x^3-4x^2+ax+b$를 복소수 범위에서 인수분해하고 그 풀이 과정을 서술하시오. [6.0점]",
    "choices": [],
    "answer": "a=2, b=4; (x−2)(x−1−√3)(x−1+√3)",
    "solution": "판별식은 Δ=[−2(k−1)]²−4(k²−ak+b−3)=4{(a−2)k+4−b}이다. 모든 실수 k에서 중근이므로 Δ=0의 k계수가 0, 상수항이 0이다. 따라서 a=2, b=4.\n이제 x³−4x²+ax+b=x³−4x²+2x+4=(x−2)(x²−2x−2)이다. x²−2x−2=0의 근은 1±√3이므로 다항식은 (x−2)(x−1−√3)(x−1+√3)로 인수분해된다.",
    "subUnitKey": "H22-C-05-QUADRATIC_EQUATION",
    "subUnit": "이차방정식",
    "subUnitConfidence": "rule_inferred",
    "subUnitClassificationDepth": "complete_rule"
  },
  {
    ...
    "wide": false,
    "content": "[서술형 2] 다음 그림과 같이 반지름의 길이가 10인 원 $O$의 지름 $AB$와 현 $CD$가 만나는 점 $P$에 대하여 $CP=9$, $DP=6$이다. 선분 $AP$와 선분 $BP$의 길이를 두 근으로 하고, $x^2$의 계수가 1인 이차방정식을 구하고 그 풀이 과정을 서술하시오. [6.0점]",
    "choices": [],
    "answer": "x^2-20x+54=0",
    "solution": "반지름이 10이므로 지름 AB=20이다. 지름 AB와 현 CD가 P에서 만나므로 교차하는 두 현의 정리에 따라 AP·PB=CP·PD=9·6=54이다. P는 A,B 사이에 있으므로 AP+PB=20. 두 근이 AP, PB인 monic 이차식은 x²−(AP+PB)x+AP·PB=0이므로 x²−20x+54=0이다.",
    "image": "assets/images/25_순천여고_1학기_중간_고1_기출/q20.png",
