...
window.questionBank = [
  ...
  },
  {
    ...
    "answer": "④",
    "solution": "문제에 제시된 행렬 상등의 실제 두 행렬이 누락되어 있어, $x-1=p$와 $y=11$이 어떤 성분 비교에서 나온 조건인지 확인할 수 없다. 누락된 행렬을 임의로 복원하지 않으면 현재 정보만으로는 $x+y+p$의 최댓값을 결정할 수 없다.",
    "subUnitKey": "H22-C-09-CORE",
    "subUnit": "경우의 수 핵심 개념",
    "subUnitConfidence": "rule_inferred",
    "subUnitClassificationDepth": "complete_rule"
  ...
  },
  {
    ...
    "wide": false,
    "content": "[서술형 1] $x$에 대한 이차방정식<br>$$x^2-2(k-1)x+k^2-ak+b-3=0$$<br>이 실수 $k$의 값에 관계없이 항상 중근을 가질 때, 상수 $a,b$에 대하여 다항식 $x^3-4x^2+ax+b$를 복소수 범위에서 인수분해하고, 그 풀이 과정을 서술하시오. [6.0점]",
    "choices": [],
