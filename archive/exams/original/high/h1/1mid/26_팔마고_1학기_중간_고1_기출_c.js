...
window.questionBank = [
  ...
  },
  {
    ...
    "choices": [],
    "answer": "이등변삼각형($a=b$)",
    "solution": "풀이: 직선각과 맞꼭지각, 평행선의 동위각·엇각 및 삼각형의 내각의 합을 이용해 그림의 각을 차례로 계산한다. 주어진 정답과 일치하는 결과는 이등변삼각형($a=b$)이다.",
  ...
  },
  {
    ...
    "solution": "풀이: 주어진 식 또는 그래프에서 좌표의 부호와 변화 관계를 확인하고, 문제의 조건을 식으로 정리한다. 주어진 정답과 일치하는 결과는 (1) $\\sqrt{5}$ (2) $8\\sqrt{5}$ (3) $112\\sqrt{5}$이다.",
    "subUnitKey": "H22-C-01-POLYNOMIAL_BASIC",
    "subUnit": "다항식의 연산",
    "subUnitConfidence": "category_or_cue_inferred",
    "subUnitClassificationDepth": "complete_category"
