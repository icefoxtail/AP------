...
window.questionBank = [
  ...
  },
  {
    ...
    "answer": "⑤",
    "solution": "[풀이]\n각 교차점까지 A에서 최단경로로 오는 경우의 수를 적는다. 왼쪽과 위쪽의 이전 교차점이 모두 연결되어 있으면 두 값을 더하고, 끊어진 길을 지나는 경우에는 그 방향의 값을 더하지 않는다. 표는 위에서부터 아래로, 왼쪽에서 오른쪽 순서이다.\n\\[\\begin{array}{ccccccc}\n1&1&1&1&1&1&1\\\\\n1&2&3&4&5&5&6\\\\\n1&3&6&6&11&16&22\\\\\n1&1&7&13&24&40&62\n\\end{array}\\]\n따라서 A에서 B까지의 전체 최단경로는 $62$가지이다.\n$P$를 지나는 경로는 두 부분으로 나누어 센다. A에서 P까지는 $\\binom{5}{1}=6$가지에서 끊어진 세로 길을 지나는 1가지를 제외하여 $5$가지이고, P에서 B까지는 끊어진 길이 없으므로 $\\binom{4}{2}=6$가지이다. 따라서 P를 지나는 경로는 $5\\times6=30$가지이다.\n그러므로 P를 지나지 않는 경로는 $62-30=32$가지이다. 따라서 정답은 ⑤이다.",
    "subUnitKey": "STAT-02-CORE",
    "subUnit": "순열과 조합 핵심 개념",
    "subUnitConfidence": "rule_inferred",
    "subUnitClassificationDepth": "complete_rule"
