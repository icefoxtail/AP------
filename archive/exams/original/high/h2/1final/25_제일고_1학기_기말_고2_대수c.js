...
window.questionBank = [
  ...
  },
  {
    ...
    wide: false,
    content: "※ 다음 조건을 만족시키는 두 실수 $\\alpha$, $\\beta$에 대하여 $\\dfrac{12}{\\pi}(\\beta-\\alpha)$의 최댓값을 구하려고 한다. 다음 물음에 답하시오.\\n(서술형 1~3, 총 10점, 각 문항별 부분 점수 있음.)\\n\\n$0 \\le x < 2\\pi$에서 함수\\n$$f(x)=\\cos^2\\left(\\dfrac{13}{12}\\pi-2x\\right)+\\cos\\left(2x-\\dfrac{7}{12}\\pi\\right)-1$$\\n은 $x=\\alpha$일 때 최댓값을 갖고, $x=\\beta$일 때 최솟값을 갖는다.\\n\n\\n(1) $\\sin\\left(2x-\\dfrac{\\pi}{12}\\right)$를 $t$로 치환하여 함수 $f(x)$를 $t$에 대한 함수 $g(t)$로 나타내시오.\\n(단, 함수 $g(t)$의 정의역 즉, $t$의 범위도 함께 나타내기) (4점)\\n\n\\n(2) $\\alpha$의 최솟값과 $\\beta$의 최댓값을 각각 구하시오. (4점)\\n\n\\n(3) $\\dfrac{12}{\\pi}(\\beta-\\alpha)$의 최댓값을 구하시오. (2점)",
    choices: [],
    answer: "(1) $g(t)=-t^2+t$ (단, $-1 \\le t \\le 1$)\\n(2) $\\alpha$의 최솟값: $\\dfrac{\\pi}{8}$, $\\beta$의 최댓값: $\\dfrac{43\\pi}{24}$\\n(3) $20$",
    solution: "[키포인트] 공통 각을 잡아 이차함수로 치환한 뒤, 최대·최소 조건을 원래 삼각방정식의 해로 되돌린다.\\n\\n(1) $\\theta=2x-\\dfrac{\\pi}{12}$라 하자.\\n첫 번째 각도는 $\\dfrac{13}{12}\\pi-2x=\\pi-\\theta$이므로 $\\cos^2(\\pi-\\theta)=\\cos^2\\theta=1-\\sin^2\\theta$이다.\\n두 번째 각도는 $2x-\\dfrac{7}{12}\\pi=\\theta-\\dfrac{\\pi}{2}$이므로 $\\cos\\left(\\theta-\\dfrac{\\pi}{2}\\right)=\\sin\\theta$이다.\\n따라서 $f(x)=(1-\\sin^2\\theta)+\\sin\\theta-1=-\\sin^2\\theta+\\sin\\theta$이다.\\n$t=\\sin\\theta=\\sin\\left(2x-\\dfrac{\\pi}{12}\\right)$로 놓으면 $g(t)=-t^2+t$이고, $t$의 범위는 $-1\\le t\\le 1$이다.\\n\\n(2) $g(t)=-t^2+t=-\\left(t-\\dfrac{1}{2}\\right)^2+\\dfrac{1}{4}$이므로 최댓값은 $t=\\dfrac{1}{2}$에서 갖는다.\\n따라서 $\\sin\\left(2x-\\dfrac{\\pi}{12}\\right)=\\dfrac{1}{2}$이고, $0\\le x<2\\pi$에서 가능한 $x$는 $\\dfrac{\\pi}{8},\\ \\dfrac{11\\pi}{24},\\ \\dfrac{9\\pi}{8},\\ \\dfrac{35\\pi}{24}$이다. 그러므로 $\\alpha$의 최솟값은 $\\dfrac{\\pi}{8}$이다.\\n또한 $-1\\le t\\le 1$에서 $g(t)$의 최솟값은 $t=-1$에서 갖는다.\\n따라서 $\\sin\\left(2x-\\dfrac{\\pi}{12}\\right)=-1$이고, 가능한 $x$는 $\\dfrac{19\\pi}{24},\\ \\dfrac{43\\pi}{24}$이다. 그러므로 $\\beta$의 최댓값은 $\\dfrac{43\\pi}{24}$이다.\\n\\n(3) $\\dfrac{12}{\\pi}(\\beta-\\alpha)$를 최대로 만들려면 $\\beta$는 최댓값, $\\alpha$는 최솟값을 선택한다.\\n$\\beta-\\alpha=\\dfrac{43\\pi}{24}-\\dfrac{\\pi}{8}=\\dfrac{40\\pi}{24}=\\dfrac{5\\pi}{3}$이므로\\n$\\dfrac{12}{\\pi}(\\beta-\\alpha)=\\dfrac{12}{\\pi}\\cdot\\dfrac{5\\pi}{3}=20$이다.\\n결론: 답은 (1) $g(t)=-t^2+t$ (단, $-1\\le t\\le 1$), (2) $\\alpha$의 최솟값 $\\dfrac{\\pi}{8}$, $\\beta$의 최댓값 $\\dfrac{43\\pi}{24}$, (3) $20$이다."
  },
  {
    id: 22,
    level: "중",
