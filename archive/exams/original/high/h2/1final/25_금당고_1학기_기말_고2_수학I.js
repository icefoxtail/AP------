...
window.questionBank = [
  ...
  },
  {
    ...
    answer: "①",
    solution: "[키포인트] 코사인법칙으로 한 각의 사인값을 구해 넓이를 구한 뒤 $S=rs$를 이용한다.\n조건 정리: 세 변의 길이는 $13, 14, 15$이고 내접원의 반지름을 구해야 한다.\n정석 풀이: $a=13, b=14, c=15$라 하면 코사인법칙에 의해 $\\cos C = \\dfrac{a^2+b^2-c^2}{2ab} = \\dfrac{169+196-225}{2\\cdot13\\cdot14} = \\dfrac{140}{364} = \\dfrac{5}{13}$이다.\n$\\sin C = \\sqrt{1-\\left(\\dfrac{5}{13}\\right)^2} = \\dfrac{12}{13}$이므로 삼각형의 넓이는 $S = \\dfrac{1}{2}ab\\sin C = \\dfrac{1}{2}\\cdot13\\cdot14\\cdot\\dfrac{12}{13} = 84$이다.\n반둘레는 $s = \\dfrac{13+14+15}{2} = 21$이고, $S = rs$이므로 $84 = 21r$에서 $r = 4$이다.\n따라서 정답은 ①이다."
  },
  {
    id: 10,
    level: "중",
