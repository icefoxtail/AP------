...
window.questionBank = [
  {
    ...
    "wide": false,
    "content": "확률변수 $X$가 이항분포 $B(100, \\dfrac{3}{5})$를 따를 때, $V(-2X+4)$의 값은? [3.4점]",
    "choices": [
      "$-96$",
      "$-48$",
      "$48$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "확률변수 $X$에 대하여 $E(X)=7$, $V(X)=2$이고, 확률변수 $Y=aX+b$에 대하여 $E(Y)=0$, $V(Y)=2$이다. 이때 상수 $a$, $b$에 대하여 $ab$의 값은? [3.5점]",
    "choices": [
      "$-3$",
      "$-4$",
      "$-5$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "오른쪽 그림과 같이 정육면체 두 개가 붙어 있다. 모서리를 따라 $A$지점에서 $L$지점으로 가는 최단 경로 중 $C$지점을 통과할 확률은? [3.5점]",
  ...
  },
  {
    ...
    "wide": false,
    "content": "한 개의 동전을 $8$번 던질 때, 앞면이 나오는 횟수를 $A$라 한다. $t$에 관한 이차방정식 $t^2-2(A-1)t+4A-4=0$이 중근을 갖게 될 확률은? [3.6점]",
    "choices": [
      "$\\dfrac{1}{8}$",
      "$\\dfrac{1}{4}$",
      "$\\dfrac{1}{2}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "집에서 학교까지의 통학 시간을 $X$분이라고 하면 확률변수 $X$는 정규분포 $N(30,5^2)$을 따른다고 한다. 수업 시작 $40$분 전에 집에서 출발할 때, 지각할 확률을 오른쪽 표준정규분포표를 이용하여 구하면? [3.6점]<table class=\"question-table\"><thead><tr><th>$z$</th><th>$P(0 \\le Z \\le z)$</th></tr></thead><tbody><tr><td>$1.0$</td><td>$0.3413$</td></tr><tr><td>$1.5$</td><td>$0.4332$</td></tr><tr><td>$2.0$</td><td>$0.4772$</td></tr><tr><td>$2.5$</td><td>$0.4938$</td></tr></tbody></table>",
    "choices": [
      "$0.0062$",
      "$0.0228$",
      "$0.0668$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "윷가락 한 개를 던질 때 평평한 면이 나올 확률은 $\\dfrac{3}{5}$이라고 한다. 윷가락 네 개를 동시에 던지는 시행을 $250$번 반복할 때, 평평한 면이 $2$번 나오는 횟수를 확률변수 $X$라고 하자. 이때 $E(X)$의 값은? [3.7점]",
    "choices": [
      "$\\dfrac{214}{5}$",
      "$\\dfrac{216}{5}$",
      "$\\dfrac{432}{5}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "이산확률변수 $X$의 확률분포를 표로 나타내면 다음과 같다. 다섯 개의 수 $a,b,c,d,e$가 이 순서대로 등차수열을 이루고 $E(X)=3$일 때, $V(X)$의 값은? [3.7점]<table class=\"question-table\"><thead><tr><th>$X$</th><th>$0$</th><th>$1$</th><th>$2$</th><th>$3$</th><th>$4$</th><th>합계</th></tr></thead><tbody><tr><td>$P(X=x)$</td><td>$a$</td><td>$b$</td><td>$c$</td><td>$d$</td><td>$e$</td><td>$1$</td></tr></tbody></table>",
    "choices": [
      "$1$",
      "$2$",
      "$3$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "한 개의 주사위를 두 번 던져서 나오는 눈의 수를 차례로 $a,b$라 할 때, $|a-3|+|b-2|=3$이거나 $a=b$일 확률은? [3.7점]",
    "choices": [
      "$\\dfrac{2}{9}$",
      "$\\dfrac{1}{4}$",
      "$\\dfrac{5}{18}$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "확률변수 $X$가 평균이 $m$, 표준편차가 $2$인 정규분포를 따르고 $P(X\\le5)=0.0228$일 때, $P(4\\le X\\le11)$의 값을 오른쪽 표준정규분포표를 이용하여 구하면? [3.8점]<table class=\"question-table\"><thead><tr><th>$z$</th><th>$P(0 \\le Z \\le z)$</th></tr></thead><tbody><tr><td>$1.0$</td><td>$0.3413$</td></tr><tr><td>$1.5$</td><td>$0.4332$</td></tr><tr><td>$2.0$</td><td>$0.4772$</td></tr><tr><td>$2.5$</td><td>$0.4938$</td></tr></tbody></table>",
    "choices": [
      "$0.6826$",
      "$0.7745$",
      "$0.8185$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "연속확률변수 $X$가 갖는 값의 범위는 $0\\le X\\le b$이고, $X$의 확률밀도함수의 그래프가 그림과 같다. $\\dfrac{P(X\\ge a)}{P(X\\le a)}=\\dfrac{6}{7}$일 때, $2(a+b)$의 값은? [3.8점]",
  ...
  },
  {
    ...
    "wide": false,
    "content": "숫자 $0,1,2,3,4,5$ 중에서 서로 다른 $4$개를 택해 일렬로 나열하여 만들 수 있는 모든 네 자리의 자연수 중에서 임의로 하나를 택할 때, 택한 수가 $5$의 배수 또는 $3500$ 이상일 확률은? [3.9점]",
    "choices": [
      "$\\dfrac{16}{25}$",
      "$\\dfrac{33}{50}$",
      "$\\dfrac{67}{100}$",
    ...
    "answer": "③",
    "solution": "[키포인트] 두 사건의 합집합은 각 사건의 경우의 수를 더한 뒤 교집합의 경우의 수를 뺀다.\n조건 정리: 서로 다른 숫자 $0,1,2,3,4,5$ 중 $4$개를 사용하여 네 자리 자연수를 만들며, 첫 자리에는 $0$이 올 수 없다.\n풀이 방향: 전체 네 자리 수, $5$의 배수, $3500$ 이상인 수, 두 조건을 모두 만족하는 수를 각각 센다.\n정석 풀이: 전체 네 자리 자연수는 첫 자리에 $1,2,3,4,5$ 중 하나를 놓고 나머지 세 자리를 배열하므로 $5\\cdot{}_5P_3=300$개이다. $5$의 배수는 일의 자리가 $0$ 또는 $5$이다. 일의 자리가 $0$이면 천의 자리는 $1$부터 $5$까지 $5$가지이고 가운데 두 자리는 남은 $4$개 중 $2$개를 배열하므로 $5\\cdot{}_4P_2=60$개이다. 일의 자리가 $5$이면 천의 자리는 $1,2,3,4$ 중 하나이고 가운데 두 자리는 남은 $4$개 중 $2$개를 배열하므로 $4\\cdot{}_4P_2=48$개이다. 따라서 $5$의 배수는 $108$개이다. $3500$ 이상인 수는 천의 자리가 $4$ 또는 $5$인 경우 $2\\cdot{}_5P_3=120$개이고, 천의 자리가 $3$인 경우에는 백의 자리가 $5$여야 하므로 나머지 두 자리를 배열하는 ${}_4P_2=12$개이다. 따라서 모두 $132$개이다. 두 조건을 모두 만족하는 수를 센다. 일의 자리가 $0$일 때 천의 자리가 $4$ 또는 $5$이면 $2\\cdot{}_4P_2=24$개이고, 천의 자리가 $3$이면 백의 자리가 $5$이며 십의 자리는 $1,2,4$ 중 하나이므로 $3$개이다. 따라서 이 경우는 $27$개이다. 일의 자리가 $5$일 때에는 천의 자리가 $4$인 경우만 가능하고 가운데 두 자리를 남은 $4$개 중에서 배열하므로 ${}_4P_2=12$개이다. 그러므로 교집합은 $27+12=39$개이다. 따라서 원하는 경우의 수는 $108+132-39=201$개이고, 구하는 확률은 $\\dfrac{201}{300}=\\dfrac{67}{100}$이다.\n따라서 정답은 ③이다."
  },
  {
    "id": 14,
    "level": "중",
    ...
    "wide": false,
    "content": "두 확률변수 $X$, $Y$에 대하여 $Y=\\dfrac{1}{6}X-1$일 때, 확률변수 $Y$의 확률분포가 다음 표와 같다. 확률변수 $X^2$의 평균은? [3.9점]<table class=\"question-table\"><thead><tr><th>$Y$</th><th>$0$</th><th>$1$</th><th>$2$</th><th>$3$</th><th>합계</th></tr></thead><tbody><tr><td>$P(Y=y)$</td><td>$\\dfrac{11}{24}$</td><td>$\\dfrac{1}{4}$</td><td>$\\dfrac{1}{8}$</td><td>$\\dfrac{1}{6}$</td><td>$1$</td></tr></tbody></table>",
    "choices": [
      "$161$",
      "$168$",
      "$175$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "두 연속확률변수 $X$와 $Y$가 갖는 값의 범위는 $0\\le X\\le10$, $0\\le Y\\le10$이고, $X$와 $Y$의 확률밀도함수는 각각 $f(x)$, $g(x)$이다. 확률변수 $X$의 확률밀도함수 $f(x)$의 그래프는 그림과 같다. $0\\le x\\le10$인 모든 $x$에 대하여 $f(x)-f(10-x)=g(10-x)-g(x)$를 만족시킬 때, $P(0\\le Y\\le5)$의 값은? (단, $k$는 상수이다.) [4점]",
  ...
  },
  {
    ...
    "answer": "①",
    "solution": "[키포인트] 전체 공의 개수가 $10$개가 되는 경우를 먼저 제한하고, 그중 흰 공이 $7$개인 경우를 찾는다.\n조건 정리: 카드 $1$이 나올 확률은 $\\dfrac{1}{4}$이고 흰 공 $1$개를 넣는다. 카드 $2$ 또는 $3$이 나올 확률은 $\\dfrac{1}{2}$이고 흰 공 $1$개와 검은 공 $1$개를 넣는다. 카드 $4$가 나올 확률은 $\\dfrac{1}{4}$이고 흰 공 $2$개와 검은 공 $1$개를 넣는다.\n풀이 방향: $5$번 시행에서 세 범주가 나온 횟수를 두어 전체 공의 개수가 $10$개가 되는 경우를 찾고, 각 경우의 다항확률을 계산한다.\n정석 풀이: 카드 $1$이 나온 횟수를 $n_1$, 카드 $2$ 또는 $3$이 나온 횟수를 $n_2$, 카드 $4$가 나온 횟수를 $n_4$라 하자. 시행 횟수에서 $n_1+n_2+n_4=5$이고, 전체 공의 개수에서 $n_1+2n_2+3n_4=10$이다. 두 식을 빼면 $n_2+2n_4=5$이므로 가능한 경우는 $(n_1,n_2,n_4)=(0,5,0),(1,3,1),(2,1,2)$이다. 각 경우의 확률은 차례로 $\\left(\\dfrac{1}{2}\\right)^5=\\dfrac{1}{32}$, $\\dfrac{5!}{1!3!1!}\\left(\\dfrac{1}{4}\\right)\\left(\\dfrac{1}{2}\\right)^3\\left(\\dfrac{1}{4}\\right)=\\dfrac{5}{32}$, $\\dfrac{5!}{2!1!2!}\\left(\\dfrac{1}{4}\\right)^2\\left(\\dfrac{1}{2}\\right)\\left(\\dfrac{1}{4}\\right)^2=\\dfrac{15}{256}$이다. 따라서 상자 $B$의 공이 $10$개일 확률은 $\\dfrac{1}{32}+\\dfrac{5}{32}+\\dfrac{15}{256}=\\dfrac{63}{256}$이다. 한편 흰 공의 개수는 $n_1+n_2+2n_4=(n_1+n_2+n_4)+n_4=5+n_4$이므로 흰 공이 $7$개이려면 $n_4=2$이어야 한다. 이는 $(n_1,n_2,n_4)=(2,1,2)$인 경우이며 그 확률은 $\\dfrac{15}{256}$이다. 그러므로 구하는 조건부확률은 $\\dfrac{15/256}{63/256}=\\dfrac{5}{21}$이다.\n따라서 정답은 ①이다."
  },
  {
    "id": 18,
    "level": "중",
    ...
    "wide": false,
    "content": "좌표평면의 원점에 점 $P$가 있다. 한 개의 주사위를 사용하여 다음 시행을 한다.<div style=\"border:1px solid #555; padding:6px 8px; margin:6px 0;\">주사위를 한 번 던져 나온 눈의 수가<br>$2$ 이하이면 점 $P$를 $x$축의 양의 방향으로 $3$만큼,<br>$3$ 이상이면 점 $P$를 $y$축의 양의 방향으로 $1$만큼 이동시킨다.</div>이 시행을 $45$번 반복하여 이동된 점 $P$와 직선 $3x+4y+5=0$ 사이의 거리를 확률변수 $X$라 하자. 이때, $X$의 평균은? [4.1점]",
    "choices": [
      "$52$",
      "$53$",
      "$54$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "확률변수 $X$가 정규분포 $N(12,2^2)$을 따른다. $x$에 대한 이차방정식 $x^2-24x+a=0$이 서로 다른 두 실근 $\\alpha$, $\\beta$ $(\\alpha<\\beta)$를 갖고, $P(\\alpha\\le X\\le\\beta)=0.8664$를 만족시킬 때, 상수 $a$의 값을 오른쪽 표준정규분포표를 이용하여 구하면? [4.1점]<table class=\"question-table\"><thead><tr><th>$z$</th><th>$P(0 \\le Z \\le z)$</th></tr></thead><tbody><tr><td>$1.0$</td><td>$0.3413$</td></tr><tr><td>$1.5$</td><td>$0.4332$</td></tr><tr><td>$2.0$</td><td>$0.4772$</td></tr><tr><td>$2.5$</td><td>$0.4938$</td></tr></tbody></table>",
    "choices": [
      "$119$",
      "$128$",
      "$135$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "두 확률변수 $X$, $Y$가 각각 정규분포 $N(30,\\sigma^2)$, $N(m,\\sigma^2)$을 따르고, 다음 조건을 만족시킨다.<div style=\"border:1px solid #555; padding:6px 8px; margin:6px 0;\">(가) $E(X^2)=916$ &nbsp;&nbsp; (나) $P(X\\ge26)+P(Y\\ge46)=1$</div>두 확률변수 $X$, $Y$의 확률밀도함수를 각각 $f(x)$, $g(x)$라 할 때, 두 상수 $a$, $b$ $(a<b)$에 대하여 $f(a)=g(a)=g(b)$이다. $P(a\\le Y\\le b)$의 값을 오른쪽 표준정규분포표를 이용하여 구하면? [4.2점]<table class=\"question-table\"><thead><tr><th>$z$</th><th>$P(0 \\le Z \\le z)$</th></tr></thead><tbody><tr><td>$0.5$</td><td>$0.1915$</td></tr><tr><td>$1.0$</td><td>$0.3413$</td></tr><tr><td>$1.5$</td><td>$0.4332$</td></tr><tr><td>$2.0$</td><td>$0.4772$</td></tr></tbody></table>",
    "choices": [
      "$0.6826$",
      "$0.7745$",
      "$0.8185$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "&lt;서술형1&gt; 평균이 $m$, 표준편차가 $4$인 정규분포를 따르는 확률변수 $X$의 확률밀도함수 $f(x)$가 다음 조건을 만족시킨다.<div style=\"border:1px solid #555; padding:6px 8px; margin:6px 0;\">(가) $f(11)>f(21)$<br>(나) $f(5)<f(23)$</div>$m$이 자연수일 때, $P(11\\le X\\le23)$의 값을 오른쪽 표준정규분포표를 이용하여 구하시오. 서술형 답안지에 자세한 풀이와 함께 서술하시오. [부분 점수 있음, 6점]<table class=\"question-table\"><thead><tr><th>$z$</th><th>$P(0 \\le Z \\le z)$</th></tr></thead><tbody><tr><td>$0.5$</td><td>$0.1915$</td></tr><tr><td>$1.0$</td><td>$0.3413$</td></tr><tr><td>$1.5$</td><td>$0.4332$</td></tr><tr><td>$2.0$</td><td>$0.4772$</td></tr></tbody></table>",
    "choices": [],
    "answer": "$0.8185$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "&lt;서술형2&gt; 정규분포를 따르는 두 확률변수 $X$, $Y$의 확률밀도함수를 각각 $f(x)$, $g(x)$라 할 때, 두 함수 $f(x)$, $g(x)$가 다음 조건을 만족시킨다.<div style=\"border:1px solid #555; padding:6px 8px; margin:6px 0;\">(가) $f(20)=g(20)$<br>(나) 모든 실수 $x$에 대하여 $f(x-2)=g(x+2)$</div>$P(15\\le X\\le18)=a$, $P(21\\le Y\\le25)=b$일 때, 다음 중 $P(19\\le X\\le21)$의 값을 $a$, $b$를 사용하여 나타내시오. 서술형 답안지에 자세한 풀이와 함께 서술하시오. [부분 점수 있음, 7점]",
    "choices": [],
    "answer": "$2a-b$",
  ...
  },
  {
    ...
    "wide": false,
    "content": "&lt;서술형3&gt; $1$부터 $5$까지 자연수가 각각 하나씩 적혀 있는 $5$개의 공이 들어 있는 주머니가 있다. 이 주머니에서 임의로 한 개의 공을 꺼내고 꺼낸 공을 다시 넣지 않을 때, $k$번째 꺼낸 공에 적혀 있는 수를 $a_k$라 하자. $\\displaystyle\\sum_{k=1}^{n}a_k$ $(n=1,2,\\cdots,5)$의 값이 처음으로 $5$의 배수가 되도록 하는 $n$의 값을 확률변수 $X$라 하자. $V(X)$의 값을 구하시오. 서술형 답안지에 자세한 풀이와 함께 서술하시오. [부분 점수 있음, 7점]",
    "choices": [],
    "answer": "$\\dfrac{118}{45}$",
    "solution": "[키포인트] $1,2,3,4,5$의 순열에서 부분합이 처음으로 $5$의 배수가 되는 위치를 경우별로 센다.\n조건 정리: 공을 꺼내는 모든 순서는 $5!=120$가지이고, 전체 합은 $15$이므로 $X$는 반드시 $1,2,3,4,5$ 중 하나이다.\n풀이 방향: $X=1,2,3,4$인 순서의 수를 먼저 구한 뒤 나머지를 $X=5$인 경우로 계산한다.\n정석 풀이: $X=1$이려면 첫 번째 수가 $5$여야 하므로 나머지 네 수를 배열하는 $4!=24$가지이다. $X=2$이려면 첫 번째 수는 $5$가 아니고 처음 두 수의 합이 $5$의 배수여야 한다. 가능한 순서쌍은 $(1,4),(4,1),(2,3),(3,2)$의 $4$개이고, 나머지 세 수의 배열은 $3!$가지이므로 $4\\cdot3!=24$가지이다. $X=3$이려면 첫째와 둘째 부분합은 $5$의 배수가 아니고 처음 세 수의 합이 $5$의 배수여야 한다. 가능한 처음 세 수는 $(1,5,4),(2,5,3),(3,5,2),(4,5,1)$의 $4$가지이며, 남은 두 수의 배열은 $2!$가지이므로 $4\\cdot2!=8$가지이다. $X=4$이려면 마지막 수가 $5$여야 처음 네 수의 합이 $10$이 된다. 앞의 네 자리는 $1,2,3,4$의 배열 $4!=24$가지인데, 처음 두 수의 합이 $5$가 되는 순서쌍 $4$개마다 나머지 두 수를 배열하는 $2!$가지, 즉 $8$가지는 $X=2$인 경우이므로 제외한다. 세 수의 합은 $6,7,8,9$ 중 하나여서 $5$의 배수가 될 수 없다. 따라서 $X=4$인 경우는 $24-8=16$가지이다. 그러므로 $X=5$인 경우는 $120-24-24-8-16=48$가지이다. 따라서 $P(X=1)=\\dfrac{24}{120}$, $P(X=2)=\\dfrac{24}{120}$, $P(X=3)=\\dfrac{8}{120}$, $P(X=4)=\\dfrac{16}{120}$, $P(X=5)=\\dfrac{48}{120}$이다. $E(X)=\\dfrac{1\\cdot24+2\\cdot24+3\\cdot8+4\\cdot16+5\\cdot48}{120}=\\dfrac{10}{3}$이고, $E(X^2)=\\dfrac{1^2\\cdot24+2^2\\cdot24+3^2\\cdot8+4^2\\cdot16+5^2\\cdot48}{120}=\\dfrac{206}{15}$이다. 따라서 $V(X)=E(X^2)-\\{E(X)\\}^2=\\dfrac{206}{15}-\\left(\\dfrac{10}{3}\\right)^2=\\dfrac{118}{45}$이다.\n따라서 구하는 값은 $\\dfrac{118}{45}$이다."
  }
];
