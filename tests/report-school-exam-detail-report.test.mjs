...
assert.doesNotMatch(html, /aprc-counsel-title">시험 요약</);
assert.ok(html.indexOf('오답 문항 분석') < html.indexOf('앞으로의 학습 방향'));
assert.ok(html.indexOf('앞으로의 학습 방향') < html.indexOf('학부모님께'));
