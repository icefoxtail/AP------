...
-- unchanged. These columns are nullable so old blueprints continue to load
-- while Phase 2B/2C starts populating and hashing the richer metadata.
ALTER TABLE exam_blueprints ADD COLUMN sub_unit_key TEXT;
ALTER TABLE exam_blueprints ADD COLUMN type_key TEXT;
ALTER TABLE exam_blueprints ADD COLUMN template_key TEXT;
ALTER TABLE exam_blueprints ADD COLUMN difficulty TEXT;
