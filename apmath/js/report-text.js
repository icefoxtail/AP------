...
const REPORT_COPY_BANK = {
    ...
    remediation: {
        withWrong: '이번 오답은 {labels}에서 주로 나왔습니다. 다음 수업과 보강에서 해당 부분을 다시 짚고, 개념을 정리한 뒤 같은 유형 2~3문항으로 한 번 더 확인하겠습니다.',
    ...
    wrongCare: {
        ...
        line2: '반복해서 틀리는 단원은 따로 모아 관리하고, 다음 시험 전에 다시 풀 문항과 유사 문항으로 점검하겠습니다.',
...
function buildNextPoint(ctx) {
    ...
    if (ctx.progressText) {
        return `${wrongStr} 뒤 ${ctx.progressText} 부분을 이어서 진행하는 것`;
    }
    return wrongStr;
}
