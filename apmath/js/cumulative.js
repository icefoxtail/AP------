...
function renderSchoolExamBatchTable() {
    ...
    if (sort === 'default') {
        ...
        var byGrade = {};
        students.forEach(function(s) { var g = String(s.grade || '기타'); if (!byGrade[g]) byGrade[g] = []; byGrade[g].push(s); });
        ...
        students.forEach(function(s) { var cn = getCumulativeClassName(getCumulativeClassIdForStudent(s.id)) || ''; bodyRows += _buildSebRow(s, year, String(s.grade || ''), cn); });
    }
