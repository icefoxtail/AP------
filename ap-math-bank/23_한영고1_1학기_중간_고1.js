...
window.questionBank = [
    ...
    },
    {
        ...
        choices: [" ", " ", " ", " ", " "],
        answer: "4",
        solution: "**[Logical Anchor]** 인수분해를 통해 모든 근을 구한 뒤 대소 비교를 수행함.\n$x^2(x - 5) - (x - 5) = 0$\n$(x^2 - 1)(x - 5) = 0$\n$(x - 1)(x + 1)(x - 5) = 0$\n실근은 $-1, 1, 5$ 임.\n가장 큰 근: $5$, 가장 작은 근: $-1$\n$\therefore 5 + (-1) = 4$"
    },
    {
        id: 19,
        level: "상",
