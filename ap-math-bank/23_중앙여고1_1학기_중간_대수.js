/**
 * 23_중앙여고1_1학기_중간_고1 (v6.5.4 AP수학 마스터 엔진 완결판)
 * 문항 수: 24문항 (누락 없음)
 * 적용 매뉴얼: 고등부 해설 MAXIMUM_EXPANSION & [하/중/상/최상] 체계
 * 특이사항: 지수·로그·삼각함수 전 구간 수식 상세 전개 및 \tf 매크로 적용
 */

// 파일명: 23_중앙여고1_1학기_중간_대수.js
window.examTitle = "23_중앙여고1_1학기_중간_대수";
...
window.questionBank = [
    {
        ...
        answer: "④",
        solution: "**[Logical Anchor]** 거듭제곱근의 성질을 지수 법칙으로 변환하여 밑을 통일한 뒤 지수를 비교함.\n주어진 식의 좌변과 우변을 유리수 지수 형태로 변형함.\n$\\text{i) 좌변: } \\sqrt[3]{a^2} = a^{\\tf{2}{3}}$\n$\\text{ii) 우변: } \\sqrt{a\\sqrt[3]{a^m}} = (a \\cdot a^{\\tf{m}{3}})^{\\tf{1}{2}} = (a^{1 + \\tf{m}{3}})^{\\tf{1}{2}}$\n지수 법칙 $(a^n)^m = a^{nm}$을 적용하여 우변을 정리함.\n$\\implies a^{(\\tf{3+m}{3}) \\cdot \\tf{1}{2}} = a^{\\tf{3+m}{6}}$\n$\\because$ 밑 $a$가 양수이고 $1$이 아니므로, 등식이 성립하려면 지수가 동일해야 함.\n$\\implies \\tf{2}{3} = \\tf{3+m}{6}$\n양변에 $6$을 곱하여 일차방정식을 해결함.\n$4 = 3 + m \\implies m = 1$\n$\\therefore 1$"
    },
    {
        id: 2,
        level: "중",
