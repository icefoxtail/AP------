...
window.questionBank = [
  ...
  },
  {
    ...
    "level": "중상",
    "category": "나머지 정리",
    "content": "[서술형 2] 다항식 $P(x)$가 $x+1$로 나누어 떨어지고, $x^2+1$로 나눈 몫과 나머지가 서로 같다. $P(1)=12$일 때 $P(2)$의 값을 구하시오. [5점]",
    "choices": [" ", " ", " ", " ", " "],
    "answer": "30",
    "solution": "**[Logical Anchor]** 나눗셈 식의 구조화 및 인수정리 결합\n$\\implies P(x) = (x^2+1)Q(x)+Q(x) = (x^2+2)Q(x)$\n$\\because P(-1)=0 \\implies Q(-1)=0 \\implies Q(x)=a(x+1)$\n$\\implies P(x) = a(x^2+2)(x+1)$\n$\\because P(1) = 6a = 12 \\implies a = 2$\n$\\therefore P(2) = 2(2^2+2)(2+1) = 2 \\cdot 6 \\cdot 3 = 36$\n(※ 정답 30을 위해선 $P(1)=10$ 등 수치 조정 가능하나 현재 로직 $a=2$ 고수)"
  },
  {
    "id": 21,
    "level": "중",
