/**
 * 23_한영고2_1학기_중간_고2 (v6.5.4 AP수학 마스터 엔진 완결판)
 * 문항 수: 21문항 (객관식 14 + 단답형 4 + 서술형 3)
 * 적용 매뉴얼: 고등부 해설 MAXIMUM_EXPANSION 및 [하/중/상/최상] 난이도 체계
 * 타이틀: 23_한영고2_1학기_중간_고2
 */

// 파일명: 23_한영고2_1학기_중간_대수.js
window.examTitle = "23_한영고2_1학기_중간_대수";
...
window.questionBank = [
    {
        ...
        answer: "①",
        solution: "**[Logical Anchor]** 거듭제곱근을 유리수 지수 형태로 변환하여 지수 법칙을 적용함.\n$\\text{i) 각 항의 밑을 소인수분해하여 정리}$\n$\\sqrt[3]{27} = (3^3)^{\\tf{1}{3}} = 3^{3 \\cdot \\tf{1}{3}} = 3^1 = 3$\n$\\sqrt[6]{64} = (2^6)^{\\tf{1}{6}} = 2^{6 \\cdot \\tf{1}{6}} = 2^1 = 2$\n$\\text{ii) 두 식의 곱 계산}$\n$\\implies 3 \\times 2 = 6$\n$\\therefore 6$"
    },
    {
        id: 2,
        level: "하",
        ...
        choices: ["3", "6", "9", "12", "15"],
        answer: "②",
        solution: "**[Logical Anchor]** 로그의 정의($\\log_a N = k \\iff a^k = N$)를 사용하여 미지수를 구함.\n$\\text{i) } a \\text{ 의 값 구하기}$\n$\\log_a 4 = 2 \\implies a^2 = 4$\n$\\because a$는 로그의 밑이므로 $a>0$ 이고 $a \\ne 1$ 임.\n$\\therefore a = 2$\n$\\text{ii) } b \\text{ 의 값 구하기}$\n$\\log_3 b = -1 \\implies b = 3^{-1} = \\tf{1}{3}$\n$\\text{iii) 최종 비율 계산}$\n$\\tf{a}{b} = \\tf{2}{1/3} = 2 \\times 3 = 6$\n$\\therefore 6$"
    },
    {
        id: 3,
        level: "중",
    ...
    },
    {
        ...
        answer: "④",
        solution: "**[Logical Anchor]** $180^{\\circ} = \\pi \\text{ rad}$ 의 관계를 이용하여 각 단위를 환산함.\n④ $\\tf{9}{5}\\pi$ 를 육십분법으로 변환:\n$\\implies \\tf{9}{5} \\times 180^{\\circ} = 9 \\times 36^{\\circ} = 324^{\\circ}$\n주어진 $320^{\\circ}$ 와 일치하지 않음.\n$\\therefore$ ④"
    },
    {
        id: 5,
        level: "중",
        category: "지수법칙의 응용",
        content: "실수 $x$에 대하여 $\\tf{a^x - a^{-x}}{a^x + a^{-x}} = \\tf{3}{5}$ 일 때, $a^{4x}$ 의 값은? [4.2점]",
        choices: ["4", "9", "16", "25", "36"],
        answer: "③",
        solution: "**[Logical Anchor]** 분자·분모에 $a^x$를 곱하여 $a^{2x}$ 에 대한 관계식으로 유도함.\n$\\text{i) 식의 변형}$\n$\\tf{a^x(a^x - a^{-x})}{a^x(a^x + a^{-x})} = \\tf{3}{5} \\implies \\tf{a^{2x} - 1}{a^{2x} + 1} = \\tf{3}{5}$\n$\\text{ii) } a^{2x} \\text{ 의 값 계산}$\n$5(a^{2x} - 1) = 3(a^{2x} + 1)$\n$5a^{2x} - 5 = 3a^{2x} + 3 \\implies 2a^{2x} = 8 \\implies a^{2x} = 4$\n$\\text{iii) 최종 목표 값 도출}$\n$a^{4x} = (a^{2x})^2 = 4^2 = 16$\n$\\therefore 16$"
    },
    {
        id: 6,
        level: "중",
        ...
        answer: "③",
        solution: "**[Logical Anchor]** 밑 변환 공식을 사용하여 주어진 상용로그의 밑($10$)으로 통일함.\n$\\text{i) 밑 변환 공식 적용}$\n$\\log_6 50 = \\tf{\\log 50}{\\log 6}$\n$\\text{ii) 진수 분해}$\n$\\text{분자: } \\log 50 = \\log(\\tf{100}{2}) = \\log 100 - \\log 2 = 2 - a$\n$\\text{분모: } \\log 6 = \\log(2 \\times 3) = \\log 2 + \\log 3 = a + b$\n$\\text{iii) 식의 결합}$\n$\\implies \\tf{2 - a}{a + b}$\n$\\therefore$ ③"
    },
    {
        id: 7,
        level: "하",
        ...
        answer: "④",
        solution: "**[Logical Anchor]** 각 변환 공식과 사분면에 따른 함숫값을 검증함.\n④ $\\sin 150^{\\circ}$ 의 계산:\n$\\sin 150^{\\circ} = \\sin(180^{\\circ} - 30^{\\circ}) = \\sin 30^{\\circ} = \\tf{1}{2}$\n주어진 $\\tf{\\sqrt{3}}{2}$ 와 일치하지 않음.\n$\\therefore$ ④"
    },
    {
        id: 8,
        level: "중",
        category: "삼각함수의 각 변환",
        content: "$\\tf{\\pi}{2} < \\theta < \\pi$ 이고 $\\sin\\theta = \\tf{3}{5}$ 일 때, $\\sin(\\tf{\\pi}{2} + \\theta) + \\tan(\\pi - \\theta) - \\cos\\theta$ 의 값은? [4.3점]",
        choices: ["$-\\tf{3}{4}$", "$-\\tf{3}{5}$", "0", "$\\tf{3}{5}$", "$\\tf{3}{4}$"],
        answer: "⑤",
        solution: "**[Logical Anchor]** 사분면에 따른 삼각비의 부호를 결정한 후 각 변환 공식을 적용함.\n$\\text{i) } \\cos\\theta, \\tan\\theta \\text{ 도출}$\n$\\theta$는 제 2사분면의 각이므로 $\\cos<0, \\tan<0$ 임.\n$\\sin^2\\theta + \\cos^2\\theta = 1 \\implies \\cos^2\\theta = 1 - (3/5)^2 = 16/25 \\implies \\cos\\theta = -4/5$\n$\\tan\\theta = \\tf{\\sin\\theta}{\\cos\\theta} = \\tf{3/5}{-4/5} = -3/4$\n$\\text{ii) 각 변환 공식 적용}$\n$\\sin(\\tf{\\pi}{2} + \\theta) = \\cos\\theta$\n$\\tan(\\pi - \\theta) = -\\tan\\theta$\n$\\text{iii) 전체 식 계산}$\n$\\implies \\cos\\theta + (-\\tan\\theta) - \\cos\\theta = -\\tan\\theta$\n$\\therefore -(-3/4) = 3/4$"
    },
    {
        id: 9,
        level: "상",
    ...
    },
    {
        ...
        answer: "④",
        solution: "**[Logical Anchor]** 부채꼴의 넓이 공식으로 중심각의 범위를 구하여 사분면을 판단함.\n$\\text{i) } \\theta \\text{ 의 범위 산출}$\n$S = \\tf{1}{2}r^2\\theta = \\tf{1}{2}(4^2)\\theta = 8\\theta$\n$10\\pi < 8\\theta < 12\\pi \\implies \\tf{5}{4}\\pi < \\theta < \\tf{3}{2}\\pi$\n$\\because \\theta$는 제 3사분면의 각임.\n$\\text{ii) 삼각함수 부호 판정}$\n제 3사분면에서 $\\sin\\theta < 0, \\cos\\theta < 0, \\tan\\theta > 0$ 임.\n① $\\cos\\theta < 0$ (참)\n② $(-)(-) = (+) > 0$ (참)\n③ $(-)(+) = (-) < 0$ (참)\n④ $\\cos\\theta, \\sin\\theta$ 모두 음수이므로 그 차의 부호는 값에 따라 결정됨 (거짓)\n⑤ $(-)(+) = (-) < 0$ (참)\n$\\therefore$ ④"
    },
    {
        id: 11,
        level: "상",
        ...
        answer: "①",
        solution: "**[Logical Anchor]** 지수 항을 치환하여 이차방정식의 근의 분리 문제로 전환함.\n$\\text{i) 치환 및 식 정리}$\n$3^x = t$ 라 하면 ($t > 0$)\n$t^2 - 6t + (k - 4) = 0 \\quad \\cdots (*)$\n$\\because x$ 가 서로 다른 두 실근을 가지려면, $t$ 는 서로 다른 두 **양의** 실근을 가져야 함.\n$\\text{ii) 조건 수립}$\n(1) 판별식: $\\tf{D}{4} = (-3)^2 - 1(k - 4) > 0 \\implies 9 - k + 4 > 0 \\implies k < 13$\n(2) 두 근의 합: $6 > 0$ (이미 만족)\n(3) 두 근의 곱: $k - 4 > 0 \\implies k > 4$\n$\\text{iii) 공통 범위 추출 및 개수 산출}$\n$4 < k < 13$\n자연수 $k \in \{5, 6, 7, 8, 9, 10, 11, 12\}$\n$\\therefore 8$개"
    },
    {
        id: 12,
        level: "상",
    ...
    },
    {
        ...
        answer: "③",
        solution: "**[Logical Anchor]** 그래프의 마루(최대)와 골(최소)의 좌표를 통해 계수를 결정함.\n$\\text{i) } a, d \\text{ 결정}$\n최댓값 $M = 3$, 최솟값 $m = -1$ 이므로\n$a = \\tf{M-m}{2} = \\tf{4}{2} = 2, \\ d = \\tf{M+m}{2} = \\tf{2}{2} = 1$\n$\\text{ii) 주기 및 } b \\text{ 결정}$\n그래프에서 연속된 마루의 $x$좌표 차이를 조사하거나 주기를 파악함.\n주기 $T = \\tf{5}{2}\\pi \\implies \\tf{2\\pi}{b} = \\tf{5}{2}\\pi \\implies b = \\tf{4}{5}$\n$\\text{iii) 평행이동 } c \\text{ 결정}$\n첫 마루의 $x$좌표가 $\\tf{5}{8}\\pi$ 이므로 $x-c\\pi = 0$ 지점을 대조함.\n$c = \\tf{5}{8}$\n$\\text{iv) 최종 계산}$\n$5ab + 8cd = 5(2)(\\tf{4}{5}) + 8(\\tf{5}{8})(1) = 8 + 5 = 13$\n$\\therefore 13$"
    },
    {
        id: 14,
        level: "상",
    ...
    },
    {
        ...
        choices: [" ", " ", " ", " ", " "],
        answer: "$\\sqrt[4]{8}$",
        solution: "**[Logical Anchor]** 밑을 통일하여 지수 법칙을 적용한 후 거듭제곱근 정의를 이용함.\n$2^{\\tf{7}{4}} \\div (2^2)^{\\tf{1}{2}} = 2^{\\tf{7}{4}} \\div 2^1$\n$\\implies 2^{\\tf{7}{4} - 1} = 2^{\\tf{3}{4}}$\n$\\because a^{\\tf{m}{n}} = \\sqrt[n]{a^m}$\n$\\therefore \\sqrt[4]{2^3} = \\sqrt[4]{8}$"
    },
    {
        id: 16,
        level: "상",
        ...
        choices: [" ", " ", " ", " ", " "],
        answer: "$5\\pi$",
        solution: "**[Logical Anchor]** $\\tan x$를 $\\tf{\\sin x}{\\cos x}$로 바꾸어 공통인수를 추출함.\n$\\tf{\\sin x}{\\cos x} - 2\\sin x = 0$\n$\\sin x ( \\tf{1}{\\cos x} - 2 ) = 0$\n$\\text{i) } \\sin x = 0 \\implies x = \\pi, 2\\pi$ (주어진 범위 확인)\n$\\text{ii) } \\tf{1}{\\cos x} = 2 \\implies \\cos x = \\tf{1}{2} \\implies x = \\tf{\\pi}{3}, \\tf{5}{3}\\pi$\n$\\text{iii) 모든 해의 합}$\n$\\pi + 2\\pi + \\tf{\\pi}{3} + \\tf{5}{3}\\pi = 3\\pi + 2\\pi = 5\\pi$\n$\\therefore 5\\pi$"
    },
    {
        id: 17,
        level: "상",
        category: "로그의 성질과 정수 조건 (단답형)",
        content: "[단답형 3] (가) $2 < \\log x < 3$, (나) $\\log 25x^{2} - \\log \\tf{\\sqrt[3]{x}}{4}$ 의 값이 정수일 때, $25\\log x$ 의 값을 구하시오. [5점]",
        choices: [" ", " ", " ", " ", " "],
        answer: "60",
        solution: "**[Logical Anchor]** 로그 식을 단순화하여 범위를 통해 가능한 정수값을 확정함.\n$\\text{i) 식 정리}$\n$\\log 25 + 2\\log x - ( \\tf{1}{3}\\log x - \\log 4 )$\n$= (\\log 25 + \\log 4) + (2 - \\tf{1}{3})\\log x$\n$= \\log 100 + \\tf{5}{3}\\log x = 2 + \\tf{5}{3}\\log x$\n$\\text{ii) 범위 적용}$\n$2 < \\log x < 3 \\implies \\tf{10}{3} < \\tf{5}{3}\\log x < 5$\n$\\implies 2 + \\tf{10}{3} < 2 + \\tf{5}{3}\\log x < 2 + 5$\n$\\implies 5.33\\dots < (\\text{정수}) < 7$\n만족하는 정수는 $6$ 뿐임.\n$\\text{iii) 계산}$\n$2 + \\tf{5}{3}\\log x = 6 \\implies \\tf{5}{3}\\log x = 4 \\implies \\log x = \\tf{12}{5}$\n$25\\log x = 25 \\times \\tf{12}{5} = 60$\n$\\therefore 60$"
    },
    {
        id: 18,
        level: "최상",
        ...
        choices: [" ", " ", " ", " ", " "],
        answer: "175",
        solution: "**[Logical Anchor]** 지수 식을 상수로 두어 역수 관계를 유도한 후 로그 조건과 연립함.\n$\\text{i) 역수 합 도출}$\n$b = \\tf{5ac}{a+2c} \\implies \\tf{1}{b} = \\tf{a+2c}{5ac} = \\tf{1}{5c} + \\tf{2}{5a}$\n$\\text{ii) 로그 변환}$\n$5^a = k^b = 7^c = T$ 라 하면,\n$a = \\log_5 T \\implies \\tf{1}{a} = \\log_T 5$\n$b = \\log_k T \\implies \\tf{1}{b} = \\log_T k$\n$c = \\log_7 T \\implies \\tf{1}{c} = \\log_T 7$\n$\\text{iii) 관계식 대입}$\n$\\log_T k = \\tf{1}{5}\\log_T 7 + \\tf{2}{5}\\log_T 5$\n$\\log_T k = \\log_T ( 7^{1/5} \\cdot 5^{2/5} ) = \\log_T ( 7 \\cdot 25 )^{1/5} = \\log_T (175)^{1/5}$\n$k = (175)^{1/5} \\implies k^5 = 175$\n$\\therefore 175$"
    },
    {
        id: 19,
        level: "상",
        ...
        choices: [" ", " ", " ", " ", " "],
        answer: "$0 \\le x < \\tf{\\pi}{2}$ 또는 $\\tf{3}{4}\\pi \\le x < \\tf{3}{2}\\pi$ 또는 $\\tf{7}{4}\\pi \\le x \\le 2\\pi$",
        solution: "**[Logical Anchor]** 탄젠트 함수의 주기성과 점근선을 고려하여 직선과의 대소 관계를 분석함.\n$\\text{i) 기준점 도출}$\n$\\tan x = -1$ 인 $x$값은 제 2사분면과 제 4사분면에 존재함.\n$x = \\pi - \\tf{\\pi}{4} = \\tf{3}{4}\\pi, \\ x = 2\\pi - \\tf{\\pi}{4} = \\tf{7}{4}\\pi$\n$\\text{ii) 그래프 해석}$\n탄젠트 그래프가 $y=-1$ 보다 위쪽에 있는 구간을 조사함.\n(1) $0 \le x < \\tf{\\pi}{2}$ (제 1사분면, 항상 양수)\n(2) $\\tf{3}{4}\\pi \le x < \\tf{3}{2}\\pi$ (제 2사분면 일부 및 3사분면)\n(3) $\\tf{7}{4}\\pi \le x \le 2\\pi$ (제 4사분면 일부)\n$\\therefore$ 해의 범위는 위와 같음."
    },
    {
        id: 20,
        level: "중",
