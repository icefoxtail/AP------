...
const work = path.join(root, "work/23_yeocheon_2final");
...
console.log(JSON.stringify({ status: "PASS", zipPath, zipSha256: sha256(zipPath), included: 21, excluded: ["5", "11"], pngCount: assets.length }, null, 2));
