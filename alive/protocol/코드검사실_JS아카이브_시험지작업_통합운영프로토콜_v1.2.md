...
### Integrated Clean Edition — 2026-08-13
### Revision: 풍덕중·순천여중·향림중 실전 작업 피드백 반영 — 기존 연향중·금당중 보강 유지 + INLINE VIEW LABEL LOCK / PRE-RECHECK LINT / 수정 에셋 STRUCTURE TYPE LOCK / POST-ASSET-WRITE VISUAL GATE / NO DESTRUCTIVE MASKING / ADJACENT SMALL-PRINT OWNERSHIP LOCK / ALL-ASSET LABEL INVENTORY SWEEP / ORIGINAL PIXEL FIRST LOCK / GENERATIVE ASSET BAN / SAFE CROP MARGIN LOCK / PARTIAL EDIT PATCH DIFF LOCK / GEOMETRY TOPOLOGY·SEMANTIC OWNERSHIP LOCK / SOURCE REPAIR CANDIDATE IMPACT MATRIX / SOURCE REPAIR CONSISTENCY LOCK / DELIVERY SCOPE LOCK / LEVEL BORDERLINE STABILITY LOCK / 단일 REVIEW LEDGER / HARD FAIL·MINOR WARN 분리 / MASTER_ACCEPTED_PASS / ZIP UTF-8 ENTRY FLAG LOCK / ZIP PATH ROUND-TRIP LOCK
