...
세부 계획: `docs/plans/WANGJI_STUDENT_MANAGEMENT_V1_IMPLEMENTATION_SCOPE.md`

산출물(완료): `apmath/wangji-student-management.html`, `apmath/js/wangji-student-management.js`,
`apmath/css/wangji-student-management.css`, `docs/plans/WANGJI_STUDENT_MANAGEMENT_V1_SCHEMA_DRAFT.sql`
