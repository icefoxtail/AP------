...
│
├─ eie/
│  └─ index.html                   ← EIE 내부 관리 (인증 없음, 점검 필요)
│
├─ planner/
...
|--------|------|--------|
| / | AP MATH | apmath-home/ |
| / | EIE English | https://blog.naver.com/wha6615 |
| / | CMath | #inquiry |
| / | 상담 문의 | #inquiry |
...
- 반드시 상대경로를 사용해야 한다.
  - `/`(루트)에서: `apmath-home/`, `apmath/`, `archive/`
  - `/apmath-home/`에서: `../apmath/`, `../apmath/student/`, `../archive/`, `../`
