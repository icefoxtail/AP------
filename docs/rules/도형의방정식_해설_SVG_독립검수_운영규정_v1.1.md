...
| 목적 | 실제 경로 | 역할 |
|---|---|---|
| 운영 규정 | docs/rules/도형의방정식_해설_SVG_독립검수_운영규정_v1.1.md | 현재 작업의 판정 기준 |
...
1. `docs/rules/도형의방정식_해설_SVG_독립검수_운영규정_v1.1.md`
2. `docs/rules/MANIFEST.md`
3. `docs/rules/JS아카이브룰북_v2.5.md`
4. `docs/rules/JS_문항품질_업그레이드.md`
5. `docs/rules/해설프로토콜.md`
6. `docs/rules/문제해설추출.md`
7. `docs/rules/무결성검수.md`
8. `docs/rules/수정프로토콜.md`
9. `docs/rules/수정후보고프로토콜.md`
10. `docs/rules/봉인.md`
11. `docs/rules/수학_문항오류_검증_프로토콜_v2.1.md`
12. `docs/rules/작업방식_5문항배치루프_필수.md`
13. `docs/rules/프로젝트_컨텍스트.md`
14. `docs/rules/JS아카이브_1차검수_프로토콜.md`
15. `docs/rules/JS아카이브_2차검수_프로토콜.md`
16. `docs/rules/JS아카이브_3차검수_프로토콜.md`
17. `docs/rules/JS아카이브_표준단원키_마스터테이블.md`
18. `docs/rules/JS아카이브_세부단원_운영규칙_v1.md`
19. `archive/코드검사실_JS아카이브_시험지작업_통합운영프로토콜_v1.3.1_14장_ENGINE_CAPABILITY_LOCK보강.md`
...
|---|---|---|
| 기존 production JS의 solution 재작성 | `docs/rules/해설프로토콜.md`, `docs/rules/문제해설추출.md`, `docs/rules/JS_문항품질_업그레이드.md`, `docs/rules/수학_문항오류_검증_프로토콜_v2.1.md` | 기존 solution은 참고 초안일 뿐이다. 직접 다시 풀고, 학생용 화면에서 읽은 뒤에만 수정한다. |
| content·choices·answer 또는 발문/보기의 원문 복원 | `docs/rules/🤖 JS아카이브 발문·보기 추출 프로토콜 v4.md`, `docs/rules/JS아카이브_1차검수_프로토콜.md`, `docs/rules/JS아카이브_2차검수_프로토콜.md`, 선택적 PDF·스캔·원본 이미지 | JS 기준 작업에서도 원문 필드 변경은 별도 승인·근거·allowlist가 없으면 금지한다. |
| standardCourse·standardUnitKey·subUnit 또는 tags/level 수정 | `docs/rules/JS아카이브_표준단원키_마스터테이블.md`, `archive/data/master_tables/js_archive_tag_master.json`, `docs/rules/JS아카이브_세부단원_운영규칙_v1.md`, `docs/rules/JS아카이브_3차검수_프로토콜.md` | H15/H22를 임의 전환하지 않는다. 마스터에 없는 키는 최종 JS에 쓰지 않는다. |
| 도형·그래프·표·문제용 PNG/SVG를 추가·수정 | `docs/rules/도형추출.md`, 통합 운영 프로토콜 12장, 대상 자산 파일 | 생성형 그림으로 원문을 대체하지 않는다. 저장 직후 실제 파일을 다시 열고 수학적 구조·라벨·크롭을 검수한다. |
| 해설용 `solutionImage` 또는 inline SVG를 추가·수정 | `docs/rules/도형추출.md`, 통합 운영 프로토콜 14장, `archive/engine.html`의 solutionImage 경로 | 엔진 지원 확인과 이번 시험지의 실제 브라우저 렌더 확인을 분리한다. SVG 안에 LaTeX를 넣지 않는다. |
...
| 최종 보고·봉인·다음 시험지 unlock | `docs/rules/수정후보고프로토콜.md`, `docs/rules/봉인.md`, 통합 운영 프로토콜 15~19장 | 전체 재렌더·독립검수·SHA·scope 결과 없이 봉인하지 않는다. |
...
- `docs/rules/# JS아카이브 표준단원키 마스터 테이블.md`: legacy snapshot 이해용일 뿐, 새 키의 기준으로 사용하지 않는다.
- `docs/rules/JS아카이브_세부단원체계_설계_v1.md`, `docs/rules/JS아카이브_세부단원_충돌재설계_v1.md`, `docs/rules/JS아카이브_분류기_세부단원_fallback_통합계획_v1.md`: 새 세부단원 설계·fallback adjudication이 범위일 때만 읽는다.
- `docs/rules/JS_변환_프롬프트.md`, `docs/rules/헬모드최종.md`: 신규 변환 또는 해당 작업 모드를 명시적으로 사용할 때만 읽는다.
