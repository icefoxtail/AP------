...
## r14 specialist mixed batch

r14 18건(수직선 13, 함수 그래프 5)은 source-only V1 18/18, 독립 검산 18/18, candidate solution freeze 18/18, static 18/18, artifact-only V2 18/18, V3 18/18·FAIL 0, local desktop/mobile overflow 0으로 닫혔다. exact fraction endpoint label과 adaptive number-line tick spacing도 반영했다.

현재 unique candidate visual은 95/379, 남은 candidate visual은 284건이다. 최신 원장은 `133_current_closure_snapshot_r14_v3_closed.json`이며, 전체 430 solution freeze·남은 fresh facts·provider FINAL_AUDIT·browser render/review·registry authority가 남아 최종 PASS는 보류한다.

## r15 specialist number-line/function batch

r15 18건(수직선 16, 함수 그래프 2)은 source-only V1 18/18, 독립 검산 18/18, candidate solution freeze 18/18, static 18/18, artifact-only V2 18/18, V3 18/18·FAIL 0, local desktop/mobile overflow 0으로 닫혔다.
...
## r18 specialist function/inequality batch

r18 18건(수직선 4, 함수 그래프 14)은 source-only V1 18/18, 독립 검산 18/18, candidate solution freeze 18/18, static 18/18, artifact-only V2 18/18, V3 18/18·FAIL 0, local desktop/mobile overflow 0으로 닫혔다.

현재 unique candidate visual은 167/379, 남은 candidate visual은 212건이다. 최신 원장은 `203_current_closure_snapshot_r18_v3_closed.json`이며, 전체 430 solution freeze·남은 fresh facts·provider FINAL_AUDIT·browser render/review·registry authority가 남아 최종 PASS는 보류한다.

## r19 specialist case-table continuation

r19 14건(수직선 7, 함수 그래프 6, case-table 1)은 source-only V1 14/14, 독립 검산 14/14, candidate solution freeze 14/14, static 14/14, artifact-only V2 14/14, V3 14/14·FAIL 0, local desktop/mobile overflow 0으로 닫혔다.

현재 unique candidate visual은 181/379, 남은 candidate visual은 198건이다. 최신 원장은 `219_current_closure_snapshot_r19_v3_closed.json`이며, 전체 430 solution freeze·남은 fresh facts·provider FINAL_AUDIT·browser render/review·registry authority가 남아 최종 PASS는 보류한다.

## r20 mixed function/inequality batch

r20 18건(수직선 1, 함수 그래프 17)은 source-only V1 18/18, 독립 검산 18/18, candidate solution freeze 18/18, static 18/18, artifact-only V2 18/18, V3 18/18·FAIL 0, local desktop/mobile overflow 0으로 닫혔다.

현재 unique candidate visual은 199/379, 남은 candidate visual은 180건이다. 최신 원장은 `235_current_closure_snapshot_r20_v3_closed.json`이며, 전체 430 solution freeze·남은 fresh facts·provider FINAL_AUDIT·browser render/review·registry authority가 남아 최종 PASS는 보류한다.
